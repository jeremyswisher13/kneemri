...
> This packet is for physician/MSK radiology review. It does not certify accuracy until each flagged item has source notes and reviewer sign-off.
...
**Description:** A primary care sports medicine elbow MRI course focused on management-changing interpretation: the thrower's elbow (UCL valgus overload, capitellar OCD, ulnar neuritis, olecranon stress), the LCL complex and posterolateral rotatory instability, the coronoid/anteromedial-facet axis, the distal biceps and triceps, lateral and medial epicondylitis, the three nerves, and don't-miss findings.

### Search Pattern

#### 1. Verify Protocol & Clinical Question
...
#### 3. Medial Ligament — UCL & Valgus Overload
...
#### 4. Lateral Ligament — LCL Complex, PLRI & Coronoid
...
#### 5. Tendons — Biceps, Triceps & Epicondyle Origins
...
#### 6. Nerves — Ulnar, Median / AIN, Radial / PIN
...
#### 7. Cartilage, Joint, Capsule, Bursa & Synovium
...
Learning objectives:
- Assign each imaging plane (axial, coronal, sagittal, FABS) to the structures it best shows, and state why capitellar OCD must be read on coronal and sagittal together rather than sagittal alone
- Choose the right protocol — routine non-contrast elbow, FABS positioning, or MR arthrography — and recognize the specific clinical questions (distal biceps grading, the UCL T-sign, loose bodies, OCD stability) that justify each
- Match fluid-sensitive fat-sat and T1 sequences to the tissue question they answer, and confirm every finding in at least two planes
- Translate the clinical question (UCL vs medial epicondylitis vs ulnar nerve vs OCD vs distal biceps) into a focused but complete search, and avoid over-calling the capitellar pseudodefect, transverse trochlear ridge, and the normal distal-UCL synovial recess
Topics:
- Plane-to-structure map: axial = nerves/origins/biceps footprint, coronal = UCL/LCL/epicondyles/radiocapitellar, sagittal = fossae/triceps
- FABS positioning: laying the distal biceps footprint flat for partial-vs-complete grading and retraction
- MR arthrography vs non-contrast: the T-sign, loose bodies, and when contrast changes the operation
- Sequences: fluid-sensitive fat-sat for edema/tears vs T1 for marrow/anatomy; confirm in ≥2 planes
...
- **Mistake:** Calling the capitellar pseudodefect, the transverse trochlear ridge, or a small distal-UCL synovial recess a lesion
  **Correction:** The pseudodefect of the capitellum is a normal posterolateral/postero-inferior bare-area groove at the capitellum–lateral-epicondyle junction — not an osteochondral lesion; the transverse trochlear ridge/groove is likewise a normal contour. A small synovial recess near the distal UCL is normal — the abnormal T-sign threshold is fluid tracking BEYOND the articular-cartilage edge, not any sliver of fluid at the attachment.

#### Topic 1: Plane-to-structure map: axial = nerves/origins/biceps footprint, coronal = UCL/LCL/epicondyles/radiocapitellar, sagittal = fossae/triceps

### Plane-to-Structure Map: Axial, Coronal, Sagittal

The first orientation skill is knowing **which plane answers which question** — because most elbow structures have one plane that displays them in profile and others that average through them.

| Plane | Best for | The clinical question it answers |
|---|---|---|
| **Axial** | Nerves (ulnar in the cubital tunnel, radial/PIN at the radiocapitellar level), common flexor/extensor origins in cross-section, the **annular ligament** around the radial neck, the distal biceps footprint | "Is there ulnar neuritis or flexion subluxation?" "Where is the entrapment?" |
| **Coronal** | The **UCL anterior bundle** to the sublime tubercle, the RCL/LUCL complex, the common flexor and extensor origins, and the **radiocapitellar contact zone** | "Is there a UCL tear (the T-sign), epicondylitis, or an LCL-origin tear?" |
| **Sagittal** | Olecranon/coronoid **fossae and the radiocapitellar recess** for loose bodies, the olecranon/triceps insertion, the anterior/posterior fat pads | "Is there a loose body or a triceps tear?" |
...
#### Topic 2: FABS positioning: laying the distal biceps footprint flat for partial-vs-complete grading and retraction

### FABS Positioning: Profiling the Distal Biceps Footprint

The distal biceps tendon runs **obliquely** to its radial-tuberosity footprint, so on standard planes it is foreshortened and partial-volumed — you cannot reliably grade a partial tear or measure retraction. **FABS** solves this.

**FABS = Flexed elbow, ABducted shoulder, forearm Supinated**, with the patient **prone** and the arm overhead. This position lays the distal biceps tendon **flat and in-plane all the way to its radial-tuberosity footprint**, so you can:
- Distinguish **partial** (some fibers still reaching the tuberosity) from **complete** (full discontinuity) tears
- **Measure retraction** — where the stump sits, in cm
- Assess the **bifurcated footprint** (short head distal/anterior, long head proximal/posterior)

**Order FABS when the question is the distal biceps** — a middle-aged patient with a flexion-loading injury, antecubital ecchymosis, weak supination, or a positive hook test. The two management-changing variables FABS lets you report are **partial-vs-complete** and **retraction**, the features that drive repair urgency. (The lacertus-fibrosus status, the other key variable, is read on axial.)

**Pitfall to avoid:** FABS is for the **distal biceps**, not the UCL — don't confuse the two when selecting positioning.

**Pearl:** When the distal biceps is the question, add the FABS view (Flexed elbow, ABducted shoulder, Supinated forearm, prone) — it lays the tendon flat to its radial-tuberosity footprint so you can grade partial-vs-complete and measure retraction, which standard planes foreshorten.

#### Topic 3: MR arthrography vs non-contrast: the T-sign, loose bodies, and when contrast changes the operation

### MR Arthrography vs Non-Contrast: When Contrast Changes the Operation

**Non-contrast 3T MRI is the default** and answers most elbow questions — tendons, OCD, nerves, occult fracture, loose bodies. **Direct MR arthrography** (intra-articular dilute gadolinium) earns its needle only when the added detail will change a decision.

**MR arthrography is the most sensitive study for:**
- The **partial undersurface UCL tear — the T-sign**: intra-articular contrast undercuts the deep fibers at the sublime tubercle, making an articular-sided partial tear conspicuous that non-contrast MRI undercalls. This is the classic throwing injury.
- **Intra-articular loose bodies and chondral delamination/flaps**: contrast outlines bodies and tracks under a delaminated flap.

**Add it when:**
- A thrower's exam says UCL but **non-contrast MRI is equivocal**
- **OCD stability** will change the surgical decision
- You need to **map loose bodies** pre-op (CT/CT arthrography adds bone detail for ossified bodies, though against arthroscopy neither it nor MRI gives a reliable exact count — report a minimum)
...
**Pearl:** Reach for MR arthrography only when it changes the operation — confirming the partial undersurface UCL T-sign, detecting and mapping loose bodies, or settling OCD stability when non-contrast is equivocal; non-contrast 3T answers most elbow cases, and an elbow valgus/ABER adjunct is not a validated routine.

#### Topic 4: Sequences: fluid-sensitive fat-sat for edema/tears vs T1 for marrow/anatomy; confirm in ≥2 planes

### Sequences: Fluid-Sensitive Fat-Sat vs T1 — and Confirming in ≥2 Planes

Match the **sequence to the tissue question**, exactly as in the other joints.

| Sequence | Reads | Use it for |
|---|---|---|
| **Fluid-sensitive fat-sat** (PD/T2 FS or **STIR**) | **Fluid + edema** | Tendon/ligament tears, the **OCD fluid rim**, marrow injury/stress, effusions, and **subacute muscle denervation edema** |
| **T1** | **Marrow, fat, anatomy** | Marrow **replacement** (confluent low-T1 below muscle = red flag), arthrogram contrast, occult fracture lines, chronic **fatty muscle atrophy** |

Think **T1 = anatomy/marrow, fluid-sensitive = pathology/edema.** A fracture line is a low-signal line on T1 with **fat-suppressed-bright** marrow edema around it; a bone *bruise* shows edema **without** a line.
...
#### Topic 5: Normal-variant pitfalls: the capitellar pseudodefect, transverse trochlear ridge, and distal-UCL synovial recess

### Normal-Variant Pitfalls — Don't Call Them Lesions

Three normal findings are routinely over-called at the elbow. Recognizing them is part of orientation, because each lives exactly where a real lesion would and each sends a normal elbow toward unnecessary imaging or referral.

| Variant | Location | How to call it normal |
|---|---|---|
| **Pseudodefect of the capitellum** | **Posterolateral / postero-inferior** bare-area groove at the capitellum–lateral-epicondyle junction | A normal contour notch where the articular cartilage ends posteriorly — **not** an osteochondral lesion. True capitellar OCD is **anterolateral/central** (the radiocapitellar contact zone), with a fluid rim, cyst, or fragment |
| **Transverse trochlear ridge / trochlear groove** | Trochlea | A normal bony ridge/groove in the trochlear contour — not an osteochondral defect |
| **Normal distal-UCL synovial recess** | Just distal to the UCL attachment at the sublime tubercle | A small synovial recess can normally exist; the abnormal **T-sign** threshold is fluid/contrast tracking **beyond the articular-cartilage edge**, not a couple of millimeters undercutting the most distal fibers |

**The location lesson:** for capitellar OCD, the real lesion is **anterolateral/central** and the mimic (pseudodefect) is **posterolateral** — location separates variant from pathology. For the UCL, a normal recess sits at the attachment but a true partial tear has contrast extending **past the cartilage margin**. Anchor each call to **location + a corroborating sign** (fluid rim, cyst, fragment, contrast beyond the cartilage edge), not to signal alone.

**Pearl:** The capitellar pseudodefect is a posterolateral bare-area groove — true OCD is anterolateral/central — and a small distal-UCL synovial recess is normal unless fluid tracks beyond the articular-cartilage edge; location plus a corroborating sign, not signal alone, separates variant from lesion.
...
Learning objectives:
- Apply a reproducible eight-step elbow MRI search pattern that reads context and bones/marrow before ligaments, tendons, and nerves
- Explain how satisfaction-of-search produces the classic elbow misses (a deep common-extensor/LUCL tear behind lateral epicondylitis; the UCL and ulnar nerve behind medial epicondylitis) and adopt a habit that defeats it
- Read medial pain as the valgus triad (UCL + flexor-pronator + ulnar nerve) and the post-dislocation elbow as the O'Driscoll circle (LCL/LUCL, coronoid including the anteromedial facet, radial head, Osborne-Cotterill, heterotopic ossification)
- Produce a structured impression that names the structure, the grade/severity, and the management consequence
Topics:
- Why a fixed, bones-first order beats lesion-spotting
- The eight-step elbow search pattern
- Satisfaction-of-search traps: the epicondylitis that hides a ligament
- Linked-structure habits: the medial valgus triad and the post-trauma O'Driscoll circle
- Sweeping for loose bodies and the plica mimic, then writing a management-grade impression
Common mistakes:
- **Mistake:** Calling lateral epicondylitis (or medial epicondylitis) and stopping the read
  **Correction:** The symptomatic tendinosis is rarely the management-changing lesion. Trace the LUCL to the supinator crest beneath every common-extensor tendinosis (a deep undersurface tear there means PLRI), and trace the UCL to the sublime tubercle plus interrogate the ulnar nerve beneath every common-flexor tendinosis. Finish all eight steps every time.
- **Mistake:** Dismissing a small coronoid fragment in a post-dislocation elbow because it looks small on radiographs
  **Correction:** Small does not mean stable at the coronoid. An anteromedial-facet fracture is highly unstable, implies varus posteromedial rotatory instability, and is surgical; untreated it drives early arthrosis. In any dislocation/terrible-triad elbow, close the O'Driscoll circle — LCL/LUCL, coronoid, radial head, Osborne-Cotterill impaction, and heterotopic ossification.
- **Mistake:** Reading tendons and ligaments first and leaving bones/marrow for the end
  **Correction:** Read context and bones/marrow as steps 1-2 while attention is freshest. The high-consequence osseous lesions (unstable OCD, olecranon stress fracture, occult radial-head fracture, the anteromedial coronoid facet, a marrow-replacing lesion) are exactly what gets lost to fatigue and satisfaction-of-search once an obvious tendinopathy is found.

#### Topic 1: Why a fixed, bones-first order beats lesion-spotting

### Why a Fixed, Bones-First Order Beats Lesion-Spotting

The natural instinct is to **chase the obvious finding** — the thickened, bright common-extensor origin in a tennis player, the fluid-filled olecranon bursa — and then quit. That is **satisfaction of search**, and at the elbow it is precisely how the management-changing lesion gets missed: the eye that locks onto lateral epicondylitis glides right past the **deep common-extensor/LUCL tear** sitting underneath it, and the elbow that should have gone to a ligament surgeon goes to rehab instead.
...
**Why it works:**
- **Coverage, not recall** — you check a structure because it is next on the list, not because you happened to remember it.
...
**Pearl:** The first finding you see is rarely the one that changes disposition — a fixed, bones-first order exists precisely to make you keep looking after you have already found something.

#### Topic 2: The eight-step elbow search pattern

### The Eight-Step Elbow Search Pattern

Drive every study through the same sequence. **Context and bones/marrow go first** (steps 1-2), while attention is freshest, because that is where the disposition-changing lesions hide. **Confirm every finding in ≥2 planes** and pair **T1** (marrow, fat, occult fracture lines, arthrogram contrast) with **fluid-sensitive fat-sat** (PD/T2 FS or STIR for edema, fluid, tears, denervation).

| Step | Region | High-yield target |
|---|---|---|
| **1 Verify** | Protocol & question | Side, non-contrast vs arthrogram, FABS present?; planes/sequences on hand; map the symptom (medial/lateral/anterior/posterior/mechanical) |
| **2 Bones/Marrow** | Capitellum, radial head, trochlea, olecranon, coronoid | **Unstable OCD vs Panner**, olecranon stress line, occult radial-head fracture, CRITOE, radiocapitellar line, marrow replacement |
| **3 Medial ligament** | UCL anterior bundle | Sublime-tubercle attachment, **T-sign** (fluid beyond the cartilage edge), proximal/mid/distal, chronic spur |
| **4 Lateral ligament** | LCL/LUCL, RCL, annular | **LUCL to the supinator crest**, undersurface tear deep to common extensor, **anteromedial coronoid facet**, PLRI signs |
| **5 Tendons** | Biceps, triceps, flexor/extensor origins | Biceps partial-vs-complete + lacertus, triceps % width, epicondylitis grade |
| **6 Nerves** | Ulnar, median/AIN, radial/PIN | Caliber/signal vs contralateral & median internal control, flexion subluxation, denervation pattern |
| **7 Joint/Synovium** | Cartilage, effusion, bursa, recesses | Loose bodies in dependent recesses, radiocapitellar plica, septic vs aseptic bursa |
| **8 Review/Red flags** | Masses + final management | Confluent low-T1 replacement, confirm the urgent injury, state the single disposition |

**Bones at step 2, not last** — the unstable OCD, the posteromedial olecranon stress fracture, and the occult radial-head fracture are the findings that change today's plan.

**Pearl:** Run bones/marrow as step 2, not last: the unstable OCD, the olecranon stress fracture, and the occult radial-head fracture are disposition-changers that get missed to end-of-read fatigue.

#### Topic 3: Satisfaction-of-search traps: the epicondylitis that hides a ligament

### Satisfaction-of-Search Traps: The Epicondylitis That Hides a Ligament

Two over-learned diagnoses — lateral and medial epicondylitis — are the elbow's most reliable satisfaction-of-search bait. Each sits **directly superficial to a ligament whose injury is the surgical problem**, so calling the tendinosis and stopping is how the operative lesion gets buried.

**Lateral pain → don't stop at the common extensor.** The **RCL/LUCL origin lies deep to the common extensor tendon**, so a **deep undersurface tear** there hides beneath what looks like simple "tennis elbow." A deep/full-thickness common-extensor tear with a **fluid-bright gap that undercuts or communicates with the radiocapitellar joint and involves the LUCL implies PLRI** — a surgical problem and a classic complication of prior **lateral steroid injection or release**. Trace the LUCL to the **supinator crest** before signing off any high-grade lateral epicondylitis. Conversely, do **not** over-call reactive lateral-epicondyle marrow edema or a thin RCL signal as an LCL tear.

**Medial pain → don't stop at the common flexor.** The **UCL** runs deep to the flexor-pronator origin, and the **ulnar nerve sits immediately posterior** in the cubital tunnel. Medial epicondylitis and UCL injury frequently coexist, especially in throwers, and a concomitant UCL tear shifts a thrower's conversation toward reconstruction.

| You see | You must also read | Because |
|---|---|---|
| Common-extensor tendinosis | **LUCL to the supinator crest** | Deep undersurface tear → PLRI (surgical) |
| Common-flexor tendinosis | **UCL to the sublime tubercle + ulnar nerve** | Coexistent UCL tear / ulnar neuritis changes the plan |

**Defeat tactic:** make the deep ligament a *required* next step the moment you call an epicondylitis — it is on the list, not a matter of memory.

**Pearl:** Read lateral epicondylitis? Trace the LUCL to the supinator crest. Read medial epicondylitis? Trace the UCL and check the ulnar nerve — the adjacent ligament is where the surgery hides.

#### Topic 4: Linked-structure habits: the medial valgus triad and the post-trauma O'Driscoll circle

### Linked-Structure Habits: The Medial Valgus Triad and the Post-Trauma O'Driscoll Circle

Two elbow situations injure structures **as a group**, so reading them as a linked set — not one at a time — is the habit that prevents the second miss.

**The medial valgus triad (every thrower's medial-pain read).** Valgus overload injures three structures together, so read them together:

| Triad member | What to document |
|---|---|
| **UCL anterior bundle** | Sublime-tubercle attachment, T-sign, chronic traction spur |
| **Flexor-pronator origin** | Tendinosis vs partial/full-thickness tear |
| **Ulnar nerve** | Caliber/signal vs contralateral & median; flexion subluxation |

Miss any one and you under-call the injury; the **sublime-tubercle traction spur** is a common bony clue to chronic valgus overload.

**The post-trauma O'Driscoll circle (every dislocation/terrible-triad elbow).** Soft-tissue disruption proceeds **lateral-to-medial** (**LCL/LUCL first → capsule → finally the MCL**), which is why the **LCL is the primary lesion in most simple dislocations** and valgus stability is often preserved. Close the circle in order:

1. **LCL/LUCL** — the usual primary lesion; comment on LUCL integrity explicitly.
2. **Coronoid** — including the **anteromedial facet**, which looks small on radiographs but implies **varus posteromedial rotatory instability (VPMRI)** and is surgical; **small does not mean stable**. (Regan-Morrey grades coronoid *height*; O'Driscoll classifies the *anteromedial facet*.)
3. **Radial head** — the third leg of the **terrible triad** (dislocation + radial-head fracture + coronoid fracture).
4. **Osborne-Cotterill** posterolateral capitellar impaction + posterolateral capsular avulsion — the lateral analog of a Hill-Sachs that perpetuates recurrent PLRI.
5. **Heterotopic ossification** — a common, function-limiting cause of the stiff post-traumatic elbow.

**Management impact:** the coronoid and the LCL are the reconstructive keystones of the terrible triad, and an unflagged anteromedial-facet fracture is the classic don't-miss that drives early arthrosis.

**Pearl:** Medial pain is a triad (UCL + flexor-pronator + ulnar nerve); the dislocated elbow is a circle (LCL/LUCL → coronoid/anteromedial facet → radial head → Osborne-Cotterill → HO) — read the group, not one structure.

#### Topic 5: Sweeping for loose bodies and the plica mimic, then writing a management-grade impression

### Sweeping for Loose Bodies, the Plica Mimic, and Writing a Management-Grade Impression

**The mechanical-symptom sweep.** Any locking/catching history earns a deliberate pass through the three **dependent recesses** where loose bodies settle — the **coronoid fossa, the olecranon fossa, and the radiocapitellar recess** — best seen against bright joint fluid on sagittal fluid-sensitive images (GRE blooms ossified bodies; CT/CT arthrography adds bone detail, but against arthroscopy it is **no more accurate than MRI** and neither modality reliably counts them — report a **minimum** count and say so). Don't ascribe every loose body to a throwing lesion: **primary elbow OA** (coronoid/olecranon-tip and fossa osteophytes, chondral loss) is the most common source in the non-thrower/laborer.

**The plica mimic.** A thickened **radiocapitellar plica / posterolateral synovial fold** causes lateral catching and mimics a loose body or OCD — check for it before you commit. But there is **no validated thickness cutoff**: a plica is present in about **75% of asymptomatic elbows** and averages roughly **3 mm**, so 3 mm is a NORMAL value, and symptomatic and asymptomatic plicae overlap. Arthroscopically confirmed symptomatic folds run nearer **7 mm** mediolateral or cover a substantial share (~≥30%) of the radial head — and the call still requires **concordant** mechanical symptoms.

**Write a management-grade impression.** The read ends in **structured language** that names the structure, the grade, and the consequence — not an anatomic list:

| Axis | Vocabulary |
|---|---|
| Grade | low-grade vs high-grade; partial undersurface vs full-thickness |
| Acuity | acute vs chronic; attenuated vs avulsed |
| Stability | stable vs instability-pattern (PLRI, VPMRI) |
| Nerve | ulnar subluxation / edema / denervation pattern |
| Fragment | displacement in **mm**; intra-articular vs not |

Then **prioritize the single management-changing finding** — rehab/injection, surgical referral, or urgent escalation — rather than burying it. A confluent **low-T1 marrow-replacing** lesion (signal below muscle/disc), a complete biceps/triceps/UCL/LUCL avulsion, an unstable OCD, or an anteromedial coronoid facet fracture each outranks an incidental degenerative finding and leads the impression.

**Pearl:** End every read with a one-line disposition that names the single management-changing finding in structured terms (grade, acuity, stability, mm) — an anatomic list buries the lesion that actually changes the plan.
...
Learning objectives:
- Distinguish capitellar osteochondritis dissecans from Panner disease by age, focality, and reversibility, and judge OCD stability on MRI from the interface signs read on coronal plus sagittal — alongside the validated physeal-status, fragmentation, and motion criteria the surgeon actually uses
- Recognize the thrower's osseous stress lesions — medial epicondyle apophysis (Little League elbow), olecranon stress reaction vs fracture, and the posteromedial olecranon osteophyte of valgus extension overload
- Apply CRITOE and the radiocapitellar line, work up the displaced posterior fat-pad sign as an occult radial-head fracture, and localize loose bodies
- Identify the high-stakes pediatric misses — an intra-articularly incarcerated medial epicondyle avulsion and the non-union-prone lateral condyle fracture (whose Salter-Harris label is not uniform in the literature, and whose fat-pad sign can be falsely negative)
Topics:
- Capitellar OCD vs Panner disease: age, focality, and reversibility
- OCD stability criteria: the fluid-undercutting line, cysts, and cartilage breach
- The thrower's stress lesions: Little League elbow, olecranon stress, and valgus extension overload
- CRITOE, the radiocapitellar line, and the occult radial-head fracture (fat-pad sign)
- Loose bodies, primary OA, and the high-stakes pediatric misses
Common mistakes:
- **Mistake:** Calling a capitellar OCD unstable on the basis of surrounding marrow edema, or applying a hard 5 mm subchondral-cyst cutoff
  **Correction:** Surrounding marrow edema is present in stable AND unstable lesions and is not a stability sign; an isolated high-T2 line without a cartilage breach or cyst is INDETERMINATE (it may be healing granulation tissue). On MRI, instability is a fluid-bright line completely undercutting the fragment (matching joint-fluid signal), a sizeable or multiple subchondral cyst(s), a cartilage cleft reaching the fragment, or a displaced fragment. The 5 mm cyst figure is De Smet's knee-derived criterion; it HAS been applied to the capitellum but performs poorly there (about 89% sensitive and only ~44% specific against surgical findings in overhead athletes), so teach 'sizeable or multiple cysts,' not a hard millimeter cutoff — and remember the validated clinical classification (Takahara) also weighs a closed capitellar physis, fragmentation, and ≥20 degrees of motion loss, so get arthroscopic or arthrographic confirmation when stability will change the operation.
- **Mistake:** Treating a displaced posterior fat pad with a 'normal' radiograph as no fracture, or sending every Mason II radial-head fracture to surgery on the 2 mm number
  **Correction:** A visible (displaced) posterior fat pad in an adult after trauma means hemarthrosis from an occult intra-articular fracture — radial head most common — until proven otherwise; MRI shows the low-signal line plus fat-suppressed-bright marrow edema and separates a true fracture from a bone bruise (edema only). The surgical trigger is a mechanical BLOCK to forearm rotation, an articular fragment displaced enough to impede motion, or comminution (Mason III), not the 2 mm displacement alone — many Mason II without a block are managed nonoperatively.
- **Mistake:** Ascribing every elbow loose body to a throwing lesion and clearing a child's 'fat pad without a line'
  **Correction:** Primary elbow OA (coronoid/olecranon-tip and fossa osteophytes, capitellar/radial-head chondral loss) is the most common source of loose bodies and mechanical symptoms in the non-thrower/laborer. In a child, the lateral condyle fracture is the elbow fracture most prone to non-union/malunion (reported roughly 1-5%; 1.4% in a 500-patient series) — anchor to that risk rather than to a Salter-Harris number, because the label is NOT uniform in the literature (Milch I, line lateral to the trochlear groove, is a Salter-Harris IV; Milch II, line into the groove, behaves as a Salter-Harris II and is the majority in operative series). And do NOT rely on the fat pad to find it: the fracture often tears the capsule so the hemarthrosis decompresses into the soft tissues, making the fat-pad sign FALSELY NEGATIVE. The clue is lateral soft-tissue swelling on the AP view plus a subtle metaphyseal lucency; an isolated posterior fat pad without a visible line is the classic marker of an occult SUPRACONDYLAR fracture. Either way the answer is oblique views, MRI, or short-interval follow-up rather than reassurance.

#### Topic 1: Capitellar OCD vs Panner disease: age, focality, and reversibility

### Capitellar OCD vs Panner Disease

Both are osteochondral lesions of the **capitellum** in young throwers and gymnasts, and both can present with lateral elbow pain and a flexion contracture — but they are different diseases with opposite trajectories. **Three discriminators settle it: age, focality, and reversibility.**

**Panner disease** — a self-limited **osteochondrosis/AVN of the ENTIRE capitellar ossific nucleus** in a younger child (**~5–10 yr**). The whole nucleus looks fragmented and low-signal, but there is **no discrete fragment, no subchondral cyst, and no loose body**. It is **reversible** and managed conservatively — the nucleus remodels and heals.

**Capitellar OCD** — a **FOCAL anterolateral/central osteochondral lesion** of the **adolescent/teen (~12–17 yr)** thrower or gymnast. Unlike Panner, an OCD lesion **can fragment, delaminate, and shed a loose body**, and it does not reliably heal once unstable.

| Feature | Panner | Capitellar OCD |
|---|---|---|
| Age | ~5–10 yr | ~12–17 yr |
| Extent | **Whole** ossific nucleus | **Focal** anterolateral/central |
| Fragment/cyst/loose body | No | Possible |
| Course | Self-limited, reversible | Can fragment; may need surgery |

**Read the lesion on coronal AND sagittal together** — the coronal shows the radiocapitellar contact face, the sagittal shows the anterior-to-posterior extent and contour. And do not call Panner or OCD on a **normal CRITOE secondary ossification center**, which is fragmented-looking by nature.

**Pearl:** Panner is the whole young capitellum (~5–10 yr) that heals; OCD is the focal teenage capitellum (~12–17 yr) that can fragment and shed a loose body — age plus focality plus the presence of a fragment/cyst separates them.

#### Topic 2: OCD stability criteria: the fluid-undercutting line, cysts, and cartilage breach

### OCD Stability Criteria — the Interface Is Everything

Once you have called a capitellar OCD, the question that changes management is **stable vs unstable**: a stable lesion is rested and followed; an unstable lesion stops throwing and goes to surgery (fixation, microfracture, fragment removal ± grafting). **On MRI**, stability is judged **at the fragment–bone interface**, read on **coronal + sagittal**.

**Unstable — ANY of:**
- A **T2 fluid-bright line completely undercutting the fragment**, matching joint-fluid signal (the most reliable adult criterion)
- A **sizeable or multiple subchondral cyst(s)** deep to the fragment
- A **high-signal cartilage cleft reaching the fragment** (delamination)
- A **displaced fragment or a loose body**

**Stable:** no surrounding fluid-bright signal, intact overlying cartilage, an in-situ fragment, and a low-signal demarcating margin.

| Sign | What it means |
|---|---|
| Fluid line fully undercutting fragment | **Unstable** |
| Sizeable/multiple subchondral cyst | **Unstable** |
| Cartilage cleft to the fragment | **Unstable** (delamination) |
| Displaced fragment / loose body | **Unstable** |
| **Surrounding marrow edema alone** | **NOT a stability sign** (stable and unstable both have it) |
| **Isolated high-T2 line, no cyst/breach** | **INDETERMINATE** (may be healing granulation) |

**The interface is the MRI half of the call, not the whole call.** The most widely used **validated** stable/unstable classification (Takahara; 106 patients, mean age 15.3, mean 7.2-year follow-up) is **not interface-based**: a lesion is **unstable if ANY of a CLOSED capitellar physis, fragmentation, or ≥20° restriction of elbow motion** is present, while lesions that healed with rest had an **open** physis, localized flattening/radiolucency, and good motion — and the **size of the capitellar defect** predicted the outcome of fragment excision. Report the **interface findings, the physeal status, and the lesion size**, then let the surgeon combine them with the motion exam. (Diffuse low signal through the WHOLE ossific nucleus is a **Panner** pattern, not an OCD instability sign — extent alone does not make a lesion unstable.)

**Hedges to teach honestly:** the **5 mm cyst** figure is **De Smet's KNEE-derived criterion** (Dipaola is a separate staging system). It **has** been applied to the capitellum, but it performs poorly there — roughly **89% sensitive and only ~44% specific** against surgically confirmed instability in overhead athletes — so a 'positive' MRI over-calls instability about as often as not, while the criteria used together are highly sensitive, so a fully negative study is reassuring. Say "sizeable or multiple cysts," not a hard cutoff. The often-quoted **~0.92 sensitivity / 0.85 specificity** for MRI stability criteria comes from an **OCD-wide (predominantly knee) meta-analysis extrapolated to the elbow** — cite it that way or teach the signs qualitatively. When stability is indeterminate and will change the operation, **MR or CT arthrography, or arthroscopic confirmation**, resolves it.

**Pearl:** On MRI, OCD instability lives at the interface — a fluid line undercutting the fragment, a sizeable or multiple cyst, a cartilage breach, or a displaced fragment; surrounding edema alone is NOT instability and an isolated high-T2 line is indeterminate — but the validated clinical call (Takahara) also counts a closed capitellar physis, fragmentation, or ≥20° motion loss, so report the interface, the physeal status, and the lesion size.

#### Topic 3: The thrower's stress lesions: Little League elbow, olecranon stress, and valgus extension overload

### The Thrower's Osseous Stress Lesions

Repetitive valgus loads the medial column in tension and the posterior column in extension. Three osseous stress patterns recur, and each is graded by the **presence or absence of a discrete fracture line**.

**Little League elbow (medial epicondyle apophysitis/avulsion)** — in the skeletally immature thrower, repetitive valgus **traction** injures the medial epicondyle apophysis: a **widened, fluid-bright physis with adjacent marrow edema**. Frank avulsion needs the exact displacement reported. **Operative triggers in a throwing athlete: displacement ≥ 5 mm, an intra-articular/incarcerated fragment, or valgus instability** — report the millimeters and whether the fragment is intra-articular. (The mm cutoff is debated in the general population; ≥ 5 mm is the widely taught throwing-athlete trigger, and incarceration or instability mandates surgery regardless of mm.)

**Olecranon stress** — a discrete **low-signal fracture LINE** (classically posteromedial/mid-olecranon) plus marrow edema = **stress fracture** (longer rest ± fixation, especially if widening/displaced); **edema WITHOUT a line = lower-grade stress reaction**. The **olecranon apophysis is among the last to fuse** — roughly **mid-to-late teens (~15–17 yr, later in throwers)** — so a persistently widened, fluid-bright olecranon physis is a physeal stress injury; **compare to the contralateral side** rather than trusting a hard fusion age.

**Valgus extension overload (VEO)** — the chronic end of the chain: UCL insufficiency lets the **posteromedial olecranon** impinge in the olecranon fossa, producing a **posteromedial olecranon osteophyte** and a posterior-compartment loose body. The osteophyte causes the catching, but the **underlying UCL must be assessed** — debriding the osteophyte without addressing valgus laxity can unmask instability.

| Lesion | Imaging | Management hinge |
|---|---|---|
| Little League elbow | Widened, bright physis + edema | ≥ 5 mm / intra-articular / unstable → surgery |
| Olecranon stress | Line = fracture; edema only = reaction | Line → longer rest ± fixation |
| VEO | Posteromedial osteophyte + loose body | Assess the UCL before debriding |

**Pearl:** Edema is the smoke — find the fire: a discrete low-signal line makes an olecranon stress FRACTURE (rest ± fixation) versus edema-only stress reaction, and a posteromedial olecranon osteophyte should always send you back to interrogate the UCL.

#### Topic 4: CRITOE, the radiocapitellar line, and the occult radial-head fracture (fat-pad sign)

### CRITOE, the Radiocapitellar Line, and the Occult Radial-Head Fracture

Three habits keep the bone read out of trouble: know the ossification order, check radial alignment, and respect the fat-pad sign.

**CRITOE** — the elbow's ossification sequence (approximate ages): **C**apitellum ~1, **R**adial head ~3, **I**nternal/medial epicondyle ~5, **T**rochlea ~7, **O**lecranon ~9, **E**xternal/lateral epicondyle ~11 — but these ages are approximate mnemonics with wide normal and sex-based variation, so trust the ORDER (and compare to the contralateral side), not the exact ages. The load-bearing rule: **the trochlea NEVER ossifies before the medial epicondyle.** If you 'see' the trochlea but **not** the medial epicondyle, the medial epicondyle has been **avulsed** — often into the joint.

**Radiocapitellar line** — a line through the **central long axis of the radial NECK** (not the shaft) **should pass through the capitellum**, and it is most reliable on the **lateral** view. It does **not** invariably bisect it even in normal elbows: in normal pediatric radiographs the neck line misses the capitellum in about **1%** and falls outside the central third in roughly a **quarter on the lateral view (about half on AP)**, and it is least reliable **under age 5** and with **forearm rotation**. The validating studies are **radiographic and pediatric** — the rule has not been validated on MRI planes or in adults — so a line that misses is **SUGGESTIVE, not pathognomonic**: treat it as a prompt to hunt radial-head subluxation/dislocation, including an **occult Monteggia**, and correlate with the contralateral side. Repetitive valgus also drives radiocapitellar (lateral-compartment) osteochondral overload — the lateral partner of medial UCL injury.

**Occult radial-head fracture / fat-pad sign** — any **visible (displaced) POSTERIOR fat pad** in an adult after trauma means **hemarthrosis = occult intra-articular fracture** (radial head most common in adults; supracondylar in children) until proven otherwise. The anterior fat pad is normally seen; elevation is the **sail sign**. MRI shows a **low-signal line + fat-suppressed-bright marrow edema** and distinguishes a true fracture from a **bone bruise (edema only)**.

| Mason | Description |
|---|---|
| I | Non-/minimally displaced |
| II | Displaced (commonly > 2 mm) partial articular |
| III | Comminuted whole-head |

**Surgical trigger** is a **mechanical BLOCK to forearm rotation**, an articular fragment displaced enough to impede motion, or **comminution (Mason III)** — **NOT the 2 mm number alone**; many Mason II without a block are managed nonoperatively.

**Pearl:** A displaced posterior fat pad after adult elbow trauma is a fracture until disproven — radial head first — and the radial-head surgical trigger is a mechanical block to forearm rotation, not the 2 mm displacement by itself.

#### Topic 5: Loose bodies, primary OA, and the high-stakes pediatric misses

### Loose Bodies, Primary OA, and the High-Stakes Pediatric Misses

**Loose bodies** migrate to **dependent recesses** — the **coronoid fossa, olecranon fossa, and radiocapitellar recess** — and are best seen **against bright joint fluid on sagittal fluid-sensitive images**. **GRE blooms ossified bodies**, and **CT or CT arthrography adds bone detail** for ossified fragments. Be explicit about the limits: against an arthroscopic reference standard, MRI and CT arthrography perform **similarly** — sensitive for posteriorly-based bodies (92–100%) but poorly specific, and unreliable both for anterior bodies and for the exact number, no better than plain radiography. So **report location and a MINIMUM count, and say the number may be an underestimate**, rather than promising an exact pre-operative count. Always sweep the fossae in any locking/catching history, and check the **radiocapitellar plica (posterolateral synovial fold)** as a mimic — remembering that a plica is present in about **three-quarters of asymptomatic elbows and averages ~3 mm**, so 3 mm is a NORMAL value and not a pathologic threshold (see below).

**Don't ascribe every loose body to a throwing lesion.** **Primary elbow OA** — coronoid- and olecranon-tip osteophytes, fossa osteophytes, and capitellar/radial-head chondral loss — is the **most common source of loose bodies and mechanical symptoms in the non-thrower/laborer**.

**The high-stakes pediatric misses:**

| Miss | Why it matters |
|---|---|
| **Incarcerated medial epicondyle avulsion** | After a transient dislocation that **spontaneously reduced**, the avulsed medial epicondyle can be **trapped intra-articularly** — use CRITOE (trochlea visible without medial epicondyle → it's avulsed, often into the joint) |
| **Lateral condyle fracture** | The elbow fracture **most prone to non-union/malunion** (~1–5%). Its fat-pad sign can be **FALSELY NEGATIVE** — the fracture often tears the capsule, so the hemarthrosis decompresses — which is why the clue is **lateral soft-tissue swelling on the AP view** plus a subtle metaphyseal lucency, answered with oblique views/MRI/short-interval follow-up, not reassurance. (An isolated posterior fat pad without a line is the classic marker of an occult **supracondylar** fracture. The Salter-Harris label is not uniform: Milch I = SH IV, while Milch II behaves as SH II and dominates operative series — anchor to the non-union risk, not to a number.) |

**No validated plica cutoff.** A posterolateral radiocapitellar synovial fold is present in roughly **75% of asymptomatic elbows** with a mean width of about **3 mm**, and symptomatic and asymptomatic plicae **overlap** in thickness — so 3 mm is a normal value, not a threshold. Call a plica clinically relevant only when it is **clearly enlarged** relative to normal (arthroscopically confirmed symptomatic series run nearer **7 mm** mediolateral, or the fold covers a substantial portion — roughly ≥30% — of the radial head) and/or edematous, **AND** the snapping/catching is concordant.

Both pediatric lesions are the kind that look unimpressive on the first pass and declare themselves later — which is exactly why bones and marrow are **search-pattern step 2**, read while attention is freshest.

**Pearl:** Most non-thrower loose bodies come from primary elbow OA, not a throwing lesion — and in a child a 'fat pad without a line' is an occult supracondylar fracture until proven otherwise, while the non-union-prone lateral condyle fracture often decompresses the hemarthrosis and shows NO fat pad at all, so hunt lateral soft-tissue swelling on the AP view and use CRITOE to catch an incarcerated medial epicondyle.
...
Learning objectives:
- Trace the anterior bundle of the UCL from the anteroinferior medial epicondyle to the sublime tubercle of the coronoid and explain why it is the primary valgus restraint across the functional throwing arc and the band reconstructed in Tommy John surgery
- Recognize the T-sign of a partial undersurface distal tear, distinguish it from a normal distal synovial recess using the articular-cartilage-edge threshold, and state when MR arthrography adds sensitivity
- Grade and locate a UCL injury (sprain vs partial undersurface vs full-thickness; proximal/mid/distal; acute vs chronic) and explain why distal and full-thickness tears carry a worse nonoperative prognosis
- Read the UCL together with the flexor-pronator origin and the ulnar nerve as the valgus-overload triad and frame the repair-vs-reconstruction conversation by lesion features and athlete demand rather than a single MRI number
Topics:
- UCL anatomy: anterior bundle from medial epicondyle to sublime tubercle as the primary valgus restraint
- Normal distal footprint and recess vs the abnormal undercutting threshold (beyond the cartilage edge)
- The T-sign: partial undersurface (articular-sided) distal tear and why MR arthrography is most sensitive
- Grading and locating: proximal/mid/distal, partial vs full-thickness, acute vs chronic
- The medial valgus triad (UCL + flexor-pronator + ulnar nerve) and the repair-vs-reconstruction decision
Common mistakes:
- **Mistake:** Calling any sliver of fluid undercutting the distal UCL a tear
  **Correction:** A small synovial recess near the sublime-tubercle insertion is normal; a couple of millimeters of fluid undercutting the most distal fibers can be a normal variant. The abnormal threshold is fluid/contrast tracking distal to the sublime-tubercle margin BEYOND the edge of the articular cartilage (the true T-sign), not 'any undercutting at all.'
- **Mistake:** Teaching distal (sublime-tubercle) UCL tears as the more common pattern in throwers
  **Correction:** Distal-vs-proximal predominance is genuinely not uniform in the literature; several series report proximal/humeral-sided partials as at least as common. Teach distal tears as a recognized, prognostically worse, under-recognized pattern that does worse nonoperatively, NOT as the most frequent lesion. Proximal partials are the ones favored for nonoperative/PRP management.
- **Mistake:** Recommending routine ulnar nerve transposition with every UCL reconstruction, or reporting a partial tear as automatically 'nonoperative' on MRI alone
  **Correction:** Concurrent transposition is selective, done for preoperative ulnar symptoms or instability, not routinely (routine transposition adds morbidity). And management is driven by lesion features plus athlete demand plus the moving-valgus exam, not the MRI grade in isolation; document ulnar neuritis/subluxation and the lesion, then frame the decision rather than dictate it.

#### Topic 1: UCL anatomy: anterior bundle from medial epicondyle to sublime tubercle as the primary valgus restraint

### The Anterior Bundle: One Band Does the Work

The **ulnar collateral ligament (UCL) complex** has three parts, but for the thrower only one matters. The **anterior bundle** is the **primary valgus restraint** across the **functional throwing arc (~20–120°)**, running from the **anteroinferior medial epicondyle** to the **sublime tubercle of the medial coronoid**. This is the band reconstructed in **Tommy John surgery**.

The other two contribute little to valgus restraint:
- **Posterior bundle** — forms the floor of the **cubital tunnel**; relevant to the ulnar nerve, not to valgus stability.
- **Transverse (Cooper) ligament** — negligible mechanical role.

**How to read it:** the normal anterior bundle is a **thin, taut, uniformly low-signal band** to the sublime tubercle, best on **coronal (or coronal-oblique) fluid-sensitive fat-sat** prescribed *along the band*. The common **flexor-pronator origin** drapes directly over it off the medial epicondyle, so trace the deep low-signal ligament separately from the overlying tendon.

| UCL component | Origin → insertion | Valgus role |
|---|---|---|
| **Anterior bundle** | Anteroinferior medial epicondyle → sublime tubercle | **Primary restraint (the Tommy John band)** |
...
#### Topic 2: Normal distal footprint and recess vs the abnormal undercutting threshold (beyond the cartilage edge)

### Normal Footprint, Normal Recess, and the Abnormal Threshold

The single most over-called finding here is a **normal distal synovial recess** mistaken for an undersurface tear. The distal footprint normally inserts as a **thin, taut, uniformly low-signal band on the sublime tubercle**, and a **small synovial recess can exist** right at that attachment.

The key is *where the fluid stops*:

| Finding | What you see | Call it |
|---|---|---|
| **Normal recess** | A sliver of fluid undercutting the **most distal fibers by a couple of mm**, NOT past the cartilage edge | Normal variant |
| **Partial undersurface tear (T-sign)** | Fluid/contrast tracking distal to the sublime tubercle **beyond the edge of the articular cartilage** | Abnormal |

The **abnormal threshold is fluid/contrast tracking distal to the sublime-tubercle margin BEYOND the edge of the articular cartilage** — not 'any undercutting at all.' A couple of millimeters undercutting the most distal fibers is within normal limits; the diagnosis turns on the fluid crossing the **articular-cartilage edge**.

**Why it matters:** over-calling a normal recess as a partial tear can push a thrower toward an injection or a surgical conversation he does not need; under-calling a true undersurface tear ends a season. Anchor every distal UCL call to the cartilage-edge landmark, and remember **MR arthrography is more sensitive** than the non-contrast study you are reading.

**Pearl:** The abnormal line for the distal UCL is the articular-cartilage edge: a couple of millimeters of fluid undercutting the most distal fibers is a normal recess, but contrast or fluid tracking BEYOND the cartilage margin along the sublime tubercle is the undersurface tear.

#### Topic 3: The T-sign: partial undersurface (articular-sided) distal tear and why MR arthrography is most sensitive

### The T-Sign: The Classic Throwing Injury

The **T-sign** is the signature of a **partial-thickness undersurface (articular-sided) DISTAL tear** — the classic throwing injury that is routinely **undercalled on non-contrast MRI**.

**What forms the 'T':** on coronal fluid-sensitive MRI or MR arthrography, **fluid/contrast tracks medially along the sublime tubercle UNDER the distal UCL attachment**, beyond the articular-cartilage edge. This medial limb of fluid meets the vertical **joint-fluid column** at a right angle, producing an **inverted / right-angle 'T'** — while the **ligament remains attached more proximally**. The deep fibers are stripped off the bone; the superficial fibers still hold.

| Feature | T-sign (undersurface partial) | Full-thickness tear |
|---|---|---|
| Fluid pattern | Medial limb undercutting distal fibers, beyond cartilage edge | Fluid-bright signal spanning the **entire** thickness |
...
#### Topic 4: Grading and locating: proximal/mid/distal, partial vs full-thickness, acute vs chronic

### Grade and Locate: The Report That Drives the Decision

The surgeon needs three things from your read: **surface, location, and chronicity.** Give all three explicitly.

**Surface / grade:**
- **Sprain / low-grade** — periligamentous or intrasubstance edema, fibers grossly intact, no surface-reaching defect, no T-sign.
- **Partial undersurface tear** — the T-sign; articular-sided, proximal fibers attached.
- **Full-thickness** — **fluid-bright signal spanning the entire thickness with a gap/retraction, or medial extravasation through the defect.**

A **<50% / >50% partial-thickness call is a useful descriptive heuristic, not a formally validated or named UCL grading scale.** Do not imply a validated cutoff drives the decision by itself.

**Location:** name it — **proximal (humeral) / midsubstance / distal (sublime tubercle).** This is not cosmetic: **distal (sublime-tubercle) tears are clinically important, more often occult, and do worse nonoperatively**, which is exactly why naming the location matters. But distal-vs-proximal **predominance is genuinely not uniform in the literature** — teach the distal tear as a recognized, prognostically worse, under-recognized pattern, **not** as the more frequent lesion. **Proximal partials** are the ones favored for nonoperative/PRP management.

**Chronicity:** a **thickened, heterogeneous, or ossified** ligament reads as **chronic**; clean acute fiber disruption reads as acute. The repair-vs-reconstruction conversation cares about **avulsion off bone (good tissue) vs a shredded chronic midsubstance.**

| Axis | Acute / favorable | Chronic / unfavorable |
|---|---|---|
| Surface | Clean partial or avulsion | Diffuse attenuation |
| Location | Proximal (better nonop/PRP) | Distal (worse nonop) |
| Tissue | Avulsion off bone | Thickened/heterogeneous/ossified |

**Pearl:** Always report surface, location, and chronicity: a <50%/>50% split is a descriptive heuristic and not a validated scale, distal/full-thickness tears do worse nonoperatively, and an 'avulsion off bone vs shredded midsubstance' distinction is exactly what the surgeon needs to choose repair over reconstruction.

#### Topic 5: The medial valgus triad (UCL + flexor-pronator + ulnar nerve) and the repair-vs-reconstruction decision

### The Medial Triad and the Repair-vs-Reconstruction Conversation

Medial-sided valgus overload **travels as a triad** — read all three on every thrower:

| Component | What to document |
|---|---|
| **UCL anterior bundle** | Surface, location, chronicity (above) |
| **Flexor-pronator (common flexor) origin** | Strain vs tendinosis off the medial epicondyle, overlying the UCL |
| **Ulnar nerve** | Neuritis (caliber + T2 signal) and **flexion subluxation** in the cubital tunnel |

A common incidental bony clue to chronic valgus overload is the **sublime-tubercle traction spur / ulnar traction marrow change**.

**Management is driven by the lesion PLUS the athlete's demand, not the MRI alone:**
- **Most partial/low-grade tears in throwers are managed nonoperatively first** — rest, flexor-pronator and kinetic-chain rehab, structured return-to-throwing; **PRP is increasingly used, especially for proximal partials.**
- **Reconstruction (Tommy John, autograft)** is the conversation for **full-thickness tears in throwers wanting high-level return**, **high-grade/symptomatic partials that fail ~3–6 months of rehab**, or **valgus instability discordant with demand.**
- **Repair ± internal brace** has re-emerged for **acute avulsion-type tears with good tissue**, particularly younger/lower-demand or earlier-return athletes — which is why the **avulsion-vs-shredded-midsubstance** distinction matters.

**Two hedges to honor:** the failed-conservative interval, the repair-vs-reconstruction boundary, and PRP efficacy are all **evolving — present decision DRIVERS, not a rigid cutoff.** And **ulnar nerve transposition with reconstruction is selective**, done for preoperative ulnar symptoms or instability, not routinely.

**The number MRI cannot give:** **dynamic valgus-stress ultrasound** quantifies **medial ulnohumeral gapping**, and there are **two published measures that are not interchangeable**. The **stress delta** is the rest-to-valgus increase *within* the injured elbow — abnormal above about **2.4 mm** (~87% sensitive / ~86% specific). The **stress delta difference** is the **side-to-side** comparison of that increase — abnormal above about **1 mm** (~96% sensitive / ~81% specific, the more sensitive of the two). Interpret both carefully: asymptomatic professional pitchers already gap about **0.8 mm** more on the dominant side, and flexion angle and applied load are **not standardized** (25 N vs 150 N; 30° vs 90°), so quote the criterion together with the technique it was derived from rather than a single universal cutoff. For counseling, typical return is **~12–15 months after reconstruction vs ~6–9 months after repair + internal brace**, and prevention rests on **pitch-count/workload limits and avoiding breaking balls before skeletal maturity.**

**Pearl:** Read the UCL, the flexor-pronator origin, and the ulnar nerve as one valgus triad, then frame management by lesion plus demand — nonoperative/PRP for most partials, reconstruction for full-thickness or rehab-failed high-demand throwers, and repair ± internal brace for acute avulsions with good tissue — while remembering that dynamic valgus-stress ultrasound, not MRI, supplies the side-to-side gapping number.
...
Learning objectives:
- Identify the components of the LCL complex and explain why the lateral ulnar collateral ligament (LUCL) is the key restraint to posterolateral rotatory instability, tracing it on coronal AND axial images
- Recognize the LCL injury patterns of dislocation and the iatrogenic post-lateral-release LUCL tear, and separate a symptomatic deep LUCL/RCL tear from accompanying common-extensor tendinosis
- Operationalize the coronoid/anteromedial-facet axis and varus posteromedial rotatory instability, and apply the Regan-Morrey (height) and O'Driscoll (anteromedial facet) coronoid classifications
- Recognize the terrible triad, the Osborne-Cotterill lesion, and post-traumatic heterotopic ossification, and route each instability pattern to the correct disposition
Topics:
- LCL complex anatomy and the LUCL as the principal restraint to PLRI
- PLRI mechanism and the deep undersurface tear hiding beneath refractory 'tennis elbow'
- O'Driscoll circle of dislocation, LCL grading vocabulary, and secondary PLRI signs
- Anteromedial coronoid facet fracture and varus posteromedial rotatory instability (VPMRI)
- Terrible triad, the Osborne-Cotterill lesion, heterotopic ossification, and the management hinge
Common mistakes:
- **Mistake:** Calling lateral epicondylitis and stopping, without tracing the LUCL to the supinator crest
  **Correction:** The LUCL/RCL origin lies deep to the common extensor tendon, so a deep undersurface tear that undercuts or communicates with the radiocapitellar joint and involves the LUCL implies PLRI — the lesion that converts refractory 'tennis elbow' into a surgical instability problem and a classic complication of prior lateral steroid injection or release. Conversely, do not over-call reactive lateral-epicondyle marrow edema or a thin reactive RCL signal as an LCL tear.
- **Mistake:** Dismissing a small anteromedial coronoid facet fragment as stable because it looks small on radiographs
  **Correction:** The anteromedial facet fragment is small on radiographs but highly unstable — it implies varus posteromedial rotatory instability (VPMRI), a distinct mechanism from PLRI, and untreated drives early arthrosis. It is surgical. Classify it with the O'Driscoll anteromedial-facet system (use Regan-Morrey only for coronoid height), and CT maps the osseous fragment best.
- **Mistake:** Assuming the medial (ulnar) collateral ligament is the primary lesion in a simple elbow dislocation
  **Correction:** By the O'Driscoll circle, soft-tissue disruption proceeds lateral-to-medial — LCL/LUCL first, then anterior and posterior capsule, and the MCL last — so the LCL is the primary lesion in most simple dislocations and valgus stability is often preserved. Comment explicitly on LUCL integrity in every post-dislocation and post-lateral-surgery elbow.

#### Topic 1: LCL complex anatomy and the LUCL as the principal restraint to PLRI

### The LCL Complex and the LUCL as the PLRI Restraint

The **lateral collateral ligament (LCL) complex** is read on coronal and axial fluid-sensitive fat-sat images. It has four named components:

| Component | Course | Role |
|---|---|---|
| **Radial collateral ligament (RCL)** | Lateral epicondyle → blends into the **annular ligament** | Lateral stabilizer; deep to the common extensor |
| **Lateral ulnar collateral ligament (LUCL)** | Lateral epicondyle → arcs **posterior to the radial head** → **supinator crest** of the ulna | **Principal restraint to PLRI** |
| **Annular ligament** | Encircles the radial neck (best on **axial**) | Stabilizes the radial head |
| **Accessory LCL** | Supinator crest to annular ligament | Supports the annular ligament |

The **LUCL is the structure that matters most** here. It originates at the lateral epicondyle, sweeps **posterior to the radial head**, and inserts on the **supinator crest** — and it is the principal restraint to **posterolateral rotatory instability (PLRI)**.

**Trace its posterolateral arc across consecutive coronal AND axial images.** Partial-volume averaging is the single most common reason the LUCL is missed — it is an oblique, curving structure, and one plane is not enough. A normal LUCL is a thin, continuous, uniformly low-signal band to the supinator crest.

**The anatomic trap:** the **LUCL/RCL origin lies deep to the common extensor tendon**. A deep undersurface tear there hides beneath what looks like simple lateral epicondylitis — which is exactly why the next topic exists.

**Pearl:** The LUCL runs lateral epicondyle → posterior to the radial head → supinator crest and is the key PLRI restraint — trace it on BOTH coronal and axial images, because partial-volume averaging on a single plane is the main reason it is missed.

#### Topic 2: PLRI mechanism and the deep undersurface tear hiding beneath refractory 'tennis elbow'

### PLRI and the Deep Tear Hiding Beneath Refractory 'Tennis Elbow'

**Posterolateral rotatory instability (PLRI)** is **LUCL incompetence** that allows posterolateral subluxation of the radius and ulna off the capitellum — the lesion behind the clinical **lateral pivot-shift apprehension**. It is the **most common chronic/recurrent elbow instability** and follows:

- **Dislocation or subluxation** (the LUCL is usually the primary lesion — see the O'Driscoll circle)
- **Iatrogenic injury** from an **aggressive lateral epicondylitis release** or **radial-head surgery**

**Why this is a satisfaction-of-search trap:** the **LUCL/RCL origin sits deep to the common extensor tendon**. A deep undersurface tear at that origin can hide beneath what reads as routine lateral epicondylitis. This is **the lesion that converts refractory 'tennis elbow' into instability** — and it is a classic complication of prior **lateral corticosteroid injection or surgical release**.

**What separates the surgical lesion from over-call:**

| Finding | Interpretation |
|---|---|
| Thickened, T2-bright common extensor, **intact deep fibers** | Tendinosis / partial CET tear → conservative |
| **Fluid-bright gap** at the origin that **undercuts/communicates with the radiocapitellar joint AND involves the LUCL** | Deep tear implying **PLRI → surgical** |
| Reactive lateral-epicondyle marrow edema, **thin RCL signal alone** | **Normal/reactive — do NOT call an LCL tear** |

**Always trace the LUCL to the supinator crest before signing off any high-grade lateral epicondylitis.** The companion ligament is where the surgery hides.

**Pearl:** A deep common-extensor tear with a fluid-bright gap that undercuts the radiocapitellar joint and involves the LUCL is PLRI, not tennis elbow — it is a known complication of prior lateral injection/release and turns a debridement into a ligament reconstruction.

#### Topic 3: O'Driscoll circle of dislocation, LCL grading vocabulary, and secondary PLRI signs

### O'Driscoll Circle, LCL Grading Vocabulary, and Secondary PLRI Signs

**The O'Driscoll circle of dislocation** explains the sequence of soft-tissue failure: disruption proceeds **lateral-to-medial** — **LCL/LUCL first → anterior and posterior capsule → finally the MCL.** Two consequences follow directly:

1. The **LCL is the primary lesion in most simple dislocations.**
2. Valgus stability is often **preserved**, because the MCL fails last.

So: **comment explicitly on LUCL integrity in every post-dislocation and post-lateral-surgery elbow.**

**Grading vocabulary** mirrors the UCL — there is **no standardized single MRI measurement** for an LUCL tear, so call it on **continuity, surface, and radiocapitellar alignment** plus the clinical pivot-shift, not a millimeter cutoff:

| Grade | Appearance |
|---|---|
| **Intact** | Thin, continuous, uniformly low-signal band to the supinator crest |
| **Sprain** | Thickening/edema, **fibers intact** |
| **Partial** | Surface-reaching fluid **not spanning** the full thickness |
| **Full-thickness** | Discontinuity/avulsion, usually **proximal/epicondylar** |

**Secondary PLRI signs** (look for these when the ligament itself is equivocal):
- **Posterolateral radial subluxation**
- **Radiocapitellar incongruity**
- **Lateral capsular and deep common-extensor tear**

Because there is no number to lean on, the **combination** of a discontinuous LUCL, radiocapitellar malalignment, and the clinical pivot-shift is what makes the call.

**Pearl:** Dislocation tears the elbow lateral-to-medial (O'Driscoll: LUCL → capsule → MCL last), so the LCL is the primary lesion in most simple dislocations and valgus is often spared — comment on LUCL integrity in every post-dislocation elbow.

#### Topic 4: Anteromedial coronoid facet fracture and varus posteromedial rotatory instability (VPMRI)

### Anteromedial Coronoid Facet Fracture and VPMRI

**Varus posteromedial rotatory instability (VPMRI)** is the **third, distinct instability mechanism** — separate from valgus instability and from PLRI. Its imaging signature is an **anteromedial coronoid facet fracture + LUCL injury**.

The critical teaching point: the **anteromedial facet fragment looks small on radiographs but is highly unstable and surgical.** Untreated VPMRI drives **early arthrosis**. This is a classic **don't-miss** MRI/CT call — **small does not mean stable at the coronoid.**

**Two coronoid classifications — use them for different things:**

| System | Classifies | Scheme |
|---|---|---|
| **O'Driscoll** | The **anteromedial facet** (the VPMRI lesion) | Anteromedial-facet subtypes |
| **Regan-Morrey** | Coronoid **height** | I = tip avulsion · II = ≤50% · III = >50% of coronoid height |

The coronoid is the **keystone of terrible-triad reconstruction**, which is why height matters surgically (Regan-Morrey), while the **anteromedial facet** specifically flags the **varus posteromedial mechanism** (O'Driscoll).

**Practical read:** in any post-trauma elbow, sweep the coronoid for **both** a height loss and an anteromedial-facet fragment. **CT maps the osseous fragment best** and is often added for surgical planning.

**Pearl:** An anteromedial coronoid facet fracture is small on radiographs but means varus posteromedial rotatory instability — a distinct, surgical instability that drives early arthrosis if missed; classify the facet with O'Driscoll and coronoid height with Regan-Morrey.

#### Topic 5: Terrible triad, the Osborne-Cotterill lesion, heterotopic ossification, and the management hinge

### Terrible Triad, Osborne-Cotterill, HO, and the Management Hinge

**The terrible triad** = **elbow dislocation + radial head fracture + coronoid fracture.** It is recognizable on MRI/CT and is **surgical**, with the **coronoid and LCL as the reconstructive keystones**.

After any dislocation, run the post-traumatic circle and look for two more findings:

- **Osborne-Cotterill lesion** — a **posterolateral capitellar impaction fracture + posterolateral capsular avulsion**. It is the **lateral analog of a Hill-Sachs**, perpetuates **recurrent PLRI**, and is a clue to **occult instability**.
- **Post-traumatic heterotopic ossification (HO)** — a common, **function-limiting cause of the stiff elbow** that changes management (timing of excision, indomethacin/radiation prophylaxis).

**The management hinge:**

| Scenario | Disposition |
|---|---|
| Acute LUCL injury after dislocation, elbow **concentrically reduced and stable** | Often **nonoperative** |
| **Persistent/recurrent PLRI** | **LUCL repair or reconstruction** |
| **Iatrogenic LUCL injury** (lateral release / radial-head surgery) | Recognized cause of **acquired PLRI** → surgical |
| **Anteromedial coronoid facet fracture (VPMRI)** | **Surgical** |
| **Terrible triad** | **Surgical** — coronoid + LCL keystones |

So the disposition turns on **whether the joint stays concentrically reduced**: a stable, reduced elbow with an LUCL injury can be treated nonoperatively, whereas recurrent PLRI, VPMRI, and the terrible triad all go to surgery.

**Pearl:** In the post-dislocation elbow, a concentrically reduced and stable joint with an LUCL injury is often nonoperative, but recurrent PLRI, the anteromedial coronoid facet (VPMRI), and the terrible triad are all surgical — and look for the Osborne-Cotterill impaction and heterotopic ossification on every one.
...
Learning objectives:
- Classify distal biceps injury (tendinosis vs partial vs complete), report retraction in centimeters and lacertus fibrosus integrity, and explain why the lacertus governs retraction and the mimic of a 'partial' tear
- Recognize distal triceps rupture as rare and commonly missed — roughly half of acute ruptures are misdiagnosed at first presentation — report WHICH layer is torn plus the percentage of tendon width, and identify the complete or high-grade partial that needs repair
- Grade lateral (common extensor/ECRB) and medial (common flexor-pronator) epicondylitis on the tendinosis-to-full-thickness ladder using the angiofibroblastic-tendinosis framework
- Flag the adjacent ligament injury that changes management — a deep extensor tear involving the LUCL (PLRI) and a concomitant UCL tear with medial epicondylitis
Topics:
...
Common mistakes:
- **Mistake:** Calling a non-retracted distal biceps tear with a relatively preserved exam a 'partial tear'
  **Correction:** A complete tear with an INTACT lacertus fibrosus does not retract (or only minimally) and can keep a near-normal exam — it is the commonly missed complete tear. Report partial-vs-complete AND lacertus-intact-vs-torn AND where the stump sits in centimeters; do not let a tethered, non-retracted complete tear be undercalled as partial.
- **Mistake:** Reading a high-grade partial triceps tear with extension weakness as 'tendinosis'
  **Correction:** Distal triceps tears fail SUPERFICIAL-layer-first: the posterior/superficial component (the combined long- and lateral-head tendon) avulses and retracts, often carrying an olecranon enthesophyte flake, while the deep, anterior medial-head attachment stays intact. And because an intact lateral expansion (with the anconeus compensating) still permits weak active extension — complete loss of active extension is present in only about 20% of ruptures — a functionally near-complete avulsion can read as 'partial' both clinically and on imaging. Report WHICH layer is torn, the percentage of width, and the gap; complete ruptures and high-grade partials (commonly >50% width, or any tear with extension weakness against resistance) are repaired. Look for the avulsed olecranon flake on the lateral radiograph as the tip-off.
- **Mistake:** Signing off a high-grade lateral epicondylitis without tracing the LUCL, or over-calling reactive epicondyle edema as an LCL tear
  **Correction:** Always trace the LUCL to the supinator crest: a deep/full-thickness common-extensor tear with a fluid-bright gap that undercuts or communicates with the radiocapitellar joint and involves the LUCL implies posterolateral rotatory instability — a surgical problem and a known complication of prior lateral steroid injection or release. Conversely, do not over-call reactive lateral-epicondyle marrow edema or a thin reactive RCL signal as an LCL tear.

#### Topic 1: Distal biceps anatomy: bifurcated radial-tuberosity footprint, lacertus fibrosus, and bicipitoradial bursa

### Distal Biceps Anatomy: Footprint, Lacertus, and Bursa

Three structures decide every distal biceps read. Find them before you grade anything.

- **Bifurcated radial-tuberosity footprint.** The distal biceps inserts on the radial (bicipital) tuberosity as **two limbs with distinct jobs**: the **short head** attaches **distal/anterior** and is the **flexion lever**; the **long head** attaches **proximal/posterior** and is the dominant **supination lever**. A tear can be partial along one limb of this footprint, which is why undersurface partial tears are easy to under-grade.
- **Lacertus fibrosus.** An aponeurotic expansion arising from the **medial musculotendinous junction** that blends into the **forearm flexor fascia**. It is the single most important structure for prognosis: intact, it **tethers the tendon and limits retraction** even when the main tendon is fully torn.
- **Bicipitoradial bursa.** Sits **between the tendon and the tuberosity**; a distended bursa is a **clue**, not a diagnosis, and a large one can compress the **PIN/radial nerve**.

| Limb | Footprint position | Primary action |
|---|---|---|
...
#### Topic 2: Distal biceps grading and the lacertus as the discriminator that drives repair urgency

### Distal Biceps Grading and the Lacertus Discriminator

Walk the ladder, then add the two modifiers that actually change management.

| Grade | What you see |
|---|---|
| **Tendinosis** | Tendon **thickening + intrasubstance signal**, no discontinuity |
| **Partial** | **Fluid-bright** defect with **some fibers still reaching the tuberosity** (non-retracted), usually undersurface at the footprint |
| **Complete** | **Full discontinuity** with a fluid/hematoma gap and a **balled-up, wavy stump** |

**The lacertus changes everything.** Report it on every complete tear:
- **Complete + intact lacertus** → the tendon **does not retract** (or only minimally) and can **mimic a partial tear** clinically and on imaging. This is the **commonly missed complete tear** — do not be reassured by a preserved exam.
- **Complete + disrupted lacertus** → the tendon **retracts proximally**, leaving an **empty tuberosity**.

**Always report three things:** partial-vs-complete, **lacertus intact-vs-torn**, and **retraction (where the stump sits, in cm)**.

**Surgical timing — a guideline, not a deadline.** A complete retracted tear is a **time-sensitive surgical lesion in active patients**: earlier anatomic repair is **technically easier**, and chronicity/retraction increasingly push toward a **graft** when the tendon will no longer reach the tuberosity (often only after many weeks to months, once it is irreducible). **Do not teach a hard 2–4-week / graft-after-6-week cutoff** — many primary repairs succeed out to roughly 4–6 weeks and beyond. **Partial tears and tendinosis are managed conservatively first.** And remember: **bicipitoradial bursitis is a clue** — scrutinize the adjacent insertion for a partial tear and do not mistake a distended bursa for a mass.

**Pearl:** Report partial-vs-complete, lacertus-intact-vs-torn, and retraction in centimeters on every distal biceps tear — a complete tear with an intact lacertus is the great mimic that hides behind a near-normal exam.

#### Topic 3: Triceps tendon: superficial-layer-first avulsion, the commonly missed rupture, and which-layer plus percent-width reporting

### Triceps Tendon: Superficial-Layer-First Avulsion and the Commonly Missed Rupture

The triceps inserts **broadly on the olecranon**. Rupture is **rare** — 0.8% of the 1014 tendon ruptures in Anzel's classic series — and is **frequently missed or diagnosed late**, with roughly **half of acute ruptures misdiagnosed at first presentation**: posterior elbow pain and swelling are nonspecific and the index of suspicion is low. Treat it as a commonly missed avulsion rather than ranking it against the distal biceps.

**The superficial-layer-first pattern:** the **posterior/superficial component — the combined long- and lateral-head tendon — avulses and retracts**, often carrying an **olecranon enthesophyte flake**, while the **deep, anterior medial-head attachment stays intact**. And because an **intact lateral expansion** of the triceps (with the **anconeus** compensating) preserves weak active extension, **complete loss of active extension is present in only about 20% of true ruptures** — so a functionally near-complete avulsion can read as **'partial'** both clinically and on the images. So:
- **Report WHICH layer is torn, the percentage of tendon width, and the gap** — not just 'partial.'
- **Do not undercall a high-grade partial as 'tendinosis'** if the patient cannot extend against resistance.

| Grade | Findings | Disposition |
|---|---|---|
| **Tendinosis** | Thickening + signal, no gap | Conservative |
| **High-grade partial** | **>50% width** torn, or **any tear with extension weakness** | Repair |
| **Complete** | Full-thickness gap, retracted stump, ± olecranon flake | Repair |

**Risk factors to raise suspicion:** **anabolic steroids, fluoroquinolones, renal failure / hyperparathyroidism, chronic olecranon bursitis, and local steroid injection.** The classic tip-off on the lateral radiograph is an **avulsed olecranon flake** — see it, and go looking for the tendon gap.

**Pearl:** Report which triceps layer is torn and the percentage of width, not just 'partial' — the superficial long/lateral-head component fails first while the deep medial head stays attached, and an intact lateral expansion preserves weak extension in roughly 80% of true ruptures, so a near-complete avulsion can masquerade as tendinosis in a patient who cannot extend against resistance.

#### Topic 4: Lateral epicondylitis (ECRB) and tracing the LUCL — the PLRI escalation

### Lateral Epicondylitis (ECRB) and Tracing the LUCL

'Tennis elbow' is **angiofibroblastic TENDINOSIS, not inflammation**, of the **common extensor origin** — the **ECRB is the principal culprit** — off the **lateral epicondyle**. Grade it on the same ladder you use elsewhere:

| Grade | Appearance |
|---|---|
| **Tendinosis** | Thickening + **intermediate signal**, no surface-reaching fluid/gap |
| **Partial** | **Fluid-bright** signal reaching a surface or a focal discontinuity, **intact deep fibers** |
| **Full-thickness** | Complete **fluid-bright gap** at the origin |

**The management-changing step: ALWAYS trace the LUCL to the supinator crest.** The LUCL/RCL origin lies **deep to the common extensor tendon**, so a deep tear can extend into the ligament. A **deep/full-thickness common-extensor tear with a fluid-bright gap that undercuts or communicates with the radiocapitellar joint and involves the LUCL implies PLRI (posterolateral rotatory instability)** — this converts a routine extensor debridement into a **ligament repair/reconstruction**, and it is a **known complication of prior lateral steroid injection or surgical release**.

**Two cautions:**
- **Do not over-call** associated **reactive lateral-epicondyle marrow edema** or a **thin reactive RCL signal** as an LCL tear.
- **Corticosteroid injection gives only short-term benefit and may worsen long-term outcomes** — frame expectations accordingly.

**Pearl:** Never sign off a high-grade lateral epicondylitis without tracing the LUCL to the supinator crest: a deep extensor tear that undercuts the radiocapitellar joint and involves the LUCL means PLRI and turns a debridement into a ligament reconstruction.

#### Topic 5: Medial epicondylitis (common flexor-pronator) and the medial valgus triad

### Medial Epicondylitis and the Medial Valgus Triad

'Golfer's elbow' is **common flexor-pronator tendinosis** off the medial epicondyle — **less common than lateral epicondylitis** but graded on the **same tendinosis → partial → full-thickness ladder**. The common flexor-pronator tendon **overlies the UCL**, which is exactly why the medial read cannot stop at the tendon.

**Read the medial side as a triad** (the three structures that travel together and fail together, especially in throwers):

| Component | Trace to | Why it matters |
|---|---|---|
| **Common flexor-pronator** | Medial epicondyle origin | The epicondylitis itself |
| **UCL (anterior bundle)** | **Sublime tubercle** of the coronoid | A concomitant tear shifts a thrower toward **reconstruction** |
| **Ulnar nerve** | **Cubital tunnel**, immediately posterior | Co-existing neuritis changes symptoms and treatment |

**The key linkage:** medial epicondylitis and UCL injury **frequently coexist**, and a **concomitant UCL tear changes the conversation toward reconstruction in a thrower** — so trace the **anterior bundle of the UCL to the sublime tubercle** and interrogate the **ulnar nerve** on every medial-pain study.

**Strain framework (applies to both sides):** the universal grade **1/2/3** scheme covers flexor-pronator and extensor **muscle** strains — **grade 1** = feathery perifascial edema with intact architecture; **grade 2** = fiber disruption with focal fluid/hematoma; **grade 3** = complete discontinuity with retraction, most common at the **myotendinous junction**.

**Pearl:** Medial pain is a triad — trace the flexor-pronator origin, the anterior-bundle UCL to the sublime tubercle, and the ulnar nerve in the cubital tunnel — because a UCL tear riding under the epicondylitis is what redirects a thrower toward reconstruction.
...
Learning objectives:
- Evaluate a peripheral nerve for entrapment using intraneural T2 hyperintensity, focal caliber change, loss of fascicular architecture, an identifiable structural cause, and target-muscle denervation, and stage denervation correctly across its three phases (early, when the muscle often still looks normal though edema can appear within days → subacute T2/STIR edema → chronic T1 fatty atrophy) without using the edema itself to date the injury
- Assess the ulnar nerve in the cubital tunnel using a side-to-side and ipsilateral-median internal-control technique rather than a single CSA cutoff or signal alone, anchoring the diagnosis to caliber change plus denervation plus clinical correlation
- Localize median/AIN and radial/PIN entrapment by site and by the pattern of denervated muscles, and recognize the management-changing caveats (AIN palsy as Parsonage-Turner, ulnar subluxation/snapping triceps favoring transposition, a mass as the compressive cause)
- Recognize that a space-occupying lesion (ganglion, lipoma, accessory muscle, osteophyte) changes management from splinting/therapy to surgical referral, and that radial tunnel syndrome can present with a normal MRI
Topics:
...
- Radial/PIN at the arcade of Frohse, radial tunnel syndrome with a normal MRI, and hunting the mass
Common mistakes:
- **Mistake:** Calling mild ulnar nerve T2 hyperintensity at the cubital tunnel 'neuritis' on signal alone
  **Correction:** Mild intraneural T2 brightness occurs in asymptomatic elbows (the nerve angulates and is closely apposed at the cubital tunnel). Anchor the diagnosis to caliber enlargement at/just distal to the medial epicondyle PLUS target-muscle (FCU, ulnar FDP, ulnar intrinsic) denervation PLUS clinical correlation, comparing the nerve to the ipsilateral median nerve and the contralateral side as internal controls — not signal in isolation.
- **Mistake:** Using muscle denervation edema to date the injury — or assuming MRI is blank for the first few weeks — and reading an AIN palsy as a mechanical compression that needs decompression
  **Correction:** Denervation has THREE phases, but the first is NOT a blind window. EARLY: the muscle often still looks normal — fluid-sensitive edema is only CONSISTENTLY present from about 2–4 weeks, so a normal-looking muscle in the first weeks excludes nothing — yet edema has been detected within 24–48 h experimentally and as early as ~4 days after symptom onset in patients, which is why MRI generally turns positive BEFORE EMG fibrillation potentials (those typically need ~1–5 weeks, longer the farther the muscle sits from the lesion). SUBACUTE: established diffuse, feathery T2/STIR edema with preserved T1 signal and bulk, potentially reversible with decompression or reinnervation. CHRONIC: T1 fatty atrophy with volume loss, not reversible. So call it 'edema-phase' denervation and let the clinical history — not the edema — set the age. And an AIN (pure-motor) palsy is frequently neuralgic amyotrophy (Parsonage–Turner), so surgery is usually NOT indicated; pivot to EMG and observation and search the history for a viral prodrome or brachial-plexopathy pattern.
- **Mistake:** Asserting supinator denervation as a constant feature of PIN syndrome, or over-reading a normal MRI in radial tunnel syndrome
  **Correction:** In PIN syndrome the supinator is variably involved and often SPARED because its motor branches frequently arise proximal to the arcade of Frohse; localize instead by extensor-compartment denervation (extensor digitorum, EDM, ECU, APL, EPB/EPL, EI). Radial tunnel syndrome is pain WITHOUT a motor deficit and often has a NORMAL MRI — say so, and report any mass (ganglion, lipoma, distended bicipitoradial bursa) at the arcade rather than manufacturing a finding.

#### Topic 1: General nerve-entrapment signs and the THREE-phase denervation timeline (early/often normal-looking → subacute edema → chronic fatty atrophy) — and why MRI generally turns positive before EMG

### General Nerve-Entrapment Signs & the Three-Phase Denervation Timeline

A peripheral nerve is read the same way wherever it is entrapped. Look for **intraneural T2 hyperintensity**, **focal caliber enlargement at or just proximal to the compression** (the nerve swells where it is squeezed), **loss of the normal fascicular architecture**, and an **identifiable structural cause** (ganglion, accessory muscle, osteophyte, mass). But the **highest-yield finding is the secondary sign: denervation of the target muscles** — the muscle pattern is what localizes the lesion.

**Denervation has THREE phases, not two** — but the first one is **not a blind window**:

| Phase | Timing | MRI finding | Reversible? |
|---|---|---|---|
| Early | First days–weeks | Muscle often still **normal-looking**; edema is only **CONSISTENTLY** present from **~2–4 weeks**, but it has been detected at **24–48 h** experimentally and **~4 days** clinically | — |
| **Subacute** | Weeks–months | **T2/STIR muscle edema** (diffuse, feathery) with **preserved T1 and bulk** | **Yes, with reinnervation** |
| **Chronic** | Months+ | **T1 fatty atrophy** with volume loss | No |

- **MRI is the EARLY test, not the late one.** Fluid-sensitive muscle edema generally appears **before** EMG fibrillation potentials, which typically need ~1–5 weeks (longer the farther the muscle sits from the lesion) — so never tell a clinician it is "too early for MRI."
- **Do not use edema to date the injury.** Its presence does not make the process weeks old, and a normal-looking muscle in the first days or weeks **excludes nothing** — call it **"edema-phase" denervation** and let the clinical history and EMG set the age.
- **Name the affected muscles** explicitly; the constellation (e.g., isolated pronator quadratus vs. the whole extensor compartment vs. FCU + ulnar intrinsics) is what tells the clinician which nerve and which level.

**Management:** the **edema phase** is the window where decompression of a true mechanical lesion can still recover muscle; chronic T1 fatty atrophy signals an established, often irreversible lesion. Staging the denervation frames the urgency — but stage it with the **history and EMG**, not with the edema alone.

**Pearl:** Denervation edema is usually a subacute finding — it is only consistently present from ~2–4 weeks, so a normal-looking muscle early on excludes nothing — but it can appear within days and generally precedes EMG fibrillations, so never use edema alone to date the injury; the edema phase is reversible, the later T1 fatty atrophy is not.

#### Topic 2: Ulnar nerve / cubital tunnel: the most common elbow neuropathy and the internal-control comparison technique

### Ulnar Nerve / Cubital Tunnel: the Internal-Control Technique

The **cubital tunnel** is the most common site of elbow neuropathy and the **second most common compression neuropathy overall** (after carpal tunnel). The ulnar nerve runs **between the medial epicondyle and the olecranon, beneath the cubital tunnel retinaculum (Osborne's)**, where it is superficial, angulated, and stretched in flexion.

**What to report (best on axial):**
- **Caliber enlargement and T2 hyperintensity at or just distal to the medial epicondyle.**
- **Denervation of the ulnar-innervated muscles: FCU, ulnar (medial) half of FDP, and the ulnar intrinsics** of the hand — the localizing secondary sign.
- A structural cause: **anconeus epitrochlearis**, ganglion, osteophyte, or the medial valgus-overload changes.

**The technique that fixes the absent CSA cutoff:** there is **no validated universal cross-sectional-area threshold**, and **mild T2 brightness can be normal**. Assess at the **medial-epicondyle level** and compare the nerve's caliber and signal to **two internal controls**:

| Comparator | Why |
|---|---|
| **Contralateral ulnar nerve** | Side-to-side asymmetry flags abnormal enlargement/signal |
| **Ipsilateral MEDIAN nerve** | A same-arm normal nerve calibrates 'how bright is too bright' |

Anchor the diagnosis to **caliber change + denervation + clinical correlation**, not signal alone. The ulnar nerve is the **third member of the medial valgus-overload triad** in throwers — with the UCL and the flexor-pronator origin — so on a thrower's medial-pain study, read all three.

**Management:** a structural, denervating cubital-tunnel lesion goes to decompression; isolated mild signal without caliber change or denervation does not.

**Pearl:** There is no universal CSA cutoff for the ulnar nerve — compare its caliber and signal to the ipsilateral median nerve and the contralateral side, and anchor the call to caliber change plus muscle denervation plus clinical correlation, because mild T2 brightness alone can be normal.

#### Topic 3: Ulnar nerve subluxation, anconeus epitrochlearis, and snapping triceps — findings that change the operation

### Ulnar Subluxation, Anconeus Epitrochlearis & Snapping Triceps

This is where the imaging **changes the operation** — in-situ decompression versus transposition versus addressing the triceps.

**Ulnar nerve subluxation/dislocation** — the nerve **rides anteriorly over the medial epicondyle in flexion**. Assess on **axial images in flexion** (a dynamic problem a static extended image can miss). Because the unstable nerve will re-subluxate over an in-situ decompression, **subluxation favors anterior transposition** over simple release.

**Anconeus epitrochlearis** — an **accessory muscle that replaces Osborne's retinaculum**, roofing the cubital tunnel. It both crowds the nerve (a space-occupying cause) and is a structural lesion the surgeon must address; recognize it as muscle (not a mass or ganglion) spanning the epicondyle-to-olecranon roof.

**Snapping triceps — the coexisting trap:** the **medial head of the triceps can subluxate over the medial epicondyle in flexion together with the ulnar nerve.** Recognizing it is management-changing: **transposing the nerve alone leaves the snapping triceps**, so the operation must also address the triceps. **Dynamic/flexion imaging is the key** — a static neutral study underdiagnoses both the nerve and the triceps subluxation.

| Finding (assess in FLEXION) | Why it changes management |
|---|---|
| Ulnar nerve over the epicondyle | Favors **transposition**, not in-situ release |
| Medial triceps head subluxing with the nerve | Must **address the triceps**, not just transpose |
| Anconeus epitrochlearis / ganglion / osteophyte | Identifies the **structural cause** to resect |

**Management:** flag dynamic subluxation, the accessory muscle, and any coexisting snapping triceps explicitly — each one alters the surgical plan.

**Pearl:** Ulnar nerve subluxation favors transposition over in-situ decompression, and the medial triceps head can subluxate WITH the nerve (snapping triceps) — a flexion/dynamic image is what reveals both, and missing the triceps means the operation fails.

#### Topic 4: Median/AIN: pure-motor AIN palsy, the Parsonage-Turner caveat, and pronator syndrome

### Median / AIN: Pure-Motor Palsy, the Parsonage-Turner Caveat & Pronator Syndrome

Two distinct median-nerve syndromes at the elbow — keep them separate, because one of them often shouldn't go to surgery.

**Anterior interosseous nerve (AIN, Kiloh–Nevin) — PURE MOTOR.** It denervates **flexor pollicis longus (FPL), FDP to the index/middle fingers, and pronator quadratus**, producing **weak pinch (an abnormal 'OK' sign) and NO sensory loss**. On MRI, look for the localizing pattern — **classically isolated pronator quadratus edema** (subacute) on axial fat-sat images.

**The caveat that stops a surgeon:** an AIN palsy is **frequently neuralgic amyotrophy (Parsonage–Turner)**, NOT a mechanical compression. So **surgery is usually NOT indicated**; the work-up pivots to **EMG and observation**, and the history search turns to a **viral/post-vaccination prodrome or a broader brachial-plexus pattern** (other muscles outside a single nerve territory). Don't reflexively route isolated PQ/FPL denervation to decompression.

**Pronator syndrome — MIXED sensory + motor.** This is **median-nerve compression** more proximally, at one of several sites:

| Compression site |
|---|
| Between the two heads of **pronator teres** |
| Under the **lacertus fibrosus** |
| At the **FDS (sublimis) arch** |
| **Ligament of Struthers** (watch for a bony **supracondylar process**) |

Unlike isolated AIN palsy, pronator syndrome has **sensory symptoms** (volar forearm/hand) plus motor findings; on MRI hunt the supracondylar process and any mass at these sites.

**Management:** isolated pure-motor AIN palsy → think Parsonage–Turner, EMG/observation; a demonstrable structural compressive cause → decompression.

**Pearl:** An isolated pure-motor AIN palsy (weak pinch, no sensory loss, classically isolated pronator-quadratus edema) is frequently Parsonage–Turner neuralgic amyotrophy — so it usually does NOT need surgery; pivot to EMG and observation rather than decompression.

#### Topic 5: Radial/PIN at the arcade of Frohse, radial tunnel syndrome with a normal MRI, and hunting the mass

### Radial / PIN at the Arcade of Frohse, Radial Tunnel Syndrome & the Mass

The radial nerve divides at the **radiocapitellar level** into the superficial (sensory) branch and the **posterior interosseous nerve (PIN)**, which enters the supinator. The PIN is **most commonly compressed at the arcade of Frohse** — the proximal, often **fibrous** edge of the supinator.

**PIN syndrome — MOTOR.** It produces a **digit drop** (failure to extend the MCPs) with **radially-deviated wrist extension** because **ECRL is spared** (its branch leaves before the supinator). Localize by **denervation of the extensor compartment**: extensor digitorum, EDM, ECU, APL, EPB/EPL, EI.

- **The supinator is variably involved and often SPARED** — its motor branches frequently arise **proximal to the arcade**. **Do NOT assert supinator denervation as a constant PIN feature.**

**Radial tunnel syndrome — PAIN, no motor deficit.** Lateral forearm pain **without weakness and often a NORMAL MRI.** Say so rather than over-read; the value of imaging here is to **report (or exclude) a mass** at the arcade — **ganglion, lipoma, or a distended bicipitoradial bursa**.

| Entity | Motor deficit | MRI |
|---|---|---|
| **PIN syndrome** | Yes (digit drop, ECRL spared) | Extensor-compartment denervation; supinator often spared |
| **Radial tunnel syndrome** | No | Often normal — hunt for a mass at the arcade |

**Always look for a mass/cyst/ganglion as the compressive cause — anywhere along any of these nerves.** A space-occupying lesion **changes management from splinting/therapy to surgical referral**, so it is the finding worth the extra pass.

**Pearl:** PIN syndrome localizes by extensor-compartment denervation with ECRL spared, but the supinator is often spared and must NOT be claimed as a constant sign; radial tunnel syndrome is pain with a normal MRI — in both, the management-changing job is to find or exclude a mass at the arcade of Frohse.
...
Learning objectives:
- Recognize the elbow findings that shift the plan away from routine rehab: occult fracture behind a normal radiograph, septic arthritis/osteomyelitis, and aggressive marrow or soft-tissue lesions
- Identify the surgically urgent ligament, tendon, and bone injuries — complete UCL or LUCL avulsion, complete distal biceps (including the intact-lacertus mimic) or triceps avulsion, and the anteromedial coronoid facet fracture — and route each correctly
- Apply the confluent low-T1 marrow-replacement heuristic for tumor/infiltration while explicitly accounting for the benign causes (red-marrow reconversion, fracture, osteomyelitis, stress edema) that also lower T1
- Prioritize the single management-changing finding in the impression and assign each study to rehab/injection, surgical referral, or urgent escalation
Topics:
- Occult fracture behind a normal radiograph: the fat-pad sign, radial head, and the lateral condyle in children
- Surgically urgent soft-tissue avulsions: complete distal biceps (and the intact-lacertus mimic), triceps, full-thickness UCL, deep extensor/LUCL
- Bony instability you must name: the anteromedial coronoid facet (VPMRI) and the terrible triad
- Infection: septic bursa vs septic joint vs osteomyelitis, and why a warm bursa is aspirated, not just imaged
- The marrow red flag: confluent low-T1 replacement vs the benign mimics that also drop T1
Common mistakes:
- **Mistake:** Clearing an injured elbow because the radiograph is 'normal' despite a displaced posterior fat pad
  **Correction:** In an adult after trauma, a visible (displaced) posterior fat pad means hemarthrosis from an occult intra-articular fracture until proven otherwise — radial head most commonly. Search the marrow on MRI for the line; in children think supracondylar and the non-union-prone lateral condyle — whose Salter-Harris label is not uniform in the literature, and whose fat-pad sign can be falsely negative because the fracture often tears the capsule and decompresses the hemarthrosis, so look for lateral soft-tissue swelling on the AP view.
- **Mistake:** Calling a complete distal biceps tear a partial tear because the tendon has not retracted and the exam looks preserved
  **Correction:** An intact lacertus fibrosus tethers a fully torn tendon so it neither retracts nor produces an obvious clinical gap — the great mimic. Report partial-vs-complete, retraction in cm, AND lacertus integrity explicitly; do not be reassured by a preserved exam when the lacertus is intact.
- **Mistake:** Reflexively reading every confluent low-T1 marrow signal as a tumor red flag — or, conversely, burying real marrow replacement as 'edema'
  **Correction:** Confluent low-T1 marrow below skeletal muscle/disc that lacks interspersed fat — especially with a soft-tissue mass, cortical destruction, or a wide transition zone — is infiltration until proven otherwise. But benign processes (red-marrow reconversion in athletes/smokers, fracture, osteomyelitis, stress-injury edema) also lower T1, so frame the heuristic by the company it keeps rather than T1 alone.

#### Topic 1: Occult fracture behind a normal radiograph: the fat-pad sign, radial head, and the lateral condyle in children

### Occult Fracture Behind a Normal Radiograph

The classic miss: a post-traumatic elbow, a radiograph read as **normal**, and a patient sent to rehab — when the radiograph already told you a fracture is there. The tell is the **fat pad**.

- The **anterior fat pad** is normally seen and can elevate into a **sail sign**; the **posterior fat pad sits hidden in the olecranon fossa** and is normally invisible.
- **Any visible (displaced) posterior fat pad in an adult after trauma = hemarthrosis from an occult intra-articular fracture until proven otherwise** — most commonly the **radial head**.

Who fractures what:

| Patient | First suspect | Why it matters |
|---|---|---|
| **Adult** | **Radial head** | Most common occult intra-articular fracture; check the radiocapitellar line for an associated subluxation (occult Monteggia) |
| **Child** | **Supracondylar**, then the **lateral condyle** | The lateral condyle is the elbow fracture **most prone to non-union** (~1–5%) if missed; its **Salter-Harris label is not uniform** (Milch I = SH IV, while Milch II behaves as SH II and dominates operative series), and its **fat-pad sign can be falsely negative** because the fracture often decompresses the hemarthrosis — hunt **lateral soft-tissue swelling on AP** |

**MRI's job:** show the **low-signal fracture line on T1 plus surrounding marrow edema**, and separate a true fracture from a simple bone bruise. Always run the **radiocapitellar line** — a line through the central long axis of the radial **neck** (not the shaft) **should pass through the capitellum**, best assessed on the **lateral** view. A line that misses is **suggestive, not pathognomonic** (in normal pediatric radiographs the neck line still misses in about 1%, and sits outside the central third in roughly a quarter of lateral views, and it is degraded by forearm rotation and young age) — treat a miss as a prompt to hunt radial-head subluxation/dislocation and an occult Monteggia, and compare with the contralateral side.

**Mason framework (radial head):** I non-/minimally displaced, II displaced partial-articular (commonly >2 mm), III comminuted whole-head. Note the trap: the **surgical trigger is a mechanical block to forearm rotation or comminution (Mason III), NOT the 2 mm number alone** — many Mason II fractures without a block are managed nonoperatively.

**Pearl:** A visible posterior fat pad after elbow trauma is a fracture until proven otherwise — search the radial-head and (in children) lateral-condyle marrow on MRI even when the radiograph is called normal.

#### Topic 2: Surgically urgent soft-tissue avulsions: complete distal biceps (and the intact-lacertus mimic), triceps, full-thickness UCL, deep extensor/LUCL

### Surgically Urgent Soft-Tissue Avulsions

These are the soft-tissue injuries that convert a rehab plan into a same-week surgical conversation. Name each one in the impression — do not let it sink into a list.

**Complete distal biceps avulsion.** Look for an **empty radial tuberosity** with a **balled-up, retracted, wavy stump**; left unrepaired, a complete tear costs roughly **40% of supination and ~30% of flexion strength**, with a far larger hit to supination **ENDURANCE** (on the order of 80%) — the endurance loss, not the peak-strength loss, is what most patients actually notice. The **great mimic**: a complete tear with an **INTACT lacertus fibrosus**, which tethers the tendon so it does **not retract** and the exam looks deceptively preserved — it is routinely undercalled as a partial tear. Report **partial-vs-complete, retraction in cm, and lacertus status**, and refer promptly while the tendon still reaches the tuberosity. **There is no hard repair deadline** — earlier anatomic repair is technically easier and many primary repairs succeed out to ~4–6 weeks and beyond; only chronic, irreducible, retracted tears that will not reach the tuberosity need a graft. Bicipitoradial bursitis is a **clue** to scrutinize the footprint, not a diagnosis. FABS positioning lays the footprint flat for grading.

**Complete triceps avulsion.** A full-thickness gap with a retracted stump, often with a small **olecranon flake**. The **superficial** (posterior long/lateral-head) layer fails first while the **deep medial-head** attachment stays intact, and an intact lateral expansion preserves weak extension in most ruptures — so a tear can **look partial despite near-complete extension weakness**. Report **which layer** is torn, the percentage of width, and the gap. Complete rupture is surgical; high-grade partials (commonly **>50% width**, or **any tear with extension weakness against resistance**) are repaired.

**Full-thickness UCL in a thrower** and a **deep common-extensor tear involving the LUCL** are the ligamentous members of this list (developed in the next topic and in the medial/lateral modules). Each ends a season or changes an operation if missed.

**Pearl:** Do not be reassured by a preserved exam in a suspected distal-biceps rupture — an intact lacertus tethers a completely torn tendon so it neither retracts nor gaps; report lacertus integrity and retraction explicitly.

#### Topic 3: Bony instability you must name: the anteromedial coronoid facet (VPMRI) and the terrible triad

### Bony Instability You Must Name: The Anteromedial Coronoid Facet and the Terrible Triad

Two osseous patterns look small on radiographs but are inherently **unstable and surgical**. They are the bony don't-miss findings of the post-trauma elbow.

**Anteromedial coronoid facet fracture.** The **coronoid is the keystone of post-traumatic stability** (sublime tubercle medially, anteromedial facet laterally). A fracture of the **anteromedial facet** can look like a tiny rim fragment yet it implies **varus posteromedial rotatory instability (VPMRI)** — a distinct mechanism from PLRI — and, untreated, drives **early arthrosis**. Classify it: **O'Driscoll for the anteromedial facet**, **Regan–Morrey by height** (I tip avulsion, II ≤50%, III >50%). **CT maps the osseous fragments best.**

**The terrible triad** = **dislocation + radial head fracture + coronoid fracture**. It is unstable, and the **coronoid and the LCL are the reconstructive keystones** — name them. Remember the **O'Driscoll circle**: a dislocation disrupts soft tissue from **lateral to medial (LUCL → capsule → MCL)**, so the **LCL is the primary lesion in most simple dislocations** — comment on LUCL integrity in **every** post-dislocation elbow.

| Don't-miss bony finding | Implies | Route |
|---|---|---|
| **Anteromedial coronoid facet fracture** | VPMRI | Surgery (CT to map) |
| **Terrible triad** | Gross instability | Surgery — coronoid + LCL keystones |
| **Osborne–Cotterill lesion** | Prior dislocation, recurrent instability | Flag; correlate with PLRI |
| **Heterotopic ossification** | Stiff post-trauma elbow | Flag in any post-dislocation/stiff elbow |

On any post-dislocation study, hunt the **Osborne–Cotterill posterolateral capitellar impaction** and **post-traumatic heterotopic ossification**.

**Pearl:** A small anteromedial coronoid facet fragment is a surgical lesion — it implies varus posteromedial rotatory instability; classify it (O'Driscoll), get a CT to map it, and comment on LUCL integrity in every post-dislocation elbow.

#### Topic 4: Infection: septic bursa vs septic joint vs osteomyelitis, and why a warm bursa is aspirated, not just imaged

### Infection: Septic Bursa vs Septic Joint vs Osteomyelitis

The elbow is a common site for **olecranon bursitis**, and the single most important teaching point is a limitation, not a sign: **MRI cannot reliably exclude infection.**

- A **red, warm, fluctuant olecranon bursa** needs **ASPIRATION**, not just imaging. Do not let a normal-looking or 'reactive' MRI talk a clinician out of tapping a bursa that is clinically inflamed.
- **Aseptic bursitis** is caused by **gout, rheumatoid arthritis, and repetitive trauma** — the picture can overlap completely with septic bursitis on MRI.

When the deeper compartments are involved, the threshold to escalate drops fast:

| Process | Imaging clue | Don't-miss point |
|---|---|---|
| **Septic bursitis** | Distended bursa ± rim enhancement | MRI cannot exclude it — **aspirate the warm bursa** |
| **Septic joint** | **Joint effusion + aggressive periarticular edema + rim enhancement** | Escalate urgently; not a rehab problem |
| **Osteomyelitis** | Marrow edema/replacement with cortical involvement | Cannot be confidently separated from aggressive inflammation on signal alone |

**Joint effusion plus aggressive periarticular edema and rim-enhancement escalates urgently.** The role of MRI here is to **map extent and raise the alarm**, not to grant clearance — the diagnosis is made by **aspiration and the clinical picture**.

**Pearl:** A warm, fluctuant olecranon bursa is aspirated, not just imaged — MRI cannot exclude infection, and gout, RA, and repetitive trauma all mimic a septic bursa.

#### Topic 5: The marrow red flag: confluent low-T1 replacement vs the benign mimics that also drop T1

### The Marrow Red Flag: Confluent Low-T1 Replacement — and Its Benign Mimics

The highest-stakes marrow call is **infiltration/tumor**, and the anchor is **T1**, not the fluid-sensitive sequence.

**The red-flag pattern:** **confluent low-T1 marrow signal that drops BELOW skeletal muscle or disc and lacks interspersed fat.** This is **marrow replacement** — tumor or infiltration until proven otherwise — and it is most convincing when it keeps dangerous company:

- an associated **soft-tissue mass**,
- **cortical destruction**, or
- a **wide (ill-defined) transition zone**.

Do **not** bury a replacement pattern as 'edema' on the fat-sat images — edema is bright on fluid-sensitive sequences but, on its own, does not produce confluent sub-muscle T1 signal.

**The honest caveat — benign processes also lower T1.** Frame the heuristic carefully:

| Lowers T1 but usually benign | What gives it away |
|---|---|
| **Red-marrow reconversion** (athletes, smokers) | Signal stays **at or above** muscle, spares subchondral/epiphyseal fat, symmetric |
| **Fracture / stress-injury edema** | A discrete line or a clinical injury; geographic, not mass-like |
| **Osteomyelitis** | Clinical infection; cannot always be separated on signal alone |

The discriminator is **signal level relative to muscle/disc, loss of interspersed fat, and the company it keeps** (mass, cortical breach, wide transition zone) — not a bright fluid-sensitive signal alone. When the pattern is confluent, sub-muscle, fat-poor, and accompanied by a mass or cortical destruction, escalate for tissue characterization rather than reassuring the patient.

**Pearl:** Confluent low-T1 marrow that drops below muscle/disc and lacks interspersed fat is replacement until proven otherwise — but red-marrow reconversion, fracture, and osteomyelitis also lower T1, so escalate on the company it keeps (mass, cortical destruction, wide transition zone), not T1 alone.

## Cases

### UCL Tear in a Thrower (Distal Avulsion + T-Sign)

ID: `elbow-ucl-tear-thrower` · Difficulty: foundational · Tier: core · Resident visible: true

Clinical scenario: A 19-year-old collegiate pitcher reports progressive medial elbow pain and loss of velocity over a single season, culminating in a 'pop' and sharp pain at ball release. The moving-valgus stress test is positive, reproducing his pain through the late-cocking/acceleration arc. The clinical question is a thrower's UCL injury versus isolated medial epicondylitis versus ulnar neuritis.
...
- **Step 1: Verify Protocol & Clinical Question**
...
Teaching media:
- src=/images/teaching/us/elbow-ucl.jpg | alt=Long-axis ultrasound of the elbow UCL anterior bundle | caption=US correlate: long-axis medial elbow — medial epicondyle, trochlea, sublime tubercle, and the humeroulnar joint gap that valgus-stress US measures. | attribution=van Trigt B et al., J Shoulder Elbow Surg Int, 2024. PMC11065662. CC-BY 4.0.
...
- src=/images/teaching/us/elbow-ulnar-nerve.jpg | alt=Ultrasound and MRI of the normal ulnar nerve at the elbow | caption=US and MRI correlate: the normal ulnar nerve — honeycomb fascicles in short axis, and isointense to muscle on T1 with only mild fluid-sensitive signal in the cubital tunnel. Mild T2 signal alone is not neuritis. | attribution=Albano D et al., Insights Imaging, 2025. PMC11780019. CC-BY 4.0.

### Capitellar Osteochondritis Dissecans — Stable vs Unstable

ID: `elbow-capitellar-ocd` · Difficulty: intermediate · Tier: core · Resident visible: true

Clinical scenario: A 13-year-old competitive gymnast (also pitches Little League) presents with several months of progressive lateral elbow pain, intermittent catching, and a fixed 15-degree loss of terminal extension (flexion contracture). Pain worsens with weight-bearing on the arms and with throwing; radiographs show a focal anterolateral capitellar lucency, prompting MRI to characterize the lesion and judge its stability.
...
1. CAPITELLAR OSTEOCHONDRITIS DISSECANS (OCD), anterolateral capitellum, in a skeletally immature gymnast/thrower — focal and lesional, distinguishing it from Panner disease (which is a self-limited osteochondrosis of the whole ossific nucleus in a younger child).
...
### Distal Biceps Tendon Tear (Retraction + Lacertus)

ID: `elbow-distal-biceps-tear` · Difficulty: foundational · Tier: core · Resident visible: true

Clinical scenario: A 48-year-old man felt a sudden tearing sensation in the front of the elbow while lifting a heavy box with the elbow flexed at about 90 degrees. He has antecubital ecchymosis, weak and painful resisted supination, and a positive hook test (the examiner cannot hook a finger under an intact distal biceps tendon laterally).
...
1. COMPLETE (full-thickness) distal biceps tendon tear avulsed from the radial tuberosity, with an EMPTY footprint and a balled-up retracted stump.
...
ID: `elbow-lateral-epicondylitis-lucl` · Difficulty: foundational · Tier: core · Resident visible: true

Clinical scenario: A 45-year-old recreational tennis player presents with chronic lateral elbow pain refractory to a dedicated rehabilitation program, tender over the lateral epicondyle. The clinical question is the grade of common-extensor pathology and, critically, whether the adjacent lateral ulnar collateral ligament is involved.
...
PROTOCOL: Non-contrast 3T elbow MRI; coronal and axial fluid-sensitive fat-saturated (T2 FS) and T1 sequences. Clinical question: chronic lateral epicondylitis refractory to rehab — grade the common extensor origin and, critically, assess the adjacent LUCL for a deep tear implying posterolateral rotatory instability. The deep common-extensor/LUCL interface is read on coronal + axial together.
...
1. Lateral epicondylitis: common extensor (ECRB) origin tendinosis with a DEEP partial-thickness undersurface tear that undercuts and communicates with the radiocapitellar joint.
...
1. Medial (common flexor-pronator) epicondylitis with a partial-thickness origin tear - thickening, intrasubstance fluid signal, and a focal deep partial tear, NOT a full-thickness avulsion.
...
1. Cubital tunnel syndrome: an enlarged, T2-hyperintense ulnar nerve at/just distal to the medial epicondyle with subacute FCU and ulnar-FDP denervation edema — concordant with the patient's flexion-provoked ulnar paresthesias and positive Tinel.
...
ID: `elbow-veo-posteromedial-loose-body` · Difficulty: advanced · Tier: advanced · Resident visible: false

Clinical scenario: A 34-year-old veteran right-handed professional baseball pitcher reports deep posterior elbow pain that is sharpest at ball release (terminal extension), a 10-degree loss of terminal extension, and an intermittent painful catching/locking sensation. He has a long history of high-volume throwing, and on exam there is posteromedial olecranon tenderness, pain on forced extension with valgus (the valgus-extension-overload provocation), and equivocal medial laxity on the moving-valgus test.
...
PROTOCOL: Non-contrast 3T elbow MRI of the throwing (right) arm with coronal, axial, and sagittal fluid-sensitive fat-saturated (T2 FS/STIR) and T1 sequences. Clinical question: posterior elbow pain and mechanical catching at ball release in a professional pitcher - valgus extension overload versus a loose body, with the UCL specifically in question. NOTE: sagittal fluid-sensitive images are the workhorse for clearing the dependent recesses for loose bodies; MR arthrography or a valgus-applied adjunct is reserved for if the UCL undersurface remains equivocal.
...
1. Valgus extension overload of the throwing elbow: posteromedial olecranon osteophyte with kissing posteromedial trochlear/olecranon-fossa chondral wear and reactive marrow edema.
...
### Occult Radial Head Fracture vs Normal Variant (Pseudodefect)

ID: `elbow-occult-radial-head-fracture` · Difficulty: intermediate · Tier: core · Resident visible: true

Clinical scenario: A 30-year-old presents after a fall on the outstretched hand (FOOSH) with lateral elbow pain, tenderness over the radial head, and painful, mechanically limited forearm pronation/supination. Radiographs show a displaced posterior fat-pad sign (elbow effusion/hemarthrosis) but no definite fracture line. MRI is requested to confirm an occult fracture and exclude an osteochondral lesion.
...
1. Non-displaced occult RADIAL HEAD/NECK fracture (fracture line + marrow edema) with a hemarthrosis displacing the posterior fat pad — confirming the radiographic fat-pad sign. A displaced posterior fat pad after trauma with a normal radiograph is an occult intra-articular fracture (radial head most common in adults) until proven otherwise; MRI confirms it and distinguishes a true fracture (line + edema) from a bone bruise (edema only).
...
Guided tour:
- **1. Get oriented** (slice 12) Coronal T2 FS through the elbow: the distal humerus is above, the proximal radius and ulna below, and the joint runs across the middle. Fat-sat makes fluid and edema bright. This is the plane for the UCL anterior bundle (to the sublime tubercle), the common flexor and extensor origins off the epicondyles, the RCL/LUCL origin, and the radiocapitellar surface where capitellar OCD lives. The rounded radial-head disc sits on the LATERAL side.
- **2. Capitellum** (slice 12) The capitellum is the rounded lateral condyle of the distal humerus, articulating with the radial head. It is THE site of osteochondritis dissecans in the adolescent thrower/gymnast — read its subchondral signal here on the coronal, then confirm on the sagittal (OCD is read on both planes together).
  - Capitellum @ x=62, y=50
- **3. Trochlea** (slice 12) The trochlea is the spool-shaped medial articular surface of the distal humerus, articulating with the trochlear notch of the ulna. Trace its smooth subchondral cortex; the transverse trochlear ridge/groove is a normal contour, not an osteochondral lesion.
  - Trochlea @ x=46, y=50
- **4. Radial head** (slice 12) The radial head is the round disc of the proximal radius articulating with the capitellum laterally — the most common site of an occult fracture after a fall on the outstretched hand. Confirm the cortex is smooth and the marrow uniform; the posterolateral capitellar pseudodefect nearby is a normal bare-area groove.
  - Radial head @ x=65, y=64
- **5. Ulnar collateral ligament (anterior bundle)** (slice 12) The anterior bundle of the UCL is the primary valgus restraint, running from the anteroinferior medial epicondyle to the sublime tubercle of the coronoid. Normal = a thin, taut, uniformly dark band to its distal attachment. The thrower's partial undersurface tear can produce a T-sign: fluid undercutting these distal fibers beyond the articular-cartilage edge.
  - UCL (anterior bundle) @ x=37, y=56
- **6. Common flexor-pronator origin** (slice 12) The common flexor-pronator tendon arises off the medial epicondyle and overlies the UCL. It is the site of medial epicondylitis (golfer's elbow) — read it together with the UCL and the ulnar nerve (the medial 'valgus triad'), since valgus overload injures all three.
  - Common flexor origin @ x=34, y=44
- **7. Common extensor origin** (slice 12) The common extensor tendon (ECRB) arises off the lateral epicondyle — the site of lateral epicondylitis (tennis elbow). The LUCL/RCL origin lies deep to it, so always trace the LUCL to the supinator crest: a deep extensor tear that takes the LUCL implies posterolateral rotatory instability.
  - Common extensor origin @ x=69, y=44
- **8. Do-not-overcall checkpoint** (slice 12) Before leaving the coronal stack, pause on the normal variants: the posterolateral capitellar pseudodefect is a posterior non-articular bare-area groove, not OCD by itself; a tiny distal UCL recess is not automatically a T-sign; and mild signal near the common extensor/LCL origin needs a real tear pattern before you call instability. Orthogonal confirmation is the habit.

Knowledge check:
- **ec-cor-q1:** On this coronal T2 FS image, what is the marked rounded lateral condyle of the distal humerus? (slice 12)
  - A. Trochlea
  - B. Capitellum [CORRECT]
  - C. Radial head
  - D. Olecranon
    Explanation: The rounded LATERAL condyle articulating with the radial head is the capitellum — the site of osteochondritis dissecans in the young thrower/gymnast. The trochlea is the spool-shaped MEDIAL articular surface that articulates with the ulna.
- **ec-cor-q2:** The thin dark band running from the medial epicondyle toward the sublime tubercle is the: (slice 12)
  - A. Lateral ulnar collateral ligament
  - B. Anterior bundle of the UCL [CORRECT]
  - C. Annular ligament
  - D. Common extensor tendon
    Explanation: The anterior bundle of the UCL is the primary valgus restraint, inserting on the sublime tubercle — where the thrower's undersurface (T-sign) tear classically occurs. The LUCL is the lateral restraint to posterolateral rotatory instability.
- **ec-cor-q3:** Tendinosis of the marked origin off the lateral epicondyle is the lesion in lateral epicondylitis. Which adjacent ligament must you always trace here? (slice 12)
  - A. The anterior bundle of the UCL
  - B. The LUCL to the supinator crest [CORRECT]
...
- **ec-cor-q6:** An 8-year-old gymnast has lateral elbow pain, and the ENTIRE ossific nucleus of the marked structure is low-signal and fragmented-appearing, with no discrete fragment, no subchondral cyst, and no loose body. What is the most likely diagnosis? (slice 12)
  - A. Panner disease [CORRECT]
  - B. Capitellar osteochondritis dissecans
  - C. The posterolateral capitellar pseudodefect
  - D. Radiocapitellar septic arthritis
    Explanation: Panner disease is a self-limited osteochondrosis of the WHOLE capitellar ossific nucleus in a younger child (~5–10 yr) — fragmented-looking and low signal, but with no discrete fragment, cyst, or loose body. Capitellar OCD is the tempting answer, and it fails on both age and extent: OCD is a FOCAL anterolateral/central lesion of the adolescent (~12–17 yr) that can fragment and shed a loose body. The pseudodefect is a small posterolateral bare-area groove, not a diffuse nucleus abnormality.
- **ec-cor-q7:** A fellow reports a contour notch at the POSTEROLATERAL margin of the marked capitellum as an osteochondral lesion. Why is that an over-call? (slice 12)
  - A. That notch is the normal capitellar pseudodefect (a bare-area groove); true OCD is anterolateral/central at the radiocapitellar contact zone [CORRECT]
  - B. It is the pseudodefect, but true OCD is also posterolateral, so location cannot separate the two
  - C. Any capitellar contour notch is an OCD — the pseudodefect only occurs at the trochlea
  - D. It is the transverse trochlear ridge, a normal variant of the capitellum
    Explanation: The pseudodefect is a normal posterolateral/postero-inferior bare-area groove at the capitellum–lateral-epicondyle junction, while true capitellar OCD sits anterolateral/central in the radiocapitellar contact zone with a corroborating sign (fluid rim, cyst, cartilage breach, or fragment). The tempting distractor keeps the pseudodefect label but abandons the location rule — location is exactly what separates variant from lesion here. The transverse trochlear ridge is a normal contour of the TROCHLEA, not the capitellum.
- **ec-cor-q8:** A ridge and shallow groove interrupt the contour of the marked spool-shaped surface. What is this most likely to be? (slice 12)
  - A. The normal transverse trochlear ridge/groove [CORRECT]
  - B. An osteochondral defect
  - C. A displaced loose body
  - D. The capitellar pseudodefect
    Explanation: The transverse trochlear ridge and its adjacent groove are a normal bony contour of the trochlea. Calling it an osteochondral defect is the over-call this course guards against: an osteochondral lesion needs a corroborating sign — a fluid rim, a subchondral cyst, a cartilage breach, or a fragment — not a contour alone. The capitellar pseudodefect is the analogous normal groove, but it lies laterally at the capitellum, not on the trochlea.
- **ec-cor-q9:** On a thrower's coronal image, which finding indicates a FULL-thickness tear of the marked ligament rather than the partial undersurface (T-sign) pattern? (slice 12)
  - A. Fluid-bright signal spanning the entire thickness with a gap/retraction, or medial extravasation through the defect [CORRECT]
  - B. Fluid undercutting the distal fibers beyond the articular-cartilage edge while the proximal fibers stay attached
  - C. A couple of millimetres of fluid at the distal attachment on the sublime tubercle
  - D. A thickened, heterogeneous, partly ossified band with no surface-reaching defect
    Explanation: A full-thickness tear shows fluid-bright signal across the whole thickness with a gap or retraction, or fluid/contrast extravasating medially through the defect. The tempting distractor describes the T-sign, which is by definition an articular-sided PARTIAL tear — the proximal fibers are still attached — a different grade and a different conversation. A couple of millimetres of fluid at the attachment can be a normal synovial recess, and a thickened/heterogeneous/ossified band without a surface-reaching defect reads as chronic sprain.
- **ec-cor-q10:** The marked band is the anterior bundle of the UCL. Which component of the UCL complex forms the floor of the cubital tunnel and contributes little to valgus restraint? (slice 12)
  - A. Posterior bundle [CORRECT]
  - B. Anterior bundle
  - C. Transverse (Cooper) ligament
  - D. Annular ligament
    Explanation: The posterior bundle forms the floor of the cubital tunnel — it matters to the ulnar nerve, not to valgus stability. The anterior bundle is the primary valgus restraint across the functional throwing arc and the band reconstructed in Tommy John surgery. The transverse (Cooper) ligament runs coronoid-to-olecranon with a negligible mechanical role and does not floor the tunnel, and the annular ligament is a LATERAL structure encircling the radial neck.
- **ec-cor-q11:** In a 45-year-old golfer the marked common flexor-pronator origin is thickened with intermediate — not fluid-bright — signal, and there is no surface-reaching defect. What is the best description? (slice 12)
  - A. Tendinosis (degenerative/angiofibroblastic), no tear [CORRECT]
  - B. A partial-thickness tear
  - C. A full-thickness tear of the origin
  - D. A grade 3 flexor-pronator muscle strain
    Explanation: Thickening with intermediate signal and no surface-reaching fluid or gap is tendinosis — and despite the '-itis' in medial epicondylitis, the underlying process is degenerative angiofibroblastic tendinosis rather than inflammation. The tempting distractor, a partial tear, requires FLUID-BRIGHT signal reaching a surface or a focal discontinuity; a full-thickness tear requires a complete fluid-bright gap at the origin. A grade 3 strain is complete discontinuity with retraction, typically at the myotendinous junction, not at the bony origin.
- **ec-cor-q12:** Alongside tendinosis of the marked common extensor origin you see reactive lateral-epicondyle marrow edema and thin signal within the RCL, with the deep fibers intact and no fluid-bright gap. How should this be reported? (slice 12)
  - A. Common extensor tendinosis with reactive change — do NOT call an LCL tear from reactive marrow edema or thin RCL signal alone [CORRECT]
  - B. A full-thickness LUCL tear implying posterolateral rotatory instability
  - C. A deep extensor tear communicating with the radiocapitellar joint, converting this into a ligament reconstruction
  - D. An Osborne–Cotterill posterolateral capitellar impaction lesion
    Explanation: Reactive lateral-epicondyle marrow edema and thin RCL signal commonly accompany lateral epicondylitis and must not be over-called as an LCL tear. The surgical lesion you are hunting is specific and absent here: a deep/full-thickness common extensor tear with a FLUID-BRIGHT GAP that undercuts or communicates with the radiocapitellar joint AND involves the LUCL — that combination implies PLRI, but the deep fibers in this case are intact. The Osborne–Cotterill lesion is a posterolateral capitellar impaction fracture after dislocation, a different entity.
- **ec-cor-q13:** A line drawn through the central long axis of the radial neck should pass through which structure? (slice 12)
  - A. Capitellum [CORRECT]
  - B. Trochlea
  - C. Coronoid process
  - D. Olecranon
    Explanation: The radiocapitellar line — drawn along the central long axis of the radial NECK (not the shaft), and most reliable on the LATERAL view — should pass through the CAPITELLUM; a line that misses points to radial-head subluxation or dislocation, including an occult Monteggia injury. Treat it as SUGGESTIVE, not pathognomonic: in 116 normal pediatric elbows the neck line still missed the capitellum in about 1% of tracings and passed through the central third only about three-quarters of the time on the lateral view (roughly half on AP), and it is degraded by forearm rotation, observer bias, and young age (least reliable under 5). So correlate with the contralateral side rather than calling instability off the line alone. The trochlea is the medial distal-humeral surface and articulates with the ulna, so it is never the radial-head partner; the coronoid and olecranon are ulnar processes.

### Plane: axi-t2fs

Guided tour:
- **1. Get oriented** (slice 16) Axial T2 FS cross-section through the elbow: the bone is central, ringed by the flexor-pronator (medial), extensor (lateral), brachialis (anterior), and triceps (posterior) compartments. This is the plane for the nerves — the ulnar nerve in the cubital tunnel, the radial nerve/PIN at the radiocapitellar level — and for the annular ligament and the distal biceps footprint. Compare a nerve to its mate and the other side.
- **2. Ulnar nerve (cubital tunnel)** (slice 16) The ulnar nerve sits in the cubital tunnel posterior to the medial epicondyle, beneath Osborne's retinaculum. Normal = an ovoid nerve of caliber and signal similar to the median nerve and the contralateral side. Assess for flexion subluxation, an anconeus epitrochlearis, or a ganglion — a structural cause can shift operative planning from in-situ decompression toward transposition. (Mild T2 brightness alone can be normal.)
  - Ulnar nerve (cubital tunnel) @ x=20, y=61
- **3. Common flexor-pronator (cross-section)** (slice 16) The common flexor-pronator mass arises off the medial epicondyle anteromedially. In cross-section, grade tendinosis vs a surface-reaching tear at the origin; the ulnar nerve sits just posterior to it, which is why golfer's elbow and ulnar neuritis travel together.
  - Common flexor-pronator @ x=30, y=55
- **4. Common extensor (cross-section)** (slice 16) The common extensor origin arises off the lateral epicondyle anterolaterally. Cross-section helps grade extensor tendinosis vs a deep tear; the radial nerve and its PIN branch run nearby at the radiocapitellar level (the PIN dives under the arcade of Frohse into the supinator).
...
Knowledge check:
- **ec-axi-q1:** The marked nerve sits posterior to the medial epicondyle. Mild T2 brightness here can be normal — what anchors a diagnosis of cubital tunnel syndrome? (slice 16)
  - A. T2 signal alone
  - B. Caliber change + muscle denervation + clinical correlation [CORRECT]
  - C. Any anterior position of the nerve
  - D. The presence of a normal Osborne retinaculum
    Explanation: The ulnar nerve in the cubital tunnel can show mild T2 brightness normally, so anchor the call to nerve enlargement PLUS FCU/ulnar-intrinsic denervation PLUS clinical correlation — and look for a structural cause (subluxation, accessory muscle) that can change operative planning.
- **ec-axi-q2:** Why does the common flexor-pronator origin (medial epicondylitis) travel with ulnar neuritis? (slice 16)
  - A. They share a blood supply
  - B. The cubital tunnel and ulnar nerve sit immediately posterior to the flexor-pronator origin [CORRECT]
...
- **ec-axi-q8:** In a patient with flexion-provoked medial snapping and ulnar symptoms, why does it matter whether the MEDIAL head of the marked triceps subluxates over the medial epicondyle? (slice 16)
  ...
  - C. It establishes a triceps tendon rupture requiring urgent repair
  - D. It localizes the symptoms to the shoulder, so no elbow surgery is warranted
...
- **ec-axi-q9:** The radial nerve divides at the radiocapitellar level near the marked lateral compartment. Beneath which structure is the posterior interosseous nerve most commonly compressed? (slice 16)
  - A. The arcade of Frohse (the proximal edge of the supinator) [CORRECT]
  - B. Osborne's retinaculum
  - C. The lacertus fibrosus
  - D. The annular ligament
    Explanation: The PIN enters the supinator beneath the arcade of Frohse — that muscle's proximal, often fibrous edge — which is its most common compression point. Osborne's retinaculum roofs the CUBITAL TUNNEL and is an ulnar-nerve structure on the medial side; the lacertus fibrosus is an anteromedial median-nerve (pronator syndrome) site; and the annular ligament stabilizes the radial head rather than tunnelling a nerve. Localize PIN syndrome by extensor-compartment denervation, remembering the supinator itself is often spared.
- **ec-axi-q10:** You call medial epicondylitis at the marked origin. Which ligament lies deep to it and must be traced to its distal attachment before you sign off? (slice 16)
  - A. The anterior bundle of the UCL, traced to the sublime tubercle [CORRECT]
  - B. The LUCL, traced to the supinator crest
  - C. The annular ligament, traced around the radial neck
  - D. The posterior bundle of the UCL, traced to the olecranon
    Explanation: The common flexor-pronator tendon drapes directly over the anterior bundle of the UCL, so every medial epicondylitis read must trace that bundle to the sublime tubercle — a concomitant UCL tear is what shifts a thrower's conversation toward reconstruction. Tracing the LUCL to the supinator crest is the correct habit on the LATERAL side beneath the common extensor, which makes it the tempting but wrong-sided answer here. The annular ligament is lateral, and the posterior bundle is the cubital-tunnel floor with a minimal valgus role.
...
- **2. Trochlea / capitellum (articular surface)** (slice 14) The distal-humeral articular surface curves through this slice, capped by its hyaline cartilage. Trace the contour as smooth; read a capitellar OCD here together with the coronal face to judge the lesion's anterior-to-posterior extent and the overlying cartilage. A thin posterolateral radiocapitellar plica/synovial fold can be normal; it becomes clinically relevant when thickened, edematous, or tied to snapping/catching.
  - Trochlea / capitellum @ x=55, y=49
- **3. Coronoid process** (slice 14) The coronoid is the anterior beak of the proximal ulna and the keystone of post-traumatic stability — an anteromedial facet fracture can look small on radiographs yet imply varus posteromedial rotatory instability, so it deserves instability-focused surgical review. The sublime tubercle on its medial aspect is the UCL's distal attachment.
  - Coronoid process @ x=45, y=60
- **4. Olecranon & triceps insertion** (slice 14) The olecranon is the posterior beak of the ulna where the triceps inserts. In the thrower, the posteromedial olecranon is the site of the valgus-extension-overload osteophyte and a posterior loose body. Sweep the olecranon fossa just above it for loose bodies on this fluid-sensitive plane.
  - Olecranon @ x=63, y=60
- **5. Fat pads (coronoid & olecranon fossae)** (slice 14) The anterior fat pad sits in the coronoid fossa and is normally visible; the posterior fat pad hides in the olecranon fossa and is normally NOT seen. After trauma, an elevated anterior fat pad or any visible posterior fat pad signals an effusion/hemarthrosis from an occult fracture until proven otherwise.
  - Anterior fat pad @ x=47, y=38
  - Olecranon fossa / posterior fat-pad location @ x=62, y=40
- **6. Brachialis & distal biceps (anterior)** (slice 14) Anteriorly, the brachialis fills the antecubital fossa and the distal biceps tendon dives toward its radial-tuberosity footprint. A complete biceps tear retracts UNLESS an intact lacertus fibrosus tethers it — so on a dedicated FABS view, report partial-vs-complete, the retraction distance, and the lacertus.
  - Brachialis / distal biceps @ x=33, y=55
- **7. Do-not-overcall checkpoint** (slice 14) On sagittal images, a thin posterolateral radiocapitellar plica can be normal, and a capitellar contour finding still needs the coronal face before you call OCD. A visible posterior fat pad after trauma is abnormal, but a normally seen anterior fat pad is not. For distal biceps/triceps tears, describe continuity, gap/retraction, and functional-grade clues rather than relying on one plane.

Knowledge check:
- **ec-sag-q1:** After elbow trauma with a normal radiograph, which fat-pad finding signals an occult fracture until proven otherwise? (slice 14)
  - A. A visible anterior fat pad
  - B. A displaced/elevated POSTERIOR fat pad [CORRECT]
  - C. Absence of the anterior fat pad
  - D. A small joint effusion alone
    Explanation: The posterior fat pad is normally hidden in the olecranon fossa; a visible/displaced posterior fat pad after trauma means a hemarthrosis from an occult intra-articular fracture (most often the radial head) until proven otherwise. The anterior fat pad is normally seen.
- **ec-sag-q2:** The marked anterior beak of the proximal ulna is the keystone of post-traumatic stability. A small fracture of which part implies varus posteromedial rotatory instability? (slice 14)
  - A. The olecranon tip
  - B. The anteromedial coronoid facet [CORRECT]
  - C. The radial styloid
  - D. The sublime tubercle only
    Explanation: An anteromedial coronoid facet fracture may look small on radiographs but can imply varus posteromedial rotatory instability (VPMRI) and needs instability-focused surgical review — 'small does not mean stable' at the coronoid. The sublime tubercle (medial) is the UCL's distal attachment.
- **ec-sag-q3:** A thin posterolateral radiocapitellar synovial fold on this sagittal elbow MRI is best interpreted how? (slice 14)
  - A. A normal plica/fold unless thickened, edematous, or associated with snapping/catching [CORRECT]
  - B. A displaced loose body until proven otherwise
...
- **ec-sag-q6:** The marked anterior fat pad is normally visible in the coronoid fossa. What does it mean when it is lifted into a triangular 'sail' after trauma? (slice 14)
  - A. A joint effusion/hemarthrosis — search the marrow for an occult intra-articular fracture [CORRECT]
  - B. Nothing — anterior fat-pad displacement is normal at any degree
  - C. A loose body has pushed it out of the coronoid fossa
  - D. A complete distal biceps tear with proximal retraction
    Explanation: The anterior fat pad is normally SEEN, but ELEVATION into a triangular sail sign means the joint is distended — after trauma that is a hemarthrosis, and the occult intra-articular fracture (radial head first in an adult; supracondylar, then the non-union-prone lateral condyle, in a child) must be hunted in the marrow. The tempting distractor confuses 'normally visible' with 'displacement is normal': visibility is normal, displacement is not. A loose body is a discrete fragment rather than a diffuse fat-pad displacement, and a biceps tear does not distend the joint capsule.
- **ec-sag-q7:** A pitcher has posterior elbow pain and catching, with a posteromedial osteophyte at the marked process and a posterior loose body. Which structure must also be assessed before an osteophyte debridement is recommended? (slice 14)
  - A. The UCL — debriding the valgus-extension-overload osteophyte without addressing valgus laxity can unmask instability [CORRECT]
  - B. The annular ligament, the usual cause of posterior catching
  - C. The lacertus fibrosus, which tethers the olecranon
  - D. The anterior fat pad, which is resected with the osteophyte
    Explanation: The posteromedial olecranon osteophyte is the chronic end of valgus extension overload: UCL insufficiency lets the posteromedial olecranon impinge in the olecranon fossa. The osteophyte generates the catching, but debriding it without addressing the underlying valgus laxity can unmask instability — so the UCL is interrogated on every VEO elbow. The annular ligament stabilizes the radial head laterally, the lacertus fibrosus belongs to the distal biceps, and the anterior fat pad is a normal anterior structure.
- **ec-sag-q8:** In an adolescent thrower with posterior elbow pain, what separates an olecranon stress FRACTURE from a lower-grade stress reaction? (slice 14)
  - A. A discrete low-signal line in addition to marrow edema; edema without a line is a stress reaction [CORRECT]
  - B. The amount of marrow edema alone — more edema means fracture
  - C. A visible posterior fat pad, which is specific for an olecranon stress fracture
  - D. Any bright signal in the olecranon apophysis, which is always pathologic in a teenager
    Explanation: A discrete low-signal LINE plus marrow edema makes it a stress fracture (longer rest, with fixation considered if it widens or displaces); edema without a line is a lower-grade stress reaction. Grading by edema volume is the tempting error — edema is the smoke, the line is the fire. A visible posterior fat pad indicates an effusion/hemarthrosis and does not localize to one bone. And the olecranon apophysis fuses in the mid-to-late teens (later in throwers), so apophyseal signal calls for contralateral comparison rather than a blanket call.
- **ec-sag-q9:** A 55-year-old laborer who has never thrown has locking and catching, and a loose body sits in the marked olecranon fossa. What is the most likely source? (slice 14)
  - A. Primary elbow osteoarthritis — coronoid/olecranon-tip and fossa osteophytes with chondral loss [CORRECT]
  - B. A thrower's valgus-extension-overload osteophyte
  - C. Capitellar osteochondritis dissecans
  - D. Synovial chondromatosis, the most common cause of elbow loose bodies
    Explanation: In a non-thrower or laborer, primary elbow osteoarthritis — coronoid- and olecranon-tip osteophytes, fossa osteophytes, and capitellar/radial-head chondral loss — is the most common source of loose bodies and mechanical symptoms. Valgus extension overload and capitellar OCD are genuine sources, but they belong to the overhead thrower and the adolescent respectively, so they are the wrong population here. Synovial chondromatosis does shed bodies but is uncommon and is not the leading cause.
- **ec-sag-q10:** A subtle contour irregularity of the marked articular surface is visible on this sagittal image but cannot be found anywhere on the coronal stack. What is the correct interpretation? (slice 14)
  - A. Treat it as partial-volume averaging or a normal contour — an osteochondral lesion must be confirmed on coronal AND sagittal [CORRECT]
  - B. Report a capitellar OCD, since the sagittal plane best profiles the cartilage contour
  - C. Report an unstable OCD, because a lesion invisible on the orthogonal plane must be displaced
  - D. Report Panner disease, which is a sagittal-only diagnosis
    Explanation: A finding present on one plane and absent on the orthogonal plane is partial-volume averaging or a normal contour until proven otherwise — which is exactly why capitellar OCD is read on coronal AND sagittal together, the coronal supplying the radiocapitellar face and the sagittal the anterior-to-posterior extent. The tempting distractor (sagittal alone profiles the contour best) is the classic protocol error this course corrects. On MRI, instability is judged at the fragment–bone interface, not by which plane shows the lesion (and the surgeon adds the physeal status and motion exam), and Panner is a diffuse whole-nucleus process in a young child rather than a plane-specific call.
- **ec-sag-q11:** Two classification systems are applied to the marked process after trauma. Which pairing is correct? (slice 14)
  - A. O'Driscoll classifies the anteromedial facet (the VPMRI lesion); Regan–Morrey grades coronoid height [CORRECT]
  - B. Regan–Morrey classifies the anteromedial facet; O'Driscoll grades coronoid height
  - C. Mason grades coronoid height; O'Driscoll classifies the radial head
  - D. Both systems grade coronoid height and are interchangeable
    Explanation: O'Driscoll classifies the ANTEROMEDIAL FACET — the fragment that implies varus posteromedial rotatory instability and is surgical even when it looks small on radiographs — while Regan–Morrey grades coronoid HEIGHT (I tip avulsion, II ≤50%, III >50%). Swapping the two is the common error, and it matters because the facet, not the height, is what flags the VPMRI mechanism. Mason is the RADIAL HEAD system, and the two coronoid schemes answer different questions, so they are not interchangeable.
- **ec-sag-q12:** Standard planes foreshorten the distal biceps as it turns toward the radial tuberosity. Which dedicated positioning lays that footprint flat for partial-vs-complete grading and retraction measurement? (slice 14)
  - A. FABS — Flexed elbow, ABducted shoulder, Supinated forearm, patient prone [CORRECT]
  - B. ABER — abduction/external rotation, as used at the shoulder
  - C. A valgus-stress coronal acquisition of the medial joint
  - D. Full extension with the forearm pronated and the arm at the side
    Explanation: FABS (Flexed elbow, ABducted shoulder, Supinated forearm, prone with the arm overhead) lays the distal biceps in-plane all the way to the radial tuberosity, which is what makes partial-vs-complete grading and retraction measurement reliable. ABER is a SHOULDER position for the anteroinferior labrum. A valgus/flexed elbow positioning adjunct targets the medial joint and the UCL — the wrong structure, and with a thin elbow-specific evidence base. Extension with pronation foreshortens the tendon further, which is the very problem FABS solves.

### Structure Pearls / Readings / Correlates

- **Capitellum:** Watch for an osteochondral lesion of the capitellum — on MRI, judge stability at the interface: a fluid line completely undercutting the fragment, a sizeable/multiple cyst, a cartilage breach, or a displaced fragment = unstable. Surrounding edema alone is not, and an isolated high-T2 line is indeterminate. The MRI interface is not the whole call: the validated clinical classification also counts a closed capitellar physis, fragmentation, or ≥20° motion loss as unstable.
- **Radial head:** Watch for an occult radial-head fracture after a fall — a marrow-edema line with a displaced posterior fat pad; the surgical trigger is a mechanical block to forearm rotation or comminution (Mason III), not the 2 mm number alone.
- **Ulnar collateral ligament (anterior bundle):** Watch for the T-sign — fluid undercutting the distal UCL beyond the articular-cartilage edge — which supports a thrower's partial undersurface tear in the right clinical setting; MR arthrography is the most sensitive study, but symptoms and laxity still matter.
...
- **Fat pads (coronoid & olecranon fossae):** A visible posterior fat pad after adult elbow trauma is a fracture until proven otherwise — radial head first.
- **Brachialis & distal biceps (anterior):** Watch the lacertus fibrosus — an intact lacertus tethers a complete distal biceps tear so it neither retracts nor shows an obvious clinical gap, the classic mimic of a partial tear.
- **Capitellum reading:** variant: The posterolateral capitellar PSEUDODEFECT (a normal bare-area groove) and the transverse trochlear ridge are normal contours — do not call them osteochondral lesions. | measure: OCD stability is qualitative, not a single cutoff: the 5 mm subchondral-cyst figure is knee-derived (De Smet) and not validated for the capitellum — teach 'sizeable or multiple cysts.' And the MRI interface is not the only input: the validated clinical classification (Takahara) calls a lesion unstable with a CLOSED capitellar physis, fragmentation, or ≥20° motion loss, and defect size predicts the outcome of excision — so report physeal status and lesion size alongside the interface findings.
- **Ulnar collateral ligament (anterior bundle) reading:** variant: A small synovial recess at the distal UCL is normal — the T-sign threshold is fluid tracking BEYOND the articular-cartilage edge, not any sliver of fluid at the attachment, and it should be interpreted with symptoms/laxity rather than as an automatic surgical indication. | measure: On dynamic valgus-stress ultrasound there are two published measures and they are NOT interchangeable: the STRESS DELTA — the rest-to-valgus increase in medial ulnohumeral joint space in the injured elbow, abnormal above about 2.4 mm — and the STRESS DELTA DIFFERENCE, the side-to-side comparison of that increase, abnormal above about 1 mm (the more sensitive of the two). Flexion angle and applied load are not standardized, so quote the criterion being used rather than one universal cutoff.
- **Radial head reading:** measure: Mason framework: I = non-/minimally displaced, II = displaced (commonly >2 mm) partial-articular, III = comminuted — but the surgical trigger is a mechanical block to rotation, not the 2 mm number alone.
- **Ulnar nerve (cubital tunnel) reading:** variant: Mild ulnar-nerve T2 hyperintensity occurs in asymptomatic elbows; there is no universal cross-sectional-area cutoff — compare to the median nerve and the contralateral side.
- **Trochlea / capitellum (articular surface) reading:** variant: A thin low-signal posterolateral radiocapitellar synovial plica/fold may be normal. It should not be mistaken for a loose body or an unstable OCD fragment unless it is thickened/edematous, trapped in the joint, or matches mechanical symptoms. | measure: A posterolateral radiocapitellar fold is present in about three-quarters of asymptomatic elbows and averages about 3 mm — so 3 mm is a NORMAL value, not a pathologic threshold, and symptomatic and asymptomatic plicae overlap in thickness. There is no validated cutoff. Call it clinically relevant only when it is clearly enlarged relative to normal (symptomatic series run nearer 7 mm mediolateral, or the fold covers a substantial portion of the radial head) and/or edematous, AND the snapping/catching is concordant.
- **Brachialis & distal biceps (anterior) reading:** variant: An intact lacertus fibrosus can leave the stump near the radial neck despite a full rupture — report complete-vs-partial AND lacertus integrity, not just the retraction distance.
- **Ulnar collateral ligament (anterior bundle) correlate:** ultrasound: seen: true | appearance: The UCL anterior bundle is superficial and well seen on US as a fibrillar band from the medial epicondyle to the sublime tubercle — and US uniquely adds the DYNAMIC valgus-stress test (side-to-side medial joint-gapping) that static MRI cannot. | tip: Long-axis over the medial joint with the elbow flexed ~30°, then apply valgus stress and compare medial gapping to the contralateral side. | image: src: /images/teaching/us/elbow-ucl.jpg | caption: Long-axis US of the medial elbow: 1 medial epicondyle, 2 humeral trochlea, 3 sublime tubercle, 4 humeroulnar joint gap, 5 UCL thickness, 6 UCL length. The joint gap (4) is what valgus-stress US measures. | attribution: van Trigt B et al., J Shoulder Elbow Surg Int, 2024. PMC11065662. CC-BY 4.0.
- **Common extensor origin correlate:** ultrasound: seen: true | appearance: The common extensor origin is superficial and ideal for US — hypoechoic swelling, neovascularity on Doppler, and intrasubstance tears of tennis elbow are readily shown, and US guides a peritendinous injection. | tip: Long-axis over the lateral epicondyle; the ECRB origin is the deep component to scrutinize. | image: src: /images/teaching/us/elbow-common-extensor.jpg | caption: Long-axis US of the common extensor origin at the lateral epicondyle (E); radial head (R). | attribution: Allen GM, Jacobson JA, in IDKD 'Musculoskeletal Diseases 2021–2024' (NCBI Bookshelf NBK570156). CC BY 4.0.
- **Common flexor-pronator origin correlate:** ultrasound: seen: true | appearance: The common flexor-pronator origin is superficial and well seen on US for golfer's elbow — but always interrogate the UCL and ulnar nerve alongside it. | image: src: /images/teaching/us/elbow-common-flexor.jpg | caption: Long-axis US of the common flexor-pronator origin at the medial epicondyle (ME). | attribution: Konarski W, et al. Healthcare 2022;10(8):1529. CC BY 4.0.
- **Ulnar nerve (cubital tunnel) correlate:** ultrasound: seen: true | appearance: The ulnar nerve is superficial in the cubital tunnel and excellent on US — measure its cross-sectional area and, crucially, perform the DYNAMIC test for flexion subluxation/dislocation over the medial epicondyle and for snapping triceps, which static MRI can miss. | tip: Short-axis posterior to the medial epicondyle, then flex the elbow to watch for nerve (± medial triceps head) subluxation. | image: src: /images/teaching/us/elbow-ulnar-nerve.jpg | caption: Normal ulnar nerve, US and MRI side by side. (a) Short axis: the honeycomb fascicular pattern. (b) Long axis: a coarse hypoechoic band. (c) T1 and (d) fat-suppressed PD in the cubital tunnel (arrow) — isointense to muscle on T1, mildly hyperintense on fluid-sensitive. Mild T2 signal alone is NOT neuritis. | attribution: Albano D et al., Insights Imaging, 2025. PMC11780019. CC-BY 4.0.
- **Brachialis & distal biceps (anterior) correlate:** ultrasound: seen: true | appearance: The distal biceps is superficial in the antecubital fossa on US; a complete tear may show a retracted balled-up stump, while an intact lacertus can tether it — US can provide quick confirmation, though MRI and selected FABS imaging better profile the footprint and retraction. | image: src: /images/teaching/us/elbow-distal-biceps.jpg | caption: Long-axis US of the distal biceps tendon in the antecubital fossa toward the radial tuberosity (RT). | attribution: Daoukas S, Galanis D. Ultrasound 2025. CC BY 4.0.
- **Radial head correlate:** ultrasound: seen: true | appearance: US shows the radial head cortex and the radiocapitellar joint, and a posterior fat-pad elevation / joint effusion (the lipohemarthrosis of an occult fracture) — but the marrow fracture line itself is an MRI finding.

### Advanced / Image CAQ / Cross-Plane Items

#### Advanced: elb-adv-1 · Protocol & planes — reading capitellar OCD and the distal biceps footprint
...
- A. Read the capitellar OCD on the sagittal plane alone, since it best profiles the cartilage contour
- B. Read the capitellar OCD on coronal plus sagittal together, with fluid-sensitive fat-sat for the interface and add MR/CT arthrography when stability will change the operation [CORRECT]
- C. Order a routine MR arthrogram on every elbow because intra-articular contrast is required to call any OCD
- D. Use the FABS (flexion–abduction–supination) view to stage the OCD because it lays the capitellum flat
...
#### Advanced: elb-adv-2 · Capitellar OCD stability — which sign makes it unstable
...
- A. These are instability signs — the lesion is unstable and warrants surgical referral [CORRECT]
- B. Surrounding marrow edema is present, so the lesion is unstable by that criterion alone
- C. An isolated high-T2 interface line like this is always definitive for an unstable fragment
- D. The fragment is stable because no subchondral cyst exceeds the 5 mm threshold
...
#### Advanced: elb-adv-3 · UCL T-sign — partial undersurface tear vs the normal distal recess
...
- A. Any undercutting of the most distal fibers at all, regardless of how far it extends
- B. Contrast/fluid extending BEYOND the edge of the articular cartilage at the sublime tubercle [CORRECT]
- C. Surrounding flexor-pronator tendinosis being present on the same image
- D. Mild T2 hyperintensity within the ulnar nerve in the adjacent cubital tunnel
...
#### Advanced: elb-adv-4 · LCL/PLRI & the coronoid — the anteromedial facet fracture
...
- A. It is a Regan–Morrey type I coronoid-tip avulsion, which is always managed nonoperatively
- B. It implies varus posteromedial rotatory instability (VPMRI) and untreated drives early arthrosis [CORRECT]
- C. It is part of the terrible triad, which by definition includes a radial head fracture here
- D. Small coronoid fragments are inherently stable, so the LUCL injury alone drives treatment
...
#### Advanced: elb-adv-5 · Distal biceps & lacertus — the non-retracted complete tear
...
- A. A partial tear, because the limited retraction indicates some fibers still reach the tuberosity
- B. A complete tear with an intact lacertus fibrosus tethering the stump — still an anatomic repair consideration in the right patient [CORRECT]
- C. Tendinosis, since a balled-up stump is absent and retraction is minimal
...
- A. Isolated lateral epicondylitis that will resolve with continued conservative care
- B. Reactive lateral-epicondyle marrow edema that should be reported as an LCL tear
- C. A deep extensor tear involving the LUCL implying posterolateral rotatory instability (PLRI) — a ligament repair/reconstruction problem [CORRECT]
- D. An LUCL injury that is irrelevant because the common extensor tendinosis is the pain generator
...
#### Advanced: elb-adv-8 · Ulnar / cubital tunnel — anchoring the diagnosis and what changes operative planning
...
- A. Mild ulnar-nerve T2 hyperintensity alone, which is sufficient to diagnose entrapment
- B. Comparing the ulnar nerve only to the median nerve, since side-to-side comparison is unhelpful
- C. Dynamic nerve subluxation with a co-existing snapping triceps — the triceps may need to be addressed, not just the nerve [CORRECT]
- D. The FCU denervation edema itself, which is the expected accompaniment of this presentation
...
#### Advanced: elb-adv-9 · PIN / AIN — the Parsonage–Turner caveat and supinator sparing

A 32-year-old develops an acute, painful inability to flex the distal interphalangeal joints of the index and middle fingers and the thumb, with weak pinch and NO sensory loss. MRI shows isolated pronator quadratus edema. What is the best next step?

- A. Urgent surgical decompression at the arcade of Frohse, since this is a PIN compression
- B. Recognize a likely AIN palsy that is frequently Parsonage–Turner — pivot to EMG and observation rather than surgery [CORRECT]
- C. Diagnose ulnar neuropathy at the cubital tunnel from the intrinsic weakness
- D. Attribute the deficit to supinator denervation, the constant feature of this syndrome
...
#### Advanced: elb-adv-10 · Occult fracture & loose body — the radial-head surgical trigger
...
- A. The displaced posterior fat pad is a normal variant and excludes an occult fracture
- B. Surgery is mandated solely because the articular fragment is displaced more than 2 mm
- C. A displaced posterior fat pad signals an occult intra-articular fracture; the surgical trigger is a mechanical block, not the 2 mm number alone [CORRECT]
- D. The posterolateral capitellar pseudodefect explains the findings, so no fracture is present
...
#### Advanced: elb-adv-11 · Panner vs capitellar OCD — age, focality, and reversibility

An 8-year-old gymnast has lateral elbow pain and a mild flexion contracture. MRI shows the ENTIRE capitellar ossific nucleus is low-signal and fragmented-appearing, with no discrete fragment, no subchondral cyst, and no loose body. Which interpretation is correct?

- A. Panner disease — a self-limited osteochondrosis of the whole capitellar nucleus at this age, managed conservatively [CORRECT]
- B. Capitellar OCD — a fragmented appearance is diagnostic regardless of age or extent
- C. An unstable OCD, since involvement of the entire nucleus is the most severe instability sign
- D. A normal CRITOE secondary ossification center, so no follow-up or activity modification is needed
...
#### Advanced: elb-adv-12 · CRITOE — the incarcerated medial epicondyle after a spontaneously reduced dislocation

A 9-year-old had a painful elbow injury; the joint is clinically reduced on arrival. On imaging you can identify the trochlear ossification center, but you cannot find the medial epicondyle ossification center. What does this mean?

- A. The medial epicondyle has been avulsed — classically trapped intra-articularly after a transient dislocation that spontaneously reduced [CORRECT]
- B. The medial epicondyle simply has not ossified yet, because the trochlea normally ossifies first
- C. The trochlea has ossified early, a recognized normal variant at this age
- D. This is a lateral condyle (Salter-Harris IV) fracture, which explains the absent center
...
#### Advanced: elb-adv-13 · The dislocated elbow — which ligament fails first and what decides disposition

A 28-year-old sustains a simple elbow dislocation that is reduced in the emergency department. Post-reduction imaging shows a concentrically reduced joint with an LUCL injury, an intact radial head, and no coronoid fracture. Which statement best reflects the expected pattern and disposition?

- A. Soft-tissue failure runs lateral-to-medial, so the LCL/LUCL is usually the primary lesion and valgus stability is often preserved; a concentrically reduced, stable elbow with an LUCL injury is often managed nonoperatively [CORRECT]
- B. The MCL fails first in most simple dislocations, so a UCL reconstruction should be planned
- C. Any LUCL injury after dislocation mandates ligament reconstruction regardless of whether the joint stays reduced
- D. Because the elbow reduced and the radiographs are now normal, no ligament comment is required
...
#### Advanced: elb-adv-14 · Posterior elbow in the thrower — stress reaction vs stress fracture, and the VEO trap

A 17-year-old pitcher has posterior elbow pain at ball release. MRI shows posteromedial olecranon marrow edema WITHOUT a discrete low-signal line, plus a small posteromedial olecranon osteophyte and a posterior loose body. How should this be read and managed?

- A. A stress REACTION (edema without a line) with valgus-extension-overload change — and the UCL must be assessed before any osteophyte debridement [CORRECT]
- B. A completed olecranon stress fracture, since marrow edema at this site is the diagnostic criterion
- C. Isolated valgus extension overload — debride the osteophyte and the loose body; the UCL is downstream and irrelevant
- D. Expected throwing adaptation — posteromedial edema, osteophytes, and small bodies need no restriction
...
#### Advanced: elb-adv-15 · Staging muscle denervation — the three phases and how early edema can appear

A patient describes ulnar-sided hand weakness that began 5 days ago. MRI shows a normal-appearing FCU and normal ulnar intrinsics with no muscle edema and no fatty atrophy. What is the correct interpretation?

- A. A normal muscle appearance does not exclude denervation — edema is only CONSISTENTLY seen from about 2-4 weeks; correlate with EMG and repeat imaging if the deficit persists [CORRECT]
- B. Denervation is excluded, because a muscle that is going to denervate always shows edema by day 5
- C. The absence of edema means the process has already reached the chronic, irreversible phase
- D. Muscle edema is the chronic phase, so a normal-looking muscle means the lesion is fresh and reversible
...
#### Advanced: elb-adv-16 · The warm olecranon bursa — what MRI can and cannot do

A 52-year-old plumber has a red, warm, fluctuant swelling over the olecranon. MRI shows a distended olecranon bursa with rim enhancement and surrounding soft-tissue edema; the elbow joint itself looks normal. What is the correct next step?

- A. Aspirate the bursa — MRI cannot reliably exclude infection, and gout, RA, and repetitive trauma produce an overlapping picture [CORRECT]
- B. Report aseptic bursitis, since the joint is normal and the process is confined to the bursa
- C. Rim enhancement is specific for infection, so start antibiotics without aspirating
- D. Reassure and treat with a compressive wrap, since MRI showed no septic arthritis or osteomyelitis
...
#### Advanced: elb-adv-17 · The marrow red flag — confluent low-T1 replacement and its benign mimics
...
- A. Red-marrow reconversion — a benign pattern; replacement is suggested when confluent T1 drops BELOW muscle/disc, loses interspersed fat, and keeps company with a mass, cortical destruction, or a wide transition zone [CORRECT]
- B. Marrow-replacing infiltration until proven otherwise, because any diffuse low-T1 marrow is a red flag
- C. Osteomyelitis, since low-T1 marrow in a symptomatic patient is the defining pattern
- D. A stress injury, because low T1 in an athlete always indicates an occult fracture line
...
#### Advanced: elb-adv-18 · The mechanical elbow — where loose bodies hide, the plica mimic, and the pre-op count

A 45-year-old machinist with no throwing history has locking and catching, and the surgeon wants a usable pre-operative loose-body count. Which approach is correct?

- A. Sweep the dependent recesses (coronoid fossa, olecranon fossa, radiocapitellar recess) against bright fluid on sagittal fluid-sensitive images, exclude a thickened radiocapitellar plica as a mimic, and report location plus a MINIMUM count — CT/CT arthrography adds bone detail, but no modality gives a reliable exact count [CORRECT]
- B. A single fluid-sensitive sequence suffices, and joint fluid pooling in the olecranon fossa can be counted as a body
- C. Report any thin posterolateral radiocapitellar synovial fold as a loose body, since both cause catching
- D. Hand the surgeon an exact pre-operative body count from the MRI, since fluid-sensitive imaging reliably detects and enumerates every ossified fragment
...
#### Advanced: elb-adv-19 · Radial tunnel syndrome vs PIN syndrome — the normal MRI and the hunt for a mass

A 41-year-old has lateral forearm pain just distal to the lateral epicondyle, tender over the mobile wad, with NO weakness of finger extension. The elbow MRI is normal. What is the best interpretation?

- A. Radial tunnel syndrome — pain without a motor deficit, frequently with a normal MRI; state that no mass is present at the arcade of Frohse rather than manufacturing a finding [CORRECT]
- B. PIN syndrome — a normal MRI is expected because the supinator is always spared
- C. The normal MRI excludes a peripheral nerve problem, so the pain must be referred from the cervical spine
- D. Report presumed common-extensor tendinosis, since lateral pain with a normal MRI is by definition tennis elbow
...
#### Advanced: elb-adv-20 · UCL management in a thrower — what MRI does and does not decide

A 21-year-old collegiate pitcher has a proximal (humeral-sided) partial UCL tear with no T-sign, an intact flexor-pronator origin, a normal-caliber ulnar nerve, and a mildly positive moving-valgus test. The coach asks whether he needs Tommy John surgery. What is the most accurate framing?

- A. Most partial/low-grade tears — especially proximal ones — are managed nonoperatively first, with reconstruction reserved for full-thickness tears or high-grade partials that fail rehab in a high-demand thrower; the MRI grade alone does not decide it [CORRECT]
- B. Any partial UCL tear on MRI is an automatic indication for reconstruction in a collegiate pitcher
- C. MRI supplies the side-to-side medial gapping measurement that defines functional valgus instability
- D. Ulnar nerve transposition should be performed routinely with every UCL reconstruction
...
#### Image CAQ: elb-caq-1 · UCL anterior bundle to the sublime tubercle — the T-sign concept

On this coronal T2 FS image, follow the medial side from the medial epicondyle down to the sublime tubercle of the coronoid and trace the anterior bundle of the ulnar collateral ligament — normally a thin, taut, uniformly low-signal band reaching the sublime tubercle, where a tiny synovial recess can be a normal finding. A 22-year-old pitcher has medial elbow pain at ball release and a positive moving-valgus test. As you scroll this plane, what is the abnormal threshold that distinguishes a partial undersurface (T-sign) tear from the normal distal recess, and what study best confirms it?

Plane: Coronal T2 FS · Stack: /images/teaching/stacks/normal-elbow-coronal · startIndex: 12

- A. Fluid/contrast tracking along the sublime tubercle BEYOND the edge of the articular cartilage while proximal fibers stay attached — the T-sign of a partial undersurface tear; MR arthrography is the most sensitive study [CORRECT]
- B. Any fluid undercutting the most distal UCL fibers by even 1–2 mm is diagnostic of a full-thickness tear; non-contrast MRI is fully sufficient
- C. Thickening and intermediate (not fluid-bright) signal of the proximal anterior bundle without any undercutting; dynamic valgus ultrasound is the most sensitive test
- D. Fluid tracking along the posterior bundle in the cubital tunnel floor; CT arthrography is the most sensitive study
...
#### Image CAQ: elb-caq-2 · Capitellar OCD — why it is read on coronal AND sagittal, and the instability signs

On this coronal T2 FS image, find the radiocapitellar joint and the convex articular surface of the capitellum — the anterolateral/central capitellum is where osteochondritis dissecans lives. (Remember the normal posterolateral capitellar pseudodefect groove is a bare area, NOT a lesion.) A 14-year-old gymnast has lateral elbow pain and catching. If the capitellum here showed an osteochondral lesion, which approach and finding correctly drive the stable-vs-unstable call?

Plane: Coronal T2 FS · Stack: /images/teaching/stacks/normal-elbow-coronal · startIndex: 12

- A. Surrounding marrow edema alone confirms instability, so the lesion can be staged from this single coronal image
- B. Read the lesion on coronal AND sagittal together; instability is suggested by a T2 fluid-bright line completely undercutting the fragment, a sizeable/multiple subchondral cyst, a cartilage cleft reaching the fragment, or a displaced fragment [CORRECT]
- C. A single subchondral cyst measuring exactly ≥5 mm is the validated capitellar threshold and is sufficient by itself to call the lesion unstable
- D. An isolated high-T2 line at the interface without a cartilage breach or cyst is definitively unstable and mandates immediate surgery
...
#### Image CAQ: elb-caq-3 · Ulnar nerve in the cubital tunnel — caliber/signal, the internal control, and flexion subluxation

On this axial T2 FS image, find the ulnar nerve in the cubital tunnel — posterior to the medial epicondyle, beneath Osborne's retinaculum, and compare it with the median nerve on the anterior side of the same slice. A 35-year-old thrower has medial elbow pain with little-finger numbness. Knowing there is no universal cross-sectional-area cutoff and that mild T2 signal can be normal, what best anchors a confident diagnosis of ulnar neuritis on this plane?

Plane: Axial T2 FS · Stack: /images/teaching/stacks/normal-elbow-axial · startIndex: 16

- A. Any T2 hyperintensity of the ulnar nerve by itself, since signal alone is diagnostic of neuritis
- B. Caliber enlargement plus T2 signal greater than the ipsilateral median-nerve internal control and the contralateral side, together with denervation of FCU/ulnar FDP/ulnar intrinsics — anchored to caliber change + denervation + clinical correlation, not signal alone [CORRECT]
- C. The presence of the anterior fat pad on this slice, which indicates an effusion and therefore neuritis
- D. Subluxation of the radial nerve/PIN over the lateral epicondyle in flexion
...
#### Image CAQ: elb-caq-4 · Common flexor-pronator and common extensor origins in cross-section — the companion ligament to trace

On this axial T2 FS image, identify the common extensor origin off the lateral epicondyle and the common flexor-pronator origin off the medial epicondyle in cross-section — both are normally uniform low-signal tendon. A 46-year-old recreational tennis player has refractory lateral elbow pain that failed prior steroid injection. As you read these origins, which companion structure must you always trace, and why does it change management?

Plane: Axial T2 FS · Stack: /images/teaching/stacks/normal-elbow-axial · startIndex: 16

- A. Trace the brachialis to the coronoid, because brachialis tendinosis is the usual cause of lateral epicondylitis
- B. Trace the LUCL to the supinator crest with lateral epicondylitis (and the anterior-bundle UCL with medial epicondylitis), because a deep common-extensor tear that undercuts the radiocapitellar joint and involves the LUCL implies PLRI — a surgical problem and a known complication of prior lateral steroid injection/release [CORRECT]
- C. Trace the annular ligament only, because a deep extensor tear most often avulses the annular ligament off the radial neck
...
- A. A visible anterior fat pad is always pathologic, whereas the posterior fat pad is normally seen in the olecranon fossa
- B. Loose bodies are best detected on the coronal plane against dark cortex, and the posterior fat pad is normally elevated
- C. Loose bodies migrate to the dependent recesses (coronoid fossa, olecranon fossa, radiocapitellar recess) and are best seen against bright joint fluid on sagittal fluid-sensitive images; a normally HIDDEN posterior fat pad that becomes visible/elevated after trauma signals an effusion/hemarthrosis (occult fracture until proven otherwise) [CORRECT]
- D. Any fluid in the olecranon fossa is a loose body, and the radiocapitellar recess never harbors bodies
...
#### Image CAQ: elb-caq-7 · Radiocapitellar plica - normal fold vs mechanical symptoms

On this sagittal IR/STIR image, trace the radiocapitellar articulation and the posterolateral recess. A fellow sees a thin low-signal synovial fold near the radiocapitellar joint in an otherwise normal elbow and wonders whether to call a loose body. Which interpretation is safest?

Plane: Sagittal IR/STIR · Stack: /images/teaching/stacks/normal-elbow-sagittal · startIndex: 14

- A. A thin posterolateral radiocapitellar plica/fold can be normal; call it clinically relevant only if thickened, edematous, trapped, or matching snapping/catching symptoms [CORRECT]
- B. Any synovial fold at the radiocapitellar joint is a displaced loose body and should be reported as mechanical
- C. The fold is a capitellar OCD instability sign even when the cartilage and subchondral interface are smooth
- D. The fold is the distal UCL T-sign and should be evaluated only on coronal MR arthrography
...
#### Cross-plane: exp-radial-head-cor-axi
...
#### Cross-plane: exp-capitellum-sag-cor
...
#### Cross-plane: exp-coronoid-sag-cor
...
#### Cross-plane: exp-flexor-cor-axi
...
#### Cross-plane: exp-extensor-cor-axi
...
#### Cross-plane: exp-brachialis-biceps-sag-axi
...
#### Cross-plane: exp-triceps-axi-sag
...
### Pre/Post Knowledge Items

#### elbow-q-protocol-pre · parallel-pre · elbow-orientation-protocol
...
- A. MR arthrography of the elbow to look for contrast undercutting the sublime-tubercle attachment beyond the cartilage edge (the T-sign) [CORRECT]
- B. Repeat non-contrast MRI in a dedicated FABS (flexion-abduction-supination) position to grade the UCL
- C. Routine elbow MR arthrography in an ABER position as the validated standard for every suspected UCL tear
- D. No further imaging is needed; UCL partial tears are diagnosed on the common-flexor origin alone
...
#### elbow-q-protocol-post · parallel-post · elbow-orientation-protocol

A 47-year-old man felt a tearing pop in the antecubital fossa while lowering a heavy box and now has a painful, bruised proximal arm. On exam the hook test is difficult to interpret because of swelling, and you cannot tell whether the distal biceps tendon is partially or completely torn or how far any complete tear has retracted, which will determine whether the surgeon can do a direct anatomic repair. Which imaging approach most directly answers that question?

- A. Routine elbow MR arthrography, since intra-articular contrast is required to evaluate any suspected tendon tear
- B. A coronal-only protocol, because the distal biceps and its retraction are best assessed on the coronal plane
- C. MRI including a dedicated FABS (flexion-abduction-supination) view to lay the radial-tuberosity footprint flat for partial-vs-complete grading and retraction [CORRECT]
- D. MR arthrography in an elbow ABER position, the validated routine for distal biceps tears
...
#### elbow-q-search-pre · parallel-pre · elbow-search-pattern
...
- A. The full-thickness common-extensor gap is the entire lesion; report lateral epicondylitis and manage with rehab, since a tendon read does not require tracing the adjacent ligament
- B. Trace the LUCL to the supinator crest, because a deep extensor tear undercutting the radiocapitellar joint can take the LUCL origin and produce posterolateral rotatory instability that changes management to ligament repair/reconstruction [CORRECT]
- C. Reactive lateral-epicondyle marrow edema accompanying the tendinosis is itself diagnostic of an LCL tear, so refer for reconstruction on that basis
- D. Read the tendons before the bones and ligaments and call the case complete once the extensor tendon is graded, because the mechanical symptoms reflect simple tendinopathy
...
#### elbow-q-search-post · parallel-post · elbow-search-pattern

A 24-year-old man is referred after an elbow dislocation that was reduced on the field; he now has recurrent instability with the forearm in varus and feels the elbow shift when bearing weight on a flexed arm. MRI/CT shows a torn LUCL at its humeral origin and a small fracture of the anteromedial facet of the coronoid; the radial head and the rest of the coronoid are intact, and the fragment measures only a few millimeters. The interpreting clinician notes the coronoid fragment is small and is inclined to treat it as a stable injury. Which interpretation most appropriately completes the post-dislocation search and directs management?

- A. Because the anteromedial facet fragment is only a few millimeters, it is mechanically stable and the elbow can be managed nonoperatively with early motion
- B. The LUCL tear is the only relevant lesion; the small coronoid fragment can be ignored once the lateral ligament is documented
- C. Reading the ligaments before the bones is acceptable here, so the coronoid does not need a dedicated review once the LUCL is called
- D. Despite its small size, the anteromedial coronoid facet fracture with the LUCL injury indicates varus posteromedial rotatory instability and is surgical, so it must be reported and referred [CORRECT]
...
#### elbow-q-ocd-stability-pre · parallel-pre · elbow-bones-marrow-osteochondral
...
- A. The surrounding marrow edema is itself the instability sign, so this lesion is unstable on that basis and surgery is indicated
- B. This is Panner disease, which is the same entity as capitellar OCD at this age and resolves with rest alone
- C. The cartilage cleft reaching the fragment with loss of congruity makes this an unstable lesion; stop throwing and refer for surgical evaluation [CORRECT]
- D. Because no subchondral cyst measures at least 5 mm, the validated elbow criterion for instability is not met and continued throwing is appropriate
...
#### elbow-q-ocd-stability-post · parallel-post · elbow-bones-marrow-osteochondral

A 14-year-old gymnast has lateral elbow pain. Coronal and sagittal fat-suppressed T2 images show a focal capitellar osteochondral lesion with a continuous joint-fluid-signal line tracking completely beneath the fragment, separating it from the parent bone. The overlying cartilage and the demarcating margin are otherwise present, and there is mild surrounding marrow edema. Which interpretation most appropriately drives management?

- A. A fluid-bright line completely undercutting the fragment makes this an unstable lesion; stop the aggravating activity and refer for surgical evaluation [CORRECT]
- B. The surrounding marrow edema is the determining instability sign, so the fragment is unstable purely on that basis
- C. Any isolated high-T2 line at the interface is definitely an unstable lesion even without a cartilage breach or cyst, so this is unstable for that reason
- D. This is Panner disease rather than OCD, so it will remodel with rest and needs no stability assessment
...
#### elbow-q-ucl-tsign-pre · parallel-pre · elbow-ucl-valgus

A 19-year-old college pitcher has medial elbow pain late in his throwing motion. Coronal T2 fat-saturated MR arthrography shows fluid/contrast tracking medially along the sublime tubercle and undercutting the distal attachment of the UCL anterior bundle BEYOND the edge of the articular cartilage, while the proximal fibers remain attached, forming an inverted 'T' with the joint-fluid column. There is no full-thickness gap or medial extravasation. The moving-valgus test reproduces his pain. How should this finding most appropriately direct management?

- A. The contrast tracking only a couple of millimetres under the most distal fibers is the expected normal distal synovial recess, so no UCL injury should be reported
- B. Because distal UCL tears definitively outnumber proximal tears, the location alone confirms a full-thickness tear and mandates immediate Tommy John reconstruction
- C. The partial-thickness MRI grade by itself dictates surgery, so proceed directly to reconstruction regardless of the athlete's demand or the moving-valgus exam
- D. This is the T-sign of a partial undersurface (distal) UCL tear; manage by integrating the lesion features, the athlete's demand, and the moving-valgus exam rather than by the MRI grade alone [CORRECT]
...
#### elbow-q-ucl-tsign-post · parallel-post · elbow-ucl-valgus

A 24-year-old javelin thrower has medial elbow pain at release. Coronal fluid-sensitive fat-saturated MRI (with intra-articular contrast) shows high-signal fluid undermining the sublime-tubercle insertion of the UCL anterior bundle and extending PAST the articular-cartilage margin, while the more proximal fibers stay attached and intact; no full-thickness defect or contrast extravasation is seen. Her moving-valgus test is positive in the painful arc. Which interpretation and management plan is most appropriate?

- A. The few millimetres of fluid under the most distal fibers represent the normal distal synovial recess, so the UCL should be reported as intact
- B. This is the T-sign of a partial undersurface (distal) UCL tear; base management on the lesion features together with the athlete's demand and the moving-valgus exam, not on the MRI grade alone [CORRECT]
- C. Since distal tears definitively predominate over proximal tears, the distal location establishes a full-thickness tear and routine ulnar-nerve transposition should accompany the reconstruction
- D. The partial-thickness grade on MRI alone determines the operation, so refer for reconstruction independent of her throwing demand or the moving-valgus exam
...
#### elbow-q-lucl-plri-pre · parallel-pre · elbow-lcl-plri

A 24-year-old rock climber sustained a simple posterolateral elbow dislocation that was reduced on the field and is now concentrically reduced and stable on exam. MRI shows an avulsed lateral ulnar collateral ligament (LUCL) at the lateral epicondyle with intact medial structures, and a separate small anteromedial coronoid facet fragment with surrounding marrow edema. Which interpretation most accurately frames the instability and surgical risk in this elbow?

- A. The LUCL injury threatens posterolateral rotatory instability, while the anteromedial coronoid facet fracture is a distinct varus posteromedial rotatory instability lesion that is surgical despite its small size [CORRECT]
- B. The LUCL tear and the anteromedial coronoid facet fracture reflect the same single instability mechanism, so naming one is sufficient for the report
- C. The anteromedial coronoid facet fragment is small and therefore mechanically stable, so it can be left out of the impression
- D. Because the elbow dislocated, the primary lesion is a torn medial (ulnar) collateral ligament, and valgus is the only post-traumatic instability to address
...
#### elbow-q-lucl-plri-post · parallel-post · elbow-lcl-plri

A 31-year-old laborer is referred 8 weeks after a simple elbow dislocation with recurrent painful clicking and a positive lateral pivot-shift apprehension sign. MRI demonstrates an attenuated, surface-disrupted lateral ulnar collateral ligament arcing from the lateral epicondyle toward the supinator crest, plus a small anteromedial coronoid facet fracture. The medial (ulnar) collateral ligament is intact. Which interpretation best characterizes the two findings and their surgical relevance?

- A. Because the elbow dislocated, the dominant lesion is an ulnar collateral ligament tear and valgus is the only meaningful post-traumatic instability
- B. The anteromedial coronoid facet fragment is small, so it is stable and need not change management
- C. The lateral ulnar collateral ligament injury underlies posterolateral rotatory instability, and the anteromedial coronoid facet fracture is a separate varus posteromedial rotatory instability lesion that is surgical even though it is small [CORRECT]
- D. The lateral ulnar collateral ligament tear and the anteromedial coronoid facet fracture are simply two expressions of one and the same instability mechanism
...
#### elbow-q-biceps-lacertus-pre · parallel-pre · elbow-tendons-biceps-triceps-epicondylitis

A 47-year-old man felt a painful 'pop' in the front of his elbow lifting a heavy box 8 days ago. He has antecubital bruising but, surprisingly, near-normal flexion and supination strength on exam. MRI shows the distal biceps tendon completely discontinuous at the radial tuberosity with an empty footprint, yet the stump is held at the level of the tuberosity with only minimal retraction; the lacertus fibrosus is intact and taut. How should this finding most appropriately direct management?

- A. Because strength is preserved and the tendon has not retracted, call this a partial tear and manage nonoperatively with rehabilitation
- B. Recognize a complete distal biceps tear tethered by an intact lacertus and refer for surgical repair, noting the intact lacertus masks the injury clinically and limits retraction [CORRECT]
- C. Attribute the symptoms to bicipitoradial bursitis as the primary diagnosis and treat with an image-guided corticosteroid injection
- D. Defer any referral and plan for tendon grafting only if he presents again beyond a fixed 6-week window
...
A 22-year-old pitcher reports 5 weeks of medial elbow discomfort and a weak pinch grip; he cannot make a normal 'OK' sign and the distal thumb and index finger collapse. Sensation is fully intact throughout the hand. Elbow MRI shows STIR hyperintensity isolated to the pronator quadratus, flexor pollicis longus, and the index/middle portions of flexor digitorum profundus, with no muscle change in flexor carpi ulnaris, the ulnar intrinsics, or the extensor compartment, and no discrete compressive mass. Which interpretation is most appropriate?

- A. Posterior interosseous nerve entrapment at the arcade of Frohse, supported by the supinator and extensor denervation pattern
- B. Ulnar neuropathy at the cubital tunnel, because mild nerve T2 signal at the medial epicondyle is enough to confirm entrapment
- C. An anterior interosseous nerve (Kiloh-Nevin) pattern; because an AIN palsy is frequently Parsonage-Turner rather than compression, pivot to EMG and observation before any decompression [CORRECT]
- D. An acute denervation pattern that must have arisen within the past few days given the muscle edema
...
#### elbow-q-nerve-localize-post · parallel-post · elbow-nerves-entrapment

A 48-year-old recreational tennis player has 6 weeks of difficulty extending the fingers, and on exam the wrist extends with marked radial deviation while finger and thumb extension are weak; sensation over the dorsal hand is normal. Elbow MRI shows STIR hyperintensity throughout the extensor digitorum, extensor digiti minimi, extensor carpi ulnaris, and the thumb extensors, while the supinator shows no signal change; flexor carpi ulnaris and the ulnar intrinsics are normal. Which interpretation is most appropriate?

- A. Posterior interosseous nerve entrapment at the arcade of Frohse; the spared supinator does not exclude it, because supinator denervation is variable and often absent rather than a constant feature [CORRECT]
- B. Ulnar neuropathy at the cubital tunnel, since the extensor-compartment edema reflects ulnar intrinsic denervation
- C. An anterior interosseous nerve palsy, which always requires surgical decompression once muscle edema is seen
- D. Denervation that must be only a few days old because muscle T2 hyperintensity is already present
...
#### elbow-q-dontmiss-pre · parallel-pre · elbow-dont-miss
...
- A. Report the complex bursal fluid as an aseptic (gout/repetitive-trauma) bursitis, since the joint and marrow are normal, and treat with compression and NSAIDs
- B. Recommend MR arthrography to confirm whether the bursa communicates with the joint before any intervention
- C. Interpret the complex bursal fluid and wall thickening as confidently excluding infection, and start oral anti-inflammatories alone
- D. Aspirate the bursa for Gram stain, culture, and crystals, because MRI cannot reliably exclude septic bursitis in a warm, fluctuant bursa [CORRECT]
...
#### elbow-q-dontmiss-post · parallel-post · elbow-dont-miss

A 39-year-old recreational weightlifter is sent in with 10 days of a tender, hot, red, fluctuant swelling over the point of the elbow and a temperature of 38.1 C. MRI demonstrates a fluid-filled, thick-walled olecranon bursa with heterogeneous internal signal and adjacent subcutaneous edema; the elbow joint, articular cartilage, and marrow signal are normal. What is the most appropriate next step in management?

- A. Conclude the heterogeneous bursal fluid reflects a chronic aseptic (repetitive-trauma) bursitis and manage with an elbow pad and activity modification
- B. Aspirate the bursa and send fluid for Gram stain, culture, and crystal analysis, since MRI cannot reliably exclude a septic bursitis [CORRECT]
- C. Treat empirically as a gout flare with colchicine alone on the basis of the imaging appearance, without sampling the fluid
- D. Obtain a post-contrast MRI to determine from the enhancement pattern whether the bursa is infected before deciding on treatment
...
#### elbow-q-ucl-chronic-post · parallel-post · elbow-ucl-valgus
...
- A. The sublime-tubercle ossification proves an acute full-thickness UCL rupture, so he should bypass any further testing and proceed to reconstruction
- B. Because any visible UCL thickening crosses the operative threshold, the MRI by itself dictates ligament reconstruction
- C. The attenuation, thickening, ossification, and traction edema indicate chronic valgus overload, and adding dynamic valgus-stress ultrasound to measure side-to-side medial gapping supplies the functional-instability data the static MRI cannot, so management is decided by chronicity, lesion features, and demand together rather than a single MRI cutoff [CORRECT]
- D. Since the static MRI shows no full-thickness gap, dynamic ultrasound adds nothing and he can return to throwing without an instability assessment
...
#### elbow-q-little-league-pre · parallel-pre · elbow-bones-marrow-osteochondral

A 12-year-old Little League pitcher has medial elbow pain that started after a hard throw two innings into a game; he could not finish pitching. Elbow MRI shows the medial epicondyle apophysis avulsed and displaced about 7 mm, with the bony fragment lying within the ulnohumeral joint and a moderate effusion. On the coronal images the trochlear ossification center is visible but the medial epicondyle is no longer in its normal position. What is the most appropriate management?

- A. Throwing rest alone, because a widened fluid-bright physis with marrow edema and no fragment heals nonoperatively
- B. Refer for surgical fixation, because the fragment is displaced and incarcerated in the joint [CORRECT]
- C. Reassure that a visible trochlea without a visible medial epicondyle simply means the epicondyle has not yet ossified per the fixed CRITOE ages, and continue pitching
- D. Treat as capitellar osteochondritis dissecans and obtain MR arthrography to grade the lesion
...
#### elbow-q-little-league-post · parallel-post · elbow-bones-marrow-osteochondral

A 13-year-old catcher who also pitches felt a sudden medial pop while throwing a runner out and now has medial elbow pain and a sense of the elbow 'opening up' with valgus stress. His elbow had briefly dislocated and reduced on the field. MRI shows the medial epicondyle apophysis avulsed; the fragment is displaced roughly 3 mm and sits at the medial joint margin, and there is medial ulnohumeral gapping on the valgus-stressed views. On coronal images the trochlear ossification center is present while the medial epicondyle is absent from its expected site. What is the most appropriate management?

- A. Continue throwing rest only, treating this as Little League apophysitis with a widened fluid-bright physis and no fragment
- B. Reassure that the absent medial epicondyle with a visible trochlea reflects the fixed CRITOE ossification ages and clear him to return to catching
- C. Diagnose Panner disease of a normal secondary ossification center and manage conservatively with observation
- D. Refer for surgical fixation, because demonstrated valgus instability mandates surgery regardless of the millimetre displacement [CORRECT]
...
#### elbow-q-lat-epi-lucl-pre · parallel-pre · elbow-tendons-biceps-triceps-epicondylitis

A 47-year-old right-handed carpenter has 9 months of refractory lateral elbow pain that worsened after two prior corticosteroid injections, and now reports a sense of the elbow 'giving way' when he pushes up from a chair. Elbow MRI shows a deep, full-thickness gap in the common extensor (ECRB) origin with fluid-bright signal that undercuts and communicates with the radiocapitellar joint, and the high-signal cleft extends into and disrupts the lateral ulnar collateral ligament traced toward the supinator crest. Which interpretation most appropriately directs management?

- A. High-grade lateral epicondylitis is always managed with arthroscopic or open extensor debridement, so refer for routine tendon debridement alone
- B. The reactive marrow edema at the lateral epicondyle and the thin adjacent radial collateral ligament signal are the true findings, indicating an isolated low-grade LCL sprain to manage conservatively
- C. A full-thickness common-extensor tear that undercuts the radiocapitellar joint and involves the LUCL implies posterolateral rotatory instability, so refer for ligament repair/reconstruction rather than routine debridement [CORRECT]
- D. Tendinosis and a full-thickness extensor gap carry the same grade and prognosis, so the gap does not change the plan from a standard tendinopathy program
...
#### elbow-q-lat-epi-lucl-post · parallel-post · elbow-tendons-biceps-triceps-epicondylitis

A 52-year-old recreational tennis player has lateral elbow pain that never settled after a prior lateral-release procedure, and she now describes painful clicking and apprehension when she extends the loaded elbow. Elbow MRI demonstrates a full-thickness defect of the common extensor (ECRB) origin with a fluid-bright cleft that undercuts and communicates with the radiocapitellar joint and extends into the lateral ulnar collateral ligament followed toward the supinator crest, with mild posterolateral radiocapitellar incongruity. Which interpretation most appropriately directs management?

- A. A full-thickness common-extensor tear that undercuts the radiocapitellar joint and involves the LUCL implies posterolateral rotatory instability, so refer for ligament repair/reconstruction rather than routine debridement [CORRECT]
- B. High-grade lateral epicondylitis is always treated by extensor debridement, so refer for a routine tendon debridement and expect resolution
- C. The lateral-epicondyle marrow edema and a thin reactive radial collateral ligament signal are the real abnormality, so call it a minor LCL sprain and continue a home program
- D. It is medial epicondylitis that involves the LUCL, so this lateral finding is incidental and the LUCL does not need to be addressed
...
#### elbow-q-ulnar-sublux-pre · parallel-pre · elbow-nerves-entrapment

A 24-year-old right-handed pitcher has medial elbow aching and intermittent little-finger numbness that worsens with throwing. A dedicated elbow MRI obtained with the elbow flexed shows the ulnar nerve enlarged with T2 hyperintensity at the medial epicondyle, and on the flexed axial images the nerve perches on and rides anteriorly over the tip of the medial epicondyle. There is mild denervation edema in the flexor carpi ulnaris. The referring surgeon plans an in-situ cubital tunnel decompression. What is the most appropriate way the MRI should shape that operative plan?

- A. Recommend in-situ decompression as planned, because dynamic subluxation of the nerve does not change the choice of operation
- B. Report only 'ulnar neuritis,' since T2 signal in the nerve is sufficient and the nerve's position is a normal finding to ignore
- C. Hold any surgical comment because nerve T2 hyperintensity alone, without attention to caliber or muscle denervation, establishes the diagnosis
- D. Report the dynamic anterior subluxation of the ulnar nerve over the medial epicondyle as the structural driver, which favors transposition over in-situ decompression [CORRECT]
...
#### elbow-q-ulnar-sublux-post · parallel-post · elbow-nerves-entrapment

A 32-year-old recreational weightlifter reports a painful snapping at the inner elbow with repeated flexion and new ulnar-sided hand tingling. On flexed-elbow axial MRI, BOTH the medial head of the triceps and the ulnar nerve displace anteriorly over the medial epicondyle during flexion, and the ulnar nerve is mildly enlarged with denervation edema in the first dorsal interosseous. The consulting team proposes a standard in-situ ulnar nerve decompression alone. How should the MRI most appropriately influence the plan?

- A. Endorse in-situ decompression alone, since the snapping triceps is incidental and needs no specific surgical treatment
- B. Report the snapping triceps with concurrent ulnar nerve subluxation as the structural cause, which favors transposition and means the triceps itself must be addressed, not just the nerve [CORRECT]
- C. Describe 'ulnar neuritis' only, treating the anterior position of the nerve and triceps in flexion as a normal finding that does not alter management
- D. Make the diagnosis on the nerve's T2 signal alone, without weighting nerve caliber change or muscle denervation
...
- **conf-elbow-orientation-protocol (elbow-orientation-protocol):** I can choose the right elbow protocol (non-contrast vs MR arthrogram, and when FABS positioning helps the distal biceps), assign each plane to the structure it best shows, and turn the clinical question into a focused but complete search.
- **conf-elbow-search-pattern (elbow-search-pattern):** I can apply a systematic eight-step elbow search pattern — reading the medial valgus triad and the post-traumatic lateral circle as linked groups — and produce a structured impression that names the structure, the grade, and the management consequence.
- **conf-elbow-bones-marrow-osteochondral (elbow-bones-marrow-osteochondral):** I can distinguish capitellar osteochondritis dissecans from Panner disease and judge OCD stability, recognize the thrower's stress lesions (medial epicondyle apophysis, olecranon stress, valgus-extension-overload osteophyte), and use CRITOE and the radiocapitellar line to catch occult and pediatric fractures.
- **conf-elbow-ucl-valgus (elbow-ucl-valgus):** I can trace the UCL anterior bundle to the sublime tubercle, separate a partial undersurface tear (the T-sign) from a full-thickness tear and from a normal recess, and explain how location, surface, and athlete demand drive repair versus reconstruction in a thrower.
- **conf-elbow-lcl-plri (elbow-lcl-plri):** I can evaluate the LCL complex (especially the LUCL) for posterolateral rotatory instability, recognize the anteromedial coronoid facet fracture and the terrible-triad pattern, and comment on LUCL integrity in every post-dislocation or post-lateral-surgery elbow.
- **conf-elbow-tendons-biceps-triceps-epicondylitis (elbow-tendons-biceps-triceps-epicondylitis):** I can grade the distal biceps and triceps tendons for partial versus complete tear (with retraction and the lacertus fibrosus), grade lateral and medial epicondylitis, and always check the adjacent ligament (LUCL with lateral, UCL with medial).
- **conf-elbow-nerves-entrapment (elbow-nerves-entrapment):** I can assess the ulnar, median/AIN, and radial/PIN nerves by caliber and signal against an internal control, use muscle denervation as the localizing sign, recognize ulnar-nerve subluxation and snapping triceps, and consider Parsonage–Turner before calling mechanical compression.
- **conf-elbow-dont-miss (elbow-dont-miss):** I can prioritize the management-changing elbow findings — complete distal biceps avulsion, unstable capitellar OCD, the thrower's T-sign/full-thickness UCL tear, a common-extensor tear involving the LUCL, and the anteromedial coronoid facet fracture — and route each to the correct disposition.

## Red Flags

- **Complete distal biceps avulsion (or a complete tear with an intact lacertus that doesn't retract):** A time-sensitive surgical repair (≈40–50% supination / ≈30% flexion strength lost). An intact lacertus tethers the tendon so it neither retracts nor shows an obvious clinical gap — the classic undercall as 'partial.' Report partial-vs-complete, retraction in cm, and lacertus integrity, and refer promptly while the tendon still reaches the tuberosity.
- **Unstable capitellar OCD:** A fluid line undercutting the fragment, sizeable/multiple subchondral cysts, a cartilage breach, or a displaced fragment/loose body in a young thrower → stop throwing and refer for surgery. Surrounding edema alone is not instability; an isolated high-T2 line is indeterminate.
- **Thrower's UCL tear — the deep-fiber T-sign or a full-thickness tear:** The undersurface (sublime-tubercle) partial tear is occult to exam and at arthroscopy and ends a throwing season if missed; distal/full-thickness tears do worse nonoperatively. Name surface, location, and acute-vs-chronic; add MR arthrography when non-contrast MRI is equivocal.
- **Deep common-extensor tear involving the LUCL (posterolateral rotatory instability):** A deep ECRB tear with a fluid-bright gap undercutting the radiocapitellar joint and involving the LUCL turns a routine 'tennis elbow' debridement into a ligament repair/reconstruction (a classic post-injection/post-release complication). Trace the LUCL to the supinator crest before signing off any high-grade lateral epicondylitis.
- **Anteromedial coronoid facet fracture (and the terrible triad):** The small-looking anteromedial facet fragment implies varus posteromedial rotatory instability and is surgical; the terrible triad (dislocation + radial head + coronoid) is unstable with the coronoid and LCL as keystones. Classify the coronoid, look for the Osborne–Cotterill lesion on any post-dislocation elbow, and route to surgery (CT maps the fragments).
...
#### Sequences — what they're for
- **Fluid-sensitive fat-sat (T2 FS / STIR):** Edema, partial/complete tendon and ligament tears, the OCD fluid rim, marrow injury, effusions, and subacute muscle denervation edema. A finding is more convincing when fluid-bright signal points to it.
- **T1-weighted:** Anatomy, marrow replacement (confluent low-T1 below muscle signal is the red flag), arthrogram contrast, occult fracture lines, and chronic fatty muscle atrophy.
- **MR arthrography:** Most sensitive for the UCL undersurface (T-sign) tear and intra-articular loose bodies/chondral delamination — intra-articular contrast undercuts a partial tear and outlines bodies. An abduction/valgus or flexed positioning adjunct can help open the medial joint (the elbow-specific evidence base is thin, unlike the shoulder ABER). Add it only when it changes the decision.

#### Medial compartment
- **UCL (ulnar collateral) complex:** The anterior bundle is the primary valgus restraint (origin anteroinferior medial epicondyle → insertion at the sublime tubercle of the coronoid); the posterior bundle (cubital tunnel floor) and transverse/Cooper ligament are secondary. Normal anterior bundle = thin, taut, uniformly low signal to the sublime tubercle; a small synovial recess can be normal.
- **Common flexor-pronator origin:** Uniform low-signal tendon off the medial epicondyle; the site of medial epicondylitis. It overlies the UCL — read the two together.
- **Ulnar nerve:** In the cubital tunnel posterior to the medial epicondyle beneath Osborne's retinaculum. Assess caliber/signal and flexion subluxation; compare to the median nerve and the contralateral side.

#### Lateral compartment
- **Common extensor origin (ECRB):** Off the lateral epicondyle; the site of lateral epicondylitis (angiofibroblastic tendinosis).
- **RCL / LUCL complex:** The radial collateral ligament blends into the annular ligament; the lateral ulnar collateral ligament (LUCL: lateral epicondyle → posterior to the radial head → supinator crest) is the key restraint to posterolateral rotatory instability. The LUCL/RCL origin lies deep to the common extensor tendon — a deep extensor tear can take it.
- **Annular ligament & radiocapitellar joint:** The annular ligament stabilizes the radial head (best on axial); the capitellum is the OCD site (anterolateral/central).
- **Radial nerve / PIN:** Divides at the radiocapitellar level; the posterior interosseous nerve enters the supinator under the arcade of Frohse.
- **Pseudodefect of the capitellum:** A normal posterolateral/postero-inferior bare-area groove — NOT an osteochondral lesion. Do not over-call it.
...
- **Capitellar pseudodefect & trochlear groove:** The posterolateral capitellar bare-area groove and the transverse trochlear ridge/groove are normal — not osteochondral lesions.
- **Distal-UCL synovial recess:** A small normal synovial recess sits near the distal UCL. The abnormal T-sign threshold is fluid tracking BEYOND the articular-cartilage edge — a couple of millimetres of undercutting can be normal.
- **Mild ulnar-nerve T2 signal:** Mild ulnar-nerve T2 hyperintensity occurs in asymptomatic elbows — anchor the diagnosis to caliber change + muscle denervation + clinical correlation, not signal alone.
- **Reactive epicondyle edema / thin RCL:** Reactive lateral-epicondyle marrow edema and thin RCL signal accompany lateral epicondylitis — do not over-call an LCL tear.
- **CRITOE ossification centers:** Skeletally immature secondary ossification centers (capitellum, radial head, internal/medial epicondyle, trochlea, olecranon, external/lateral epicondyle) — do not call Panner or OCD on a normal center.

### measurementSections

#### UCL grading & the T-sign
- **Grading: sprain → partial undersurface → full-thickness:** Sprain/low-grade: periligamentous/intrasubstance edema, fibers grossly intact, no surface-reaching defect. Partial undersurface tear = the T-sign (below). Full-thickness: fiber discontinuity across the whole thickness, a gap/retraction, or medial extravasation. Always describe location (proximal/mid/distal) and acute vs chronic. A <50%/>50% partial call is a descriptive heuristic, not a validated graded scale.
- **The T-sign (partial undersurface tear):** Fluid/contrast undermines the distal/sublime-tubercle attachment BEYOND the articular-cartilage edge while the proximal fibers stay attached (articular-sided, not full-thickness). The abnormal threshold is fluid extending past the cartilage margin — a couple of millimetres can be a normal recess. MR arthrography is the most sensitive study.
- **Management & the dynamic-US threshold:** Repair ± internal brace vs reconstruction is driven by location/surface/acute-vs-chronic + athlete demand + the moving-valgus exam — NOT a single MRI cutoff. Distal/full-thickness tears do worse nonoperatively. On dynamic valgus-stress ultrasound, a side-to-side medial gapping difference of ~>1 mm (commonly cited ~1.5–2 mm) is the functional threshold.

#### Capitellar OCD — stability criteria
- **Stable (rest + follow-up):** No fluid-bright surrounding signal, intact overlying cartilage, an in-situ fragment, and a low-signal demarcating margin → throwing rest and serial follow-up.
- **Unstable — any of (surgical referral):** A T2 fluid-bright line completely undercutting the fragment (matching joint-fluid signal); a sizeable or multiple subchondral cyst(s); a high-signal cartilage cleft reaching the fragment; or a displaced fragment/loose body. NOTE: the 5 mm cyst figure is a knee-derived (De Smet) criterion not validated for the capitellum — teach 'sizeable or multiple.'
- **Not stability signs / indeterminate:** Surrounding marrow edema alone is NOT a stability sign; an isolated high-T2 line without a cartilage breach or cyst is INDETERMINATE. Read on coronal + sagittal; add MR/CT arthrography when stability will change the operation.
- **OCD vs Panner:** OCD = adolescent (~12–17 yr), focal anterolateral capitellum, fragmentation possible. Panner = osteochondrosis age ~5–10 yr, the whole ossific nucleus, self-limited, no fragment/cyst.

#### Medial epicondyle avulsion & olecranon stress (young thrower)
- **Little League elbow (apophysitis):** A widened, fluid-bright medial epicondyle physis with marrow edema; managed with throwing rest.
- **Avulsion — operative triggers:** Report exact displacement in mm and whether the fragment is intra-articular/incarcerated (a transiently dislocated elbow can trap it after spontaneous reduction). Operative triggers in a throwing athlete: displacement ≥5 mm, an intra-articular/incarcerated fragment, or valgus instability — incarceration/instability mandates surgery regardless of the mm (the general-population mm cutoff is debated).
- **Olecranon stress + CRITOE:** A discrete low-signal line + edema = stress fracture; edema only = stress reaction. The olecranon apophysis fuses mid-to-late teens (~15–17 yr, later in throwers) — compare to the contralateral side, not a hard cutoff. CRITOE rule: the trochlea never ossifies before the medial epicondyle, so a visible trochlea without the medial epicondyle implies the epicondyle is avulsed (often intra-articular).

#### Distal biceps tear — retraction & the lacertus
- **Partial vs complete:** Partial = usually an undersurface tear at the radial-tuberosity footprint (best on FABS). Complete = full discontinuity with a balled-up, wavy stump.
- **Retraction & the lacertus fibrosus:** State retraction (where the stump sits, in cm) and the lacertus status. An INTACT lacertus tethers the tendon, limits retraction, and can mask a complete tear clinically and on imaging; a DISRUPTED lacertus allows proximal retraction and an empty tuberosity. Bicipitoradial bursitis is a clue to scrutinize the insertion, not a diagnosis.
...
- **Grading:** Tendinosis (thickening + intermediate signal, intact fibers, no surface-reaching fluid/gap) → partial-thickness tear → full-thickness gap at the origin. Lateral = common extensor (ECRB); medial = common flexor/pronator.
- **The companion to always check:** Trace the LUCL to the supinator crest with lateral epicondylitis, and the anterior-bundle UCL with medial epicondylitis — the adjacent ligament is where the surgery hides.
...
#### LCL complex, PLRI & the coronoid (post-trauma instability)
- **LUCL & PLRI:** LUCL: lateral epicondyle → posterior to the radial head → supinator crest; the primary restraint to posterolateral rotatory instability. Trace it on coronal + axial (partial-volume averaging causes misses). There is no standardized single MRI measurement — call it on continuity, surface, and radiocapitellar alignment plus the clinical pivot-shift.
- **The O'Driscoll circle:** A dislocation disrupts soft tissue lateral-to-medial (LUCL → capsule → MCL), so the LCL is the primary lesion in most simple dislocations. Look for the Osborne–Cotterill posterolateral capitellar impaction and heterotopic ossification after any dislocation.
- **Coronoid classifications & surgical patterns:** Regan–Morrey by HEIGHT (I = tip avulsion, II = ≤50%, III = >50%); O'Driscoll for the ANTEROMEDIAL FACET (the VPMRI lesion). Persistent/recurrent PLRI → LUCL repair/reconstruction; the anteromedial coronoid facet fracture (small on radiographs) implies varus posteromedial rotatory instability and is surgical; the terrible triad (dislocation + radial head + coronoid fracture) is surgical with the coronoid and LCL as keystones. Comment on LUCL integrity in EVERY post-dislocation or post-lateral-surgery elbow.

#### Ulnar nerve / cubital tunnel
- **What to report:** Nerve enlargement and T2 hyperintensity at/just distal to the medial epicondyle, plus denervation of FCU, the ulnar FDP, and the ulnar intrinsics. Compare caliber/signal to the median nerve and the contralateral side (no universal cross-sectional-area cutoff; mild T2 brightness can be normal). Assess flexion subluxation on axial; look for an anconeus epitrochlearis, ganglion, or osteophyte. Snapping triceps can coexist.
- **What changes the operation:** Anchor the diagnosis to caliber change + muscle denervation + clinical correlation, not signal alone. Dynamic subluxation or an accessory muscle favors transposition over in-situ decompression; snapping triceps means the triceps must be addressed, not just the nerve.

#### PIN / radial tunnel & AIN
- **PIN syndrome:** The PIN compresses most commonly at the arcade of Frohse. PIN syndrome = motor digit drop with radially-deviated wrist extension (ECRL spared) and extensor-compartment denervation; the SUPINATOR is variably involved/often spared (its branches arise proximal to the arcade) — don't assert supinator denervation as a constant feature. Radial tunnel syndrome = pain without a motor deficit and often a normal MRI; report any mass at the arcade.
- **AIN (Kiloh–Nevin) — and the Parsonage–Turner caveat:** Pure motor: FPL, the FDP to index/middle, and pronator quadratus (classically isolated PQ edema). An AIN palsy is frequently neuralgic amyotrophy (Parsonage–Turner) rather than mechanical compression → usually NO surgery; pivot to EMG/observation.
- **Denervation timeline:** No MRI change for the first ~2–4 weeks → subacute T2/STIR muscle edema → chronic T1 fatty atrophy. Use the denervated muscle to localize the lesion.
...
- **Non-contrast MRI:** The first study for most questions: tendons, OCD, nerves, occult fracture, loose bodies. Non-contrast 3T answers most cases.
- **MR arthrography:** Add it for a suspected UCL undersurface (T-sign) tear and for loose-body/chondral-delamination detection when non-contrast MRI is equivocal, or when OCD stability will change the operation.
- **CT, radiograph & dynamic ultrasound:** CT is best for osseous fragment/loose-body quantification and complex fracture mapping (coronoid, terrible triad). Radiograph is first-line for the fat-pad sign, the radiocapitellar line, and osteophytes; dynamic ultrasound confirms ulnar-nerve subluxation and UCL valgus gapping that static MRI cannot.

## Daily Pearls

- **1:** Edema is the smoke — find the fire: tie every elbow marrow edema to a fracture line, a physis, a subchondral cyst, or an osteochondral fragment before moving on.
- **2:** Capitellar OCD instability is about the interface: a fluid line undercutting the fragment, a sizeable/multiple cyst, a cartilage breach, or a displaced fragment = unstable. Surrounding edema alone is not, and an isolated high-T2 line is indeterminate.
- **3:** Panner is the whole young capitellum (~5–10 yr) and it heals; OCD is the focal teenage capitellum (~12–17 yr) and it doesn't always.
- **4:** 'Trochlea before medial epicondyle is impossible' — if you see the trochlea but not the medial epicondyle on a child's elbow, the epicondyle is avulsed, often into the joint (CRITOE).
- **5:** A displaced posterior fat pad after adult elbow trauma is a fracture until disproven — radial head first; the surgical trigger is a block to forearm rotation, not the 2 mm number alone.
- **6:** The T-sign — fluid undermining the distal UCL beyond the articular-cartilage edge — is the partial undersurface tear missed at exam and arthroscopy; MR arthrography is the most sensitive study. (Distal tears are important and under-recognized, but don't claim they outnumber proximal tears.)
- **7:** Medial elbow pain is a triad: read the flexor-pronator origin, the UCL to the sublime tubercle, AND the ulnar nerve together — they injure together in valgus overload.
- **8:** Read lateral epicondylitis? Trace the LUCL to the supinator crest. Read medial epicondylitis? Trace the UCL. The adjacent ligament is where the surgery hides.
- **9:** The lacertus decides whether a complete distal biceps tear retracts — always report complete-vs-partial AND lacertus-intact-vs-torn; an intact lacertus is the classic mimic of a partial tear.
- **10:** Localize a nerve by its muscle: isolated pronator quadratus edema = AIN (consider Parsonage–Turner, not surgery); extensor compartment = PIN at the arcade of Frohse; FCU / ulnar-FDP / intrinsics = ulnar at the cubital tunnel — and compare the ulnar nerve to the median nerve and the other side.
