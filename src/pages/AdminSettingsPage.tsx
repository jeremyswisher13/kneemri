...
export default function AdminSettingsPage() {
  ...
  useEffect(() => {
    ...
    getDoc(doc(db, "settings", "cohort"))
      .then((snap) => {
        if (snap.exists()) {
          setUnlocked(snap.data().postQuizUnlocked === true);
        }
      })
      .catch(() => {})
  ...
  async function handleToggle() {
    ...
    try {
      ...
      await togglePostQuizUnlock(user.uid, user.email || "", newValue);
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="text-lg font-semibold text-gray-900">
                Post-Assessment Access
              </h3>
              <p className="mt-1 text-sm text-gray-500">
                Control whether fellows can access the post-assessment quiz and
                survey.
              </p>
            </div>
            ...
            <button
              ...
              aria-label="Toggle post-assessment access"
            >
              <span
          ...
          <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-amber-700">
                Once unlocked, fellows can take the post-assessment quiz and
                survey. This should typically be done after all fellows have
                completed the modules and case practice.
              </p>
            </div>
          </div>
        </Card>
