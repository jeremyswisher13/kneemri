...
Articular-sided supraspinatus tears are common. Bursal-sided tears can be more symptomatic in some impingement patterns and may be associated with subacromial bursitis.`,
        ...
        images: [
          ...
          },
          {
            ...
            caption:
              "Bursal-sided partial tear — oblique coronal fat-suppressed PD MRI shows discontinuity reaching the SUPERFICIAL (bursal) surface of the supraspinatus (arrow). Compare with the articular-sided tear above: the deep surface is intact here, and it is the surface involved that determines the classification.",
            attribution: "Perez Yubran A et al., Insights Imaging, 2024;15:61. PMC10899560. CC-BY 4.0.",
          },
        ],
      },
