...
export const confidenceStatements: ConfidenceStatement[] = [
  ...
  { id: "kc-marrow-mechanism", domain: "marrow-mechanism", statement: "I can use marrow edema distribution as a clue to injury mechanism (pivot-shift, dashboard/PCL, patellar dislocation) and distinguish a likely insufficiency fracture from traumatic contusion using morphology and clinical context." },
