  ...
  "hip-fai-labrum": [
    {
      ...
      correctAnswer: "B",
      explanation: "The cam bump peaks anterosuperiorly (1–2 o'clock), which a straight axial under-samples and can falsely normalize. Oblique-axial/radial reformats angled along the neck capture the peak. The historic >55° cutoff remains common, while ≥60° is better supported for classifying cam morphology; neither value alone diagnoses symptomatic FAI. A is wrong because a single normal axial value does not exclude cam morphology. C is unsupported — the symptoms may fit cam-type impingement, while pincer requires acetabular over-coverage findings. D skips conservative management and is far premature.",
      topicIndex: 0,
    },
    {
