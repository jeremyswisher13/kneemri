...
export const hipCaseRegistry: CaseMetadata[] = [
  ...
  },
  {
    ...
    searchPatternFindings: [
      ...
      { step: 4, stepName: "Labrum & FAI Morphology", expectedFindings: ["No labral tear or FAI morphology identified as a competing structural pain source", "No cam/pincer morphology accounting for symptoms", "The stress-fracture pattern best explains the presentation"] },
      ...
      { step: 6, stepName: "Flexors, Adductors & Pubic Symphysis", expectedFindings: ["Adductor and flexor origins normal", "No pubic-symphyseal or core-muscle injury identified as a competing structural pain source", "No additional pelvic stress reaction (but consider screening sacrum if edema pattern suggests)"] },
  ...
  },
  {
    ...
    searchPatternFindings: [
      ...
      { step: 2, stepName: "Bones, Marrow & Stress Injury", expectedFindings: ["Reactive marrow edema and enthesophytes at the greater trochanteric facets", "Normal femoral head/neck - no stress fracture or AVN", "No competing intraosseous abnormality identified"] },
      ...
      { step: 4, stepName: "Labrum & FAI Morphology", expectedFindings: ["Labrum intact", "No FAI morphology", "No competing structural intra-articular abnormality identified"] },
      ...
      { step: 6, stepName: "Flexors, Adductors & Pubic Symphysis", expectedFindings: ["Flexor and adductor origins normal", "Pubic symphysis normal", "No additional structural abnormality identified"] },
  ...
  },
  {
    ...
    searchPatternFindings: [
      ...
      { step: 4, stepName: "Labrum & FAI Morphology", expectedFindings: ["Labrum intact", "No FAI morphology", "No structural intra-articular pain source identified on this examination"] },
  ...
  },
  {
    ...
    searchPatternFindings: [
      ...
      { step: 3, stepName: "Cartilage, Joint Surface & Effusion", expectedFindings: ["Hip joints unremarkable with no effusion", "Cartilage preserved with no competing structural intra-articular abnormality identified", "Reinforces an extra-articular pubic process"] },
      ...
      { step: 5, stepName: "Abductors, Lateral & Posterior Soft Tissue", expectedFindings: ["Abductors and hamstring origins normal", "No competing posterior or lateral soft-tissue lesion identified", "Focus stays anterior/medial"] },
  ...
  },
  {
    ...
    searchPatternFindings: [
      { step: 1, stepName: "Verify Protocol & Clinical Question", expectedFindings: ["Confirm high-resolution T1 and fluid-sensitive coronal/sagittal sequences", "Clinical question is transient BME vs SIFFH in an atraumatic painful hip", "Recognize the discriminator will be presence/absence of a subchondral fracture band"] },
      { step: 2, stepName: "Bones, Marrow & Stress Injury", expectedFindings: ["Diffuse femoral head/neck marrow edema (low T1, high STIR)", "Focal irregular low-signal SUBCHONDRAL FRACTURE BAND in the weight-bearing head - the key finding making this SIFFH", "No geographic serpiginous lesion or double-line sign (against AVN)"] },
      ...
      { step: 7, stepName: "Don't-Miss & Final Management Review", expectedFindings: ["Don't-miss: the subtle subchondral fracture band that distinguishes SIFFH from transient BME", "State collapse risk and recommend protected weight-bearing plus prompt follow-up", "Disposition: orthopedic referral and bone-health/insufficiency workup"] },
    ],
    teachingImages: [
      {
